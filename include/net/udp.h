...
#define UDP_MAX_DATAGRAM_SIZE 65507  // Maximum UDP datagram size (65535 - 20 - 8)
#define UDP_MAX_PAYLOAD       1472   // Maximum UDP payload in standard MTU (1500 - 20 - 8)
 ...
 */
void udp_set_payload(udp_packet_t *packet, const uint8_t *payload, uint32_t length);
 ...
 */
uint32_t udp_serialize(const udp_packet_t *packet, uint8_t *buffer, uint32_t buffer_size, 
