...
int main( void ) {
   ...
   11ef3:	b9 85 74 01 00       	mov    $0x17485,%ecx
...
context_t *stack_setup( pcb_t *pcb, uint32_t entry,
   ...
   16cc8:	ba 3b 6f 01 00       	mov    $0x16f3b,%edx
...
int detect_intel_8255x() {
   ...
   16ddc:	83 ec 30             	sub    $0x30,%esp
  int bus;
  int dev;
  int func;
  uint32_t val;
  int found = 0;
   16ddf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  ...
  for (bus = 0; bus < 256 && !found; bus++) {
   16de6:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
   16ded:	e9 ba 00 00 00       	jmp    16eac <detect_intel_8255x+0xd3>
    for (dev = 0; dev < 32 && !found; dev++) {
   16df2:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
   16df9:	e9 9a 00 00 00       	jmp    16e98 <detect_intel_8255x+0xbf>
      for (func = 0; func < 8 && !found; func++) {
   16dfe:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
   16e05:	eb 7d                	jmp    16e84 <detect_intel_8255x+0xab>
        val = pci_read_config(bus, dev, func, 0);
   16e07:	6a 00                	push   $0x0
   16e09:	ff 75 f4             	pushl  -0xc(%ebp)
   16e0c:	ff 75 f8             	pushl  -0x8(%ebp)
   16e0f:	ff 75 fc             	pushl  -0x4(%ebp)
   16e12:	e8 68 ff ff ff       	call   16d7f <pci_read_config>
   16e17:	83 c4 10             	add    $0x10,%esp
   16e1a:	89 45 ec             	mov    %eax,-0x14(%ebp)
        if ((val & 0xFFFF) == 0x8086) { /* Intel vendor ID */
   16e1d:	8b 45 ec             	mov    -0x14(%ebp),%eax
   16e20:	0f b7 c0             	movzwl %ax,%eax
   16e23:	3d 86 80 00 00       	cmp    $0x8086,%eax
   16e28:	75 56                	jne    16e80 <detect_intel_8255x+0xa7>
          uint16_t device_id = (val >> 16) & 0xFFFF;
   16e2a:	8b 45 ec             	mov    -0x14(%ebp),%eax
   16e2d:	c1 e8 10             	shr    $0x10,%eax
   16e30:	66 89 45 ea          	mov    %ax,-0x16(%ebp)

          if (device_id == 0x1227 || /* 82557 */
   16e34:	66 81 7d ea 27 12    	cmpw   $0x1227,-0x16(%ebp)
   16e3a:	74 08                	je     16e44 <detect_intel_8255x+0x6b>
   16e3c:	66 81 7d ea 29 12    	cmpw   $0x1229,-0x16(%ebp)
   16e42:	75 3c                	jne    16e80 <detect_intel_8255x+0xa7>
   ...
   16e44:	6a 10                	push   $0x10
   16e46:	ff 75 f4             	pushl  -0xc(%ebp)
   16e49:	ff 75 f8             	pushl  -0x8(%ebp)
   16e4c:	ff 75 fc             	pushl  -0x4(%ebp)
   16e4f:	e8 2b ff ff ff       	call   16d7f <pci_read_config>
   16e54:	83 c4 10             	add    $0x10,%esp
   16e57:	89 45 e4             	mov    %eax,-0x1c(%ebp)
                uint32_t io_base = io_bar & ~0x3; /* Mask off the low bits */
   16e5a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
   16e5d:	83 e0 fc             	and    $0xfffffffc,%eax
   16e60:	89 45 e0             	mov    %eax,-0x20(%ebp)

                // Get interrupt line
                uint8_t irq = pci_read_config(bus, dev, func, 0x3C) & 0xFF;
   16e63:	6a 3c                	push   $0x3c
   16e65:	ff 75 f4             	pushl  -0xc(%ebp)
   16e68:	ff 75 f8             	pushl  -0x8(%ebp)
   16e6b:	ff 75 fc             	pushl  -0x4(%ebp)
   16e6e:	e8 0c ff ff ff       	call   16d7f <pci_read_config>
   16e73:	83 c4 10             	add    $0x10,%esp
   16e76:	88 45 df             	mov    %al,-0x21(%ebp)
                // cio_printf("e100: I/O base = 0x%x, IRQ = %d\n", io_base, irq);

                return 0;
   16e79:	b8 00 00 00 00       	mov    $0x0,%eax
   16e7e:	eb 3f                	jmp    16ebf <detect_intel_8255x+0xe6>
      for (func = 0; func < 8 && !found; func++) {
   16e80:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
   16e84:	83 7d f4 07          	cmpl   $0x7,-0xc(%ebp)
   16e88:	7f 0a                	jg     16e94 <detect_intel_8255x+0xbb>
   16e8a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
   16e8e:	0f 84 73 ff ff ff    	je     16e07 <detect_intel_8255x+0x2e>
    for (dev = 0; dev < 32 && !found; dev++) {
   16e94:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
   16e98:	83 7d f8 1f          	cmpl   $0x1f,-0x8(%ebp)
   16e9c:	7f 0a                	jg     16ea8 <detect_intel_8255x+0xcf>
   16e9e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
   16ea2:	0f 84 56 ff ff ff    	je     16dfe <detect_intel_8255x+0x25>
  for (bus = 0; bus < 256 && !found; bus++) {
   16ea8:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
   16eac:	81 7d fc ff 00 00 00 	cmpl   $0xff,-0x4(%ebp)
   16eb3:	7f 0a                	jg     16ebf <detect_intel_8255x+0xe6>
   16eb5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
   16eb9:	0f 84 33 ff ff ff    	je     16df2 <detect_intel_8255x+0x19>
          }
        }
      }
    }
...
00016ec1 <intel_8255x_init>:

int intel_8255x_init(void) { return detect_intel_8255x(); }
   16ec1:	55                   	push   %ebp
   16ec2:	89 e5                	mov    %esp,%ebp
   16ec4:	e8 10 ff ff ff       	call   16dd9 <detect_intel_8255x>
   16ec9:	5d                   	pop    %ebp
   16eca:	c3                   	ret    
...
SYSCALL(exit)
   16ecb:	b8 00 00 00 00       	mov    $0x0,%eax
   16ed0:	cd 80                	int    $0x80
   16ed2:	c3                   	ret    

00016ed3 <waitpid>:
SYSCALL(waitpid)
   16ed3:	b8 01 00 00 00       	mov    $0x1,%eax
   16ed8:	cd 80                	int    $0x80
   16eda:	c3                   	ret    

00016edb <fork>:
SYSCALL(fork)
   16edb:	b8 02 00 00 00       	mov    $0x2,%eax
   16ee0:	cd 80                	int    $0x80
   16ee2:	c3                   	ret    

00016ee3 <exec>:
SYSCALL(exec)
   16ee3:	b8 03 00 00 00       	mov    $0x3,%eax
   16ee8:	cd 80                	int    $0x80
   16eea:	c3                   	ret    

00016eeb <read>:
SYSCALL(read)
   16eeb:	b8 04 00 00 00       	mov    $0x4,%eax
   16ef0:	cd 80                	int    $0x80
   16ef2:	c3                   	ret    

00016ef3 <write>:
SYSCALL(write)
   16ef3:	b8 05 00 00 00       	mov    $0x5,%eax
   16ef8:	cd 80                	int    $0x80
   16efa:	c3                   	ret    

00016efb <getpid>:
SYSCALL(getpid)
   16efb:	b8 06 00 00 00       	mov    $0x6,%eax
   16f00:	cd 80                	int    $0x80
   16f02:	c3                   	ret    

00016f03 <getppid>:
SYSCALL(getppid)
   16f03:	b8 07 00 00 00       	mov    $0x7,%eax
   16f08:	cd 80                	int    $0x80
   16f0a:	c3                   	ret    

00016f0b <gettime>:
SYSCALL(gettime)
   16f0b:	b8 08 00 00 00       	mov    $0x8,%eax
   16f10:	cd 80                	int    $0x80
   16f12:	c3                   	ret    

00016f13 <getprio>:
SYSCALL(getprio)
   16f13:	b8 09 00 00 00       	mov    $0x9,%eax
   16f18:	cd 80                	int    $0x80
   16f1a:	c3                   	ret    

00016f1b <setprio>:
SYSCALL(setprio)
   16f1b:	b8 0a 00 00 00       	mov    $0xa,%eax
   16f20:	cd 80                	int    $0x80
   16f22:	c3                   	ret    

00016f23 <kill>:
SYSCALL(kill)
   16f23:	b8 0b 00 00 00       	mov    $0xb,%eax
   16f28:	cd 80                	int    $0x80
   16f2a:	c3                   	ret    

00016f2b <sleep>:
SYSCALL(sleep)
   16f2b:	b8 0c 00 00 00       	mov    $0xc,%eax
   16f30:	cd 80                	int    $0x80
   16f32:	c3                   	ret    
...
*/
SYSCALL(bogus)
   16f33:	b8 ad 0b 00 00       	mov    $0xbad,%eax
   16f38:	cd 80                	int    $0x80
   16f3a:	c3                   	ret    
...
fake_exit:
   ...
   16f3c:	e8 8a ff ff ff       	call   16ecb <exit>
...
USERMAIN( idle ) {
   16f41:	55                   	push   %ebp
   16f42:	89 e5                	mov    %esp,%ebp
   16f44:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char ch = '.';
#endif
   ...
   16f4a:	8b 45 0c             	mov    0xc(%ebp),%eax
   16f4d:	8b 00                	mov    (%eax),%eax
   16f4f:	85 c0                	test   %eax,%eax
   16f51:	74 07                	je     16f5a <idle+0x19>
   16f53:	8b 45 0c             	mov    0xc(%ebp),%eax
   16f56:	8b 00                	mov    (%eax),%eax
   16f58:	eb 05                	jmp    16f5f <idle+0x1e>
   16f5a:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   16f5f:	89 45 f0             	mov    %eax,-0x10(%ebp)

	// get some current information
	uint_t pid = getpid();
   16f62:	e8 94 ff ff ff       	call   16efb <getpid>
   16f67:	89 45 ec             	mov    %eax,-0x14(%ebp)
	uint32_t now = gettime();
   16f6a:	e8 9c ff ff ff       	call   16f0b <gettime>
   16f6f:	89 45 e8             	mov    %eax,-0x18(%ebp)
	enum priority_e prio = getprio();
   16f72:	e8 9c ff ff ff       	call   16f13 <getprio>
   16f77:	89 45 e4             	mov    %eax,-0x1c(%ebp)

	char buf[128];
	usprint( buf, "%s [%d], started @ %u\n", name, pid, prio, now );
   16f7a:	83 ec 08             	sub    $0x8,%esp
   16f7d:	ff 75 e8             	pushl  -0x18(%ebp)
   16f80:	ff 75 e4             	pushl  -0x1c(%ebp)
   16f83:	ff 75 ec             	pushl  -0x14(%ebp)
   16f86:	ff 75 f0             	pushl  -0x10(%ebp)
   16f89:	68 6f ba 01 00       	push   $0x1ba6f
   16f8e:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
   16f94:	50                   	push   %eax
   16f95:	e8 db 2c 00 00       	call   19c75 <usprint>
   16f9a:	83 c4 20             	add    $0x20,%esp
	cwrites( buf );
   16f9d:	83 ec 0c             	sub    $0xc,%esp
   16fa0:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
   16fa6:	50                   	push   %eax
   16fa7:	e8 b6 33 00 00       	call   1a362 <cwrites>
   16fac:	83 c4 10             	add    $0x10,%esp
	...
	for(;;) {
		DELAY(LONG);
   16faf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
   16fb6:	eb 04                	jmp    16fbc <idle+0x7b>
   16fb8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
   16fbc:	81 7d f4 ff e0 f5 05 	cmpl   $0x5f5e0ff,-0xc(%ebp)
   16fc3:	7e f3                	jle    16fb8 <idle+0x77>
   16fc5:	eb e8                	jmp    16faf <idle+0x6e>
...
static void usage( void ) {
   ...
   16fca:	83 ec 18             	sub    $0x18,%esp
	swrites( "\nTests - run with '@x', where 'x' is one or more of:\n " );
   16fcd:	83 ec 0c             	sub    $0xc,%esp
   16fd0:	68 54 bb 01 00       	push   $0x1bb54
   16fd5:	e8 ee 33 00 00       	call   1a3c8 <swrites>
   16fda:	83 c4 10             	add    $0x10,%esp
	proc_t *p = sh_spawn_table;
   16fdd:	c7 45 f4 20 d1 01 00 	movl   $0x1d120,-0xc(%ebp)
	while( p->entry != TBLEND ) {
   16fe4:	eb 23                	jmp    17009 <usage+0x42>
		swritech( ' ' );
   16fe6:	83 ec 0c             	sub    $0xc,%esp
   16fe9:	6a 20                	push   $0x20
   16feb:	e8 b7 33 00 00       	call   1a3a7 <swritech>
   16ff0:	83 c4 10             	add    $0x10,%esp
		swritech( p->select[0] );
   16ff3:	8b 45 f4             	mov    -0xc(%ebp),%eax
   16ff6:	0f b6 40 09          	movzbl 0x9(%eax),%eax
   16ffa:	0f be c0             	movsbl %al,%eax
   16ffd:	83 ec 0c             	sub    $0xc,%esp
   17000:	50                   	push   %eax
   17001:	e8 a1 33 00 00       	call   1a3a7 <swritech>
   17006:	83 c4 10             	add    $0x10,%esp
	while( p->entry != TBLEND ) {
   17009:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1700c:	8b 00                	mov    (%eax),%eax
   1700e:	3d ed ad be de       	cmp    $0xdebeaded,%eax
   17013:	75 d1                	jne    16fe6 <usage+0x1f>
	}
	swrites( "\nOther commands: @* (all), @h (help), @x (exit)\n" );
   17015:	83 ec 0c             	sub    $0xc,%esp
   17018:	68 8c bb 01 00       	push   $0x1bb8c
   1701d:	e8 a6 33 00 00       	call   1a3c8 <swrites>
   17022:	83 c4 10             	add    $0x10,%esp
}
   17025:	90                   	nop
   17026:	c9                   	leave  
   17027:	c3                   	ret    
...
static int run( char which ) {
   17028:	55                   	push   %ebp
   17029:	89 e5                	mov    %esp,%ebp
   1702b:	53                   	push   %ebx
   1702c:	81 ec a4 00 00 00    	sub    $0xa4,%esp
   17032:	8b 45 08             	mov    0x8(%ebp),%eax
   17035:	88 85 64 ff ff ff    	mov    %al,-0x9c(%ebp)
	char buf[128];
	register proc_t *p;

	if( which == 'h' ) {
   1703b:	80 bd 64 ff ff ff 68 	cmpb   $0x68,-0x9c(%ebp)
   17042:	75 0a                	jne    1704e <run+0x26>

		// builtin "help" command
		usage();
   17044:	e8 7e ff ff ff       	call   16fc7 <usage>
   17049:	e9 e0 00 00 00       	jmp    1712e <run+0x106>

	} else if( which == 'x' ) {
   1704e:	80 bd 64 ff ff ff 78 	cmpb   $0x78,-0x9c(%ebp)
   17055:	75 0c                	jne    17063 <run+0x3b>

		// builtin "exit" command
		time_to_stop = true;
   17057:	c6 05 b4 f1 01 00 01 	movb   $0x1,0x1f1b4
   1705e:	e9 cb 00 00 00       	jmp    1712e <run+0x106>

	} else if( which == '*' ) {
   17063:	80 bd 64 ff ff ff 2a 	cmpb   $0x2a,-0x9c(%ebp)
   1706a:	75 40                	jne    170ac <run+0x84>

		// torture test! run everything!
		for( p = sh_spawn_table; p->entry != TBLEND; ++p ) {
   1706c:	bb 20 d1 01 00       	mov    $0x1d120,%ebx
   17071:	eb 2b                	jmp    1709e <run+0x76>
			int status = spawn( p->entry, p->args );
   17073:	8d 53 0c             	lea    0xc(%ebx),%edx
   17076:	8b 03                	mov    (%ebx),%eax
   17078:	83 ec 08             	sub    $0x8,%esp
   1707b:	52                   	push   %edx
   1707c:	50                   	push   %eax
   1707d:	e8 4a 32 00 00       	call   1a2cc <spawn>
   17082:	83 c4 10             	add    $0x10,%esp
   17085:	89 45 f0             	mov    %eax,-0x10(%ebp)
			if( status > 0 ) {
   17088:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
   1708c:	7e 0d                	jle    1709b <run+0x73>
				++children;
   1708e:	a1 b8 f1 01 00       	mov    0x1f1b8,%eax
   17093:	83 c0 01             	add    $0x1,%eax
   17096:	a3 b8 f1 01 00       	mov    %eax,0x1f1b8
		for( p = sh_spawn_table; p->entry != TBLEND; ++p ) {
   1709b:	83 c3 34             	add    $0x34,%ebx
   1709e:	8b 03                	mov    (%ebx),%eax
   170a0:	3d ed ad be de       	cmp    $0xdebeaded,%eax
   170a5:	75 cc                	jne    17073 <run+0x4b>
   170a7:	e9 82 00 00 00       	jmp    1712e <run+0x106>
		}
		...
		for( p = sh_spawn_table; p->entry != TBLEND; ++p ) {
   170ac:	bb 20 d1 01 00       	mov    $0x1d120,%ebx
   170b1:	eb 3c                	jmp    170ef <run+0xc7>
			if( p->select[0] == which ) {
   170b3:	0f b6 43 09          	movzbl 0x9(%ebx),%eax
   170b7:	38 85 64 ff ff ff    	cmp    %al,-0x9c(%ebp)
   170bd:	75 2d                	jne    170ec <run+0xc4>
				// found it!
				int status = spawn( p->entry, p->args );
   170bf:	8d 53 0c             	lea    0xc(%ebx),%edx
   170c2:	8b 03                	mov    (%ebx),%eax
   170c4:	83 ec 08             	sub    $0x8,%esp
   170c7:	52                   	push   %edx
   170c8:	50                   	push   %eax
   170c9:	e8 fe 31 00 00       	call   1a2cc <spawn>
   170ce:	83 c4 10             	add    $0x10,%esp
   170d1:	89 45 f4             	mov    %eax,-0xc(%ebp)
				if( status > 0 ) {
   170d4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
   170d8:	7e 0d                	jle    170e7 <run+0xbf>
					++children;
   170da:	a1 b8 f1 01 00       	mov    0x1f1b8,%eax
   170df:	83 c0 01             	add    $0x1,%eax
   170e2:	a3 b8 f1 01 00       	mov    %eax,0x1f1b8
				}
				return status;
   170e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
   170ea:	eb 47                	jmp    17133 <run+0x10b>
		for( p = sh_spawn_table; p->entry != TBLEND; ++p ) {
   170ec:	83 c3 34             	add    $0x34,%ebx
   170ef:	8b 03                	mov    (%ebx),%eax
   170f1:	3d ed ad be de       	cmp    $0xdebeaded,%eax
   170f6:	75 bb                	jne    170b3 <run+0x8b>
			}
		}

		// uh-oh, made it through the table without finding the program
		usprint( buf, "shell: unknown cmd '%c'\n", which );
   170f8:	0f be 85 64 ff ff ff 	movsbl -0x9c(%ebp),%eax
   170ff:	83 ec 04             	sub    $0x4,%esp
   17102:	50                   	push   %eax
   17103:	68 bd bb 01 00       	push   $0x1bbbd
   17108:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
   1710e:	50                   	push   %eax
   1710f:	e8 61 2b 00 00       	call   19c75 <usprint>
   17114:	83 c4 10             	add    $0x10,%esp
		swrites( buf );
   17117:	83 ec 0c             	sub    $0xc,%esp
   1711a:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
   17120:	50                   	push   %eax
   17121:	e8 a2 32 00 00       	call   1a3c8 <swrites>
   17126:	83 c4 10             	add    $0x10,%esp
		usage();
   17129:	e8 99 fe ff ff       	call   16fc7 <usage>
	}

	return 0;
   1712e:	b8 00 00 00 00       	mov    $0x0,%eax
}
   17133:	8b 5d fc             	mov    -0x4(%ebp),%ebx
   17136:	c9                   	leave  
   17137:	c3                   	ret    
...
static int edit( char line[], int n ) {
   17138:	55                   	push   %ebp
   17139:	89 e5                	mov    %esp,%ebp
   1713b:	83 ec 10             	sub    $0x10,%esp
	char *ptr = line + n - 1;	// last char in buffer
   1713e:	8b 45 0c             	mov    0xc(%ebp),%eax
   17141:	8d 50 ff             	lea    -0x1(%eax),%edx
   17144:	8b 45 08             	mov    0x8(%ebp),%eax
   17147:	01 d0                	add    %edx,%eax
   17149:	89 45 fc             	mov    %eax,-0x4(%ebp)

	// strip the EOLN sequence
	while( n > 0 ) {
   1714c:	eb 18                	jmp    17166 <edit+0x2e>
		if( *ptr == '\n' || *ptr == '\r' ) {
   1714e:	8b 45 fc             	mov    -0x4(%ebp),%eax
   17151:	0f b6 00             	movzbl (%eax),%eax
   17154:	3c 0a                	cmp    $0xa,%al
   17156:	74 0a                	je     17162 <edit+0x2a>
   17158:	8b 45 fc             	mov    -0x4(%ebp),%eax
   1715b:	0f b6 00             	movzbl (%eax),%eax
   1715e:	3c 0d                	cmp    $0xd,%al
   17160:	75 0a                	jne    1716c <edit+0x34>
			--n;
   17162:	83 6d 0c 01          	subl   $0x1,0xc(%ebp)
	while( n > 0 ) {
   17166:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
   1716a:	7f e2                	jg     1714e <edit+0x16>
			break;
		}
	}
	...
	if( n > 0 ) {
   1716c:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
   17170:	7e 0b                	jle    1717d <edit+0x45>
		line[n] = '\0';
   17172:	8b 55 0c             	mov    0xc(%ebp),%edx
   17175:	8b 45 08             	mov    0x8(%ebp),%eax
   17178:	01 d0                	add    %edx,%eax
   1717a:	c6 00 00             	movb   $0x0,(%eax)
	}

	return n;
   1717d:	8b 45 0c             	mov    0xc(%ebp),%eax
}
   17180:	c9                   	leave  
   17181:	c3                   	ret    
...
USERMAIN( shell ) {
   17182:	55                   	push   %ebp
   17183:	89 e5                	mov    %esp,%ebp
   17185:	81 ec 28 01 00 00    	sub    $0x128,%esp
	char line[128];
   ...
   17190:	85 c0                	test   %eax,%eax
   17192:	74 07                	je     1719b <shell+0x19>
   17194:	8b 45 0c             	mov    0xc(%ebp),%eax
   17197:	8b 00                	mov    (%eax),%eax
   17199:	eb 05                	jmp    171a0 <shell+0x1e>
   1719b:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   171a0:	89 45 ec             	mov    %eax,-0x14(%ebp)

	// report that we're up and running
	usprint( line, "%s is ready\n", name );
   171a3:	83 ec 04             	sub    $0x4,%esp
   171a6:	ff 75 ec             	pushl  -0x14(%ebp)
   171a9:	68 d6 bb 01 00       	push   $0x1bbd6
   171ae:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   171b4:	50                   	push   %eax
   171b5:	e8 bb 2a 00 00       	call   19c75 <usprint>
   171ba:	83 c4 10             	add    $0x10,%esp
	swrites( line );
   171bd:	83 ec 0c             	sub    $0xc,%esp
   171c0:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   171c6:	50                   	push   %eax
   171c7:	e8 fc 31 00 00       	call   1a3c8 <swrites>
   171cc:	83 c4 10             	add    $0x10,%esp

	// print a summary of the commands we'll accept
	usage();
   171cf:	e8 f3 fd ff ff       	call   16fc7 <usage>

	// loop forever
	while( !time_to_stop ) {
   171d4:	e9 a7 01 00 00       	jmp    17380 <shell+0x1fe>
		char *ptr;
		...
		swrites( "\n> " );
   171d9:	83 ec 0c             	sub    $0xc,%esp
   171dc:	68 e3 bb 01 00       	push   $0x1bbe3
   171e1:	e8 e2 31 00 00       	call   1a3c8 <swrites>
   171e6:	83 c4 10             	add    $0x10,%esp
		int n = read( CHAN_SIO, line, sizeof(line) );
   171e9:	83 ec 04             	sub    $0x4,%esp
   171ec:	68 80 00 00 00       	push   $0x80
   171f1:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   171f7:	50                   	push   %eax
   171f8:	6a 01                	push   $0x1
   171fa:	e8 ec fc ff ff       	call   16eeb <read>
   171ff:	83 c4 10             	add    $0x10,%esp
   17202:	89 45 e8             	mov    %eax,-0x18(%ebp)
		
		// shortest valid command is "@?", so must have 3+ chars here
		if( n < 3 ) {
   17205:	83 7d e8 02          	cmpl   $0x2,-0x18(%ebp)
   17209:	7f 05                	jg     17210 <shell+0x8e>
			// ignore it
			continue;
   1720b:	e9 70 01 00 00       	jmp    17380 <shell+0x1fe>
		}

		// edit it as needed; new shortest command is 2+ chars
		if( (n=edit(line,n)) < 2 ) {
   17210:	83 ec 08             	sub    $0x8,%esp
   17213:	ff 75 e8             	pushl  -0x18(%ebp)
   17216:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   1721c:	50                   	push   %eax
   1721d:	e8 16 ff ff ff       	call   17138 <edit>
   17222:	83 c4 10             	add    $0x10,%esp
   17225:	89 45 e8             	mov    %eax,-0x18(%ebp)
   17228:	83 7d e8 01          	cmpl   $0x1,-0x18(%ebp)
   1722c:	7f 05                	jg     17233 <shell+0xb1>
			continue;
   1722e:	e9 4d 01 00 00       	jmp    17380 <shell+0x1fe>
		}

		// find the '@'
		int i = 0;
   17233:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
		for( ptr = line; i < n; ++i, ++ptr ) {
   1723a:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   17240:	89 45 f4             	mov    %eax,-0xc(%ebp)
   17243:	eb 12                	jmp    17257 <shell+0xd5>
			if( *ptr == '@' ) {
   17245:	8b 45 f4             	mov    -0xc(%ebp),%eax
   17248:	0f b6 00             	movzbl (%eax),%eax
   1724b:	3c 40                	cmp    $0x40,%al
   1724d:	74 12                	je     17261 <shell+0xdf>
		for( ptr = line; i < n; ++i, ++ptr ) {
   1724f:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
   17253:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
   17257:	8b 45 f0             	mov    -0x10(%ebp),%eax
   1725a:	3b 45 e8             	cmp    -0x18(%ebp),%eax
   1725d:	7c e6                	jl     17245 <shell+0xc3>
   1725f:	eb 01                	jmp    17262 <shell+0xe0>
				break;
   17261:	90                   	nop
			}
		}
		...
		// did we find an '@'?
		if( i < n ) {
   17262:	8b 45 f0             	mov    -0x10(%ebp),%eax
   17265:	3b 45 e8             	cmp    -0x18(%ebp),%eax
   17268:	0f 8d 12 01 00 00    	jge    17380 <shell+0x1fe>

			// yes; process any commands that follow it
			++ptr;
   1726e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

			for( ; *ptr != '\0'; ++ptr ) {
   17272:	eb 66                	jmp    172da <shell+0x158>
				char buf[128];
				int pid = run( *ptr );
   17274:	8b 45 f4             	mov    -0xc(%ebp),%eax
   17277:	0f b6 00             	movzbl (%eax),%eax
   1727a:	0f be c0             	movsbl %al,%eax
   1727d:	83 ec 0c             	sub    $0xc,%esp
   17280:	50                   	push   %eax
   17281:	e8 a2 fd ff ff       	call   17028 <run>
   17286:	83 c4 10             	add    $0x10,%esp
   17289:	89 45 e4             	mov    %eax,-0x1c(%ebp)

				if( pid < 0 ) {
   1728c:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
   17290:	79 39                	jns    172cb <shell+0x149>
					// spawn() failed
   ...
   17295:	0f b6 00             	movzbl (%eax),%eax
					usprint( buf, "+++ %s spawn %c failed, code %d\n",
   17298:	0f be c0             	movsbl %al,%eax
   1729b:	83 ec 0c             	sub    $0xc,%esp
   1729e:	ff 75 e4             	pushl  -0x1c(%ebp)
   172a1:	50                   	push   %eax
   172a2:	ff 75 ec             	pushl  -0x14(%ebp)
   172a5:	68 e8 bb 01 00       	push   $0x1bbe8
   172aa:	8d 85 dc fe ff ff    	lea    -0x124(%ebp),%eax
   172b0:	50                   	push   %eax
   172b1:	e8 bf 29 00 00       	call   19c75 <usprint>
   172b6:	83 c4 20             	add    $0x20,%esp
					cwrites( buf );
   172b9:	83 ec 0c             	sub    $0xc,%esp
   172bc:	8d 85 dc fe ff ff    	lea    -0x124(%ebp),%eax
   172c2:	50                   	push   %eax
   172c3:	e8 9a 30 00 00       	call   1a362 <cwrites>
   172c8:	83 c4 10             	add    $0x10,%esp
				}

				// should we end it all?
				if( time_to_stop ) {
   172cb:	0f b6 05 b4 f1 01 00 	movzbl 0x1f1b4,%eax
   172d2:	84 c0                	test   %al,%al
   172d4:	75 13                	jne    172e9 <shell+0x167>
			for( ; *ptr != '\0'; ++ptr ) {
   172d6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
   172da:	8b 45 f4             	mov    -0xc(%ebp),%eax
   172dd:	0f b6 00             	movzbl (%eax),%eax
   172e0:	84 c0                	test   %al,%al
   172e2:	75 90                	jne    17274 <shell+0xf2>
   172e4:	e9 8a 00 00 00       	jmp    17373 <shell+0x1f1>
					break;
   172e9:	90                   	nop
				}
			} // for
			...
			while( children > 0 ) {
   172ea:	e9 84 00 00 00       	jmp    17373 <shell+0x1f1>
				// wait for the child
				int32_t status;
				char buf[128];
				int whom = waitpid( 0, &status );
   172ef:	83 ec 08             	sub    $0x8,%esp
   172f2:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   172f8:	50                   	push   %eax
   172f9:	6a 00                	push   $0x0
   172fb:	e8 d3 fb ff ff       	call   16ed3 <waitpid>
   17300:	83 c4 10             	add    $0x10,%esp
   17303:	89 45 e0             	mov    %eax,-0x20(%ebp)

				// figure out the result
				if( whom == E_NO_CHILDREN ) {
   17306:	83 7d e0 fc          	cmpl   $0xfffffffc,-0x20(%ebp)
   1730a:	75 02                	jne    1730e <shell+0x18c>
   1730c:	eb 72                	jmp    17380 <shell+0x1fe>
					break;
				} else if( whom < 1 ) {
   1730e:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
   17312:	7f 1c                	jg     17330 <shell+0x1ae>
					usprint( buf, "%s: waitpid() returned %d\n", name, whom );
   17314:	ff 75 e0             	pushl  -0x20(%ebp)
   17317:	ff 75 ec             	pushl  -0x14(%ebp)
   1731a:	68 09 bc 01 00       	push   $0x1bc09
   1731f:	8d 85 dc fe ff ff    	lea    -0x124(%ebp),%eax
   17325:	50                   	push   %eax
   17326:	e8 4a 29 00 00       	call   19c75 <usprint>
   1732b:	83 c4 10             	add    $0x10,%esp
   1732e:	eb 31                	jmp    17361 <shell+0x1df>
				} else {
					--children;
   17330:	a1 b8 f1 01 00       	mov    0x1f1b8,%eax
   17335:	83 e8 01             	sub    $0x1,%eax
   17338:	a3 b8 f1 01 00       	mov    %eax,0x1f1b8
					usprint( buf, "%s: PID %d exit status %d\n",
   1733d:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
   17343:	83 ec 0c             	sub    $0xc,%esp
   17346:	50                   	push   %eax
   17347:	ff 75 e0             	pushl  -0x20(%ebp)
   1734a:	ff 75 ec             	pushl  -0x14(%ebp)
   1734d:	68 24 bc 01 00       	push   $0x1bc24
   17352:	8d 85 dc fe ff ff    	lea    -0x124(%ebp),%eax
   17358:	50                   	push   %eax
   17359:	e8 17 29 00 00       	call   19c75 <usprint>
   1735e:	83 c4 20             	add    $0x20,%esp
							name, whom, status );
				}
				// report it
				swrites( buf );
   17361:	83 ec 0c             	sub    $0xc,%esp
   17364:	8d 85 dc fe ff ff    	lea    -0x124(%ebp),%eax
   1736a:	50                   	push   %eax
   1736b:	e8 58 30 00 00       	call   1a3c8 <swrites>
   17370:	83 c4 10             	add    $0x10,%esp
			while( children > 0 ) {
   17373:	a1 b8 f1 01 00       	mov    0x1f1b8,%eax
   17378:	85 c0                	test   %eax,%eax
   1737a:	0f 8f 6f ff ff ff    	jg     172ef <shell+0x16d>
	while( !time_to_stop ) {
   17380:	0f b6 05 b4 f1 01 00 	movzbl 0x1f1b4,%eax
   17387:	84 c0                	test   %al,%al
   17389:	0f 84 4a fe ff ff    	je     171d9 <shell+0x57>
			}
		}  // if i < n
	}  // while

	cwrites( "!!! shell exited loop???\n" );
   1738f:	83 ec 0c             	sub    $0xc,%esp
   17392:	68 3f bc 01 00       	push   $0x1bc3f
   17397:	e8 c6 2f 00 00       	call   1a362 <cwrites>
   1739c:	83 c4 10             	add    $0x10,%esp
	exit( 1 );
   1739f:	83 ec 0c             	sub    $0xc,%esp
   173a2:	6a 01                	push   $0x1
   173a4:	e8 22 fb ff ff       	call   16ecb <exit>
   173a9:	83 c4 10             	add    $0x10,%esp

	// yeah, yeah....
	return( 0 );
   173ac:	b8 00 00 00 00       	mov    $0x0,%eax
}
   173b1:	c9                   	leave  
   173b2:	c3                   	ret    
...
{
   173b3:	55                   	push   %ebp
   173b4:	89 e5                	mov    %esp,%ebp
   173b6:	81 ec 98 00 00 00    	sub    $0x98,%esp
	char buf[128];

	// kick off the process
	int32_t p = fork();
   173bc:	e8 1a fb ff ff       	call   16edb <fork>
   173c1:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if( p < 0 ) {
   173c4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
   173c8:	79 34                	jns    173fe <process+0x4b>

		// error!
		usprint( buf, "INIT: fork for #%d failed\n",
				(uint32_t) (proc->entry) );
   173ca:	8b 45 08             	mov    0x8(%ebp),%eax
   173cd:	8b 00                	mov    (%eax),%eax
		usprint( buf, "INIT: fork for #%d failed\n",
   173cf:	83 ec 04             	sub    $0x4,%esp
   173d2:	50                   	push   %eax
   173d3:	68 66 bc 01 00       	push   $0x1bc66
   173d8:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
   173de:	50                   	push   %eax
   173df:	e8 91 28 00 00       	call   19c75 <usprint>
   173e4:	83 c4 10             	add    $0x10,%esp
		cwrites( buf );
   173e7:	83 ec 0c             	sub    $0xc,%esp
   173ea:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
   173f0:	50                   	push   %eax
   173f1:	e8 6c 2f 00 00       	call   1a362 <cwrites>
   ...
   173f9:	e9 84 00 00 00       	jmp    17482 <process+0xcf>
	} else if( p == 0 ) {
   173fe:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
   17402:	75 5f                	jne    17463 <process+0xb0>
		(void) setprio( proc->e_prio );
   17404:	8b 45 08             	mov    0x8(%ebp),%eax
   17407:	0f b6 40 08          	movzbl 0x8(%eax),%eax
   1740b:	0f b6 c0             	movzbl %al,%eax
   1740e:	83 ec 0c             	sub    $0xc,%esp
   17411:	50                   	push   %eax
   17412:	e8 04 fb ff ff       	call   16f1b <setprio>
   17417:	83 c4 10             	add    $0x10,%esp
		exec( proc->entry, proc->args );
   1741a:	8b 45 08             	mov    0x8(%ebp),%eax
   1741d:	8d 50 0c             	lea    0xc(%eax),%edx
   17420:	8b 45 08             	mov    0x8(%ebp),%eax
   17423:	8b 00                	mov    (%eax),%eax
   17425:	83 ec 08             	sub    $0x8,%esp
   17428:	52                   	push   %edx
   17429:	50                   	push   %eax
   1742a:	e8 b4 fa ff ff       	call   16ee3 <exec>
   1742f:	83 c4 10             	add    $0x10,%esp
				(uint32_t) (proc->entry) );
   17432:	8b 45 08             	mov    0x8(%ebp),%eax
   17435:	8b 00                	mov    (%eax),%eax
		usprint( buf, "INIT: exec(0x%08x) failed\n",
   17437:	83 ec 04             	sub    $0x4,%esp
   1743a:	50                   	push   %eax
   1743b:	68 81 bc 01 00       	push   $0x1bc81
   17440:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
   17446:	50                   	push   %eax
   17447:	e8 29 28 00 00       	call   19c75 <usprint>
   1744c:	83 c4 10             	add    $0x10,%esp
		cwrites( buf );
   1744f:	83 ec 0c             	sub    $0xc,%esp
   17452:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
   17458:	50                   	push   %eax
   17459:	e8 04 2f 00 00       	call   1a362 <cwrites>
   1745e:	83 c4 10             	add    $0x10,%esp
}
   17461:	eb 1f                	jmp    17482 <process+0xcf>
		swritech( ch );
   17463:	0f b6 05 3c d6 01 00 	movzbl 0x1d63c,%eax
   1746a:	0f be c0             	movsbl %al,%eax
   1746d:	83 ec 0c             	sub    $0xc,%esp
   17470:	50                   	push   %eax
   17471:	e8 31 2f 00 00       	call   1a3a7 <swritech>
   17476:	83 c4 10             	add    $0x10,%esp
		proc->pid = p;
   17479:	8b 55 f4             	mov    -0xc(%ebp),%edx
   1747c:	8b 45 08             	mov    0x8(%ebp),%eax
   1747f:	89 50 04             	mov    %edx,0x4(%eax)
}
   17482:	90                   	nop
   17483:	c9                   	leave  
   17484:	c3                   	ret    
...
USERMAIN( init ) {
   17485:	55                   	push   %ebp
   17486:	89 e5                	mov    %esp,%ebp
   17488:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   1748e:	8b 45 0c             	mov    0xc(%ebp),%eax
   17491:	8b 00                	mov    (%eax),%eax
   17493:	85 c0                	test   %eax,%eax
   17495:	74 07                	je     1749e <init+0x19>
   17497:	8b 45 0c             	mov    0xc(%ebp),%eax
   1749a:	8b 00                	mov    (%eax),%eax
   1749c:	eb 05                	jmp    174a3 <init+0x1e>
   1749e:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   174a3:	89 45 e8             	mov    %eax,-0x18(%ebp)
	char buf[128];

	// check to see if we got a non-standard "spawn" character
	if( argc > 1 ) {
   174a6:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
   174aa:	7e 2d                	jle    174d9 <init+0x54>
		// maybe - check it to be sure it's printable
		uint_t i = argv[1][0];
   174ac:	8b 45 0c             	mov    0xc(%ebp),%eax
   174af:	83 c0 04             	add    $0x4,%eax
   174b2:	8b 00                	mov    (%eax),%eax
   174b4:	0f b6 00             	movzbl (%eax),%eax
   174b7:	0f be c0             	movsbl %al,%eax
   174ba:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		if( i > ' ' && i < 0x7f ) {
   174bd:	83 7d e4 20          	cmpl   $0x20,-0x1c(%ebp)
   174c1:	76 16                	jbe    174d9 <init+0x54>
   174c3:	83 7d e4 7e          	cmpl   $0x7e,-0x1c(%ebp)
   174c7:	77 10                	ja     174d9 <init+0x54>
			ch = argv[1][0];
   174c9:	8b 45 0c             	mov    0xc(%ebp),%eax
   174cc:	83 c0 04             	add    $0x4,%eax
   174cf:	8b 00                	mov    (%eax),%eax
   174d1:	0f b6 00             	movzbl (%eax),%eax
   174d4:	a2 3c d6 01 00       	mov    %al,0x1d63c
		}
	}

	// test the sio
	write( CHAN_SIO, "$+$\n", 4 );
   174d9:	83 ec 04             	sub    $0x4,%esp
   174dc:	6a 04                	push   $0x4
   174de:	68 9c bc 01 00       	push   $0x1bc9c
   174e3:	6a 01                	push   $0x1
   174e5:	e8 09 fa ff ff       	call   16ef3 <write>
   174ea:	83 c4 10             	add    $0x10,%esp
	DELAY(SHORT);
   174ed:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
   174f4:	eb 04                	jmp    174fa <init+0x75>
   174f6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
   174fa:	81 7d f4 9f 25 26 00 	cmpl   $0x26259f,-0xc(%ebp)
   17501:	7e f3                	jle    174f6 <init+0x71>

	usprint( buf, "%s: started\n", name );
   17503:	83 ec 04             	sub    $0x4,%esp
   17506:	ff 75 e8             	pushl  -0x18(%ebp)
   17509:	68 a1 bc 01 00       	push   $0x1bca1
   1750e:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   17514:	50                   	push   %eax
   17515:	e8 5b 27 00 00       	call   19c75 <usprint>
   1751a:	83 c4 10             	add    $0x10,%esp
	cwrites( buf );
   1751d:	83 ec 0c             	sub    $0xc,%esp
   17520:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   17526:	50                   	push   %eax
   17527:	e8 36 2e 00 00       	call   1a362 <cwrites>
   1752c:	83 c4 10             	add    $0x10,%esp
	...
	// wait a bit
	DELAY(SHORT);
   1752f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
   17536:	eb 04                	jmp    1753c <init+0xb7>
   17538:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
   1753c:	81 7d f0 9f 25 26 00 	cmpl   $0x26259f,-0x10(%ebp)
   17543:	7e f3                	jle    17538 <init+0xb3>

	// a bit of Dante to set the mood :-)
	swrites( "\n\nSpem relinquunt qui huc intrasti!\n\n\r" );
   17545:	83 ec 0c             	sub    $0xc,%esp
   17548:	68 b0 bc 01 00       	push   $0x1bcb0
   1754d:	e8 76 2e 00 00       	call   1a3c8 <swrites>
   17552:	83 c4 10             	add    $0x10,%esp
   ...
   17555:	83 ec 04             	sub    $0x4,%esp
   17558:	ff 75 e8             	pushl  -0x18(%ebp)
   1755b:	68 d7 bc 01 00       	push   $0x1bcd7
   17560:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   17566:	50                   	push   %eax
   17567:	e8 09 27 00 00       	call   19c75 <usprint>
   1756c:	83 c4 10             	add    $0x10,%esp
	cwrites( buf );
   1756f:	83 ec 0c             	sub    $0xc,%esp
   17572:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   17578:	50                   	push   %eax
   17579:	e8 e4 2d 00 00       	call   1a362 <cwrites>
   1757e:	83 c4 10             	add    $0x10,%esp

	proc_t *next;
	for( next = init_spawn_table; next->entry != TBLEND; ++next ) {
   17581:	c7 45 ec a0 d5 01 00 	movl   $0x1d5a0,-0x14(%ebp)
   17588:	eb 12                	jmp    1759c <init+0x117>
		process( next );
   1758a:	83 ec 0c             	sub    $0xc,%esp
   1758d:	ff 75 ec             	pushl  -0x14(%ebp)
   17590:	e8 1e fe ff ff       	call   173b3 <process>
   17595:	83 c4 10             	add    $0x10,%esp
	for( next = init_spawn_table; next->entry != TBLEND; ++next ) {
   17598:	83 45 ec 34          	addl   $0x34,-0x14(%ebp)
   1759c:	8b 45 ec             	mov    -0x14(%ebp),%eax
   1759f:	8b 00                	mov    (%eax),%eax
   175a1:	3d ed ad be de       	cmp    $0xdebeaded,%eax
   175a6:	75 e2                	jne    1758a <init+0x105>
	}

	swrites( " !!!\r\n\n" );
   175a8:	83 ec 0c             	sub    $0xc,%esp
   175ab:	68 f4 bc 01 00       	push   $0x1bcf4
   175b0:	e8 13 2e 00 00       	call   1a3c8 <swrites>
   175b5:	83 c4 10             	add    $0x10,%esp
	/*
   ...
   175b8:	83 ec 04             	sub    $0x4,%esp
   175bb:	ff 75 e8             	pushl  -0x18(%ebp)
   175be:	68 fc bc 01 00       	push   $0x1bcfc
   175c3:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   175c9:	50                   	push   %eax
   175ca:	e8 a6 26 00 00       	call   19c75 <usprint>
   175cf:	83 c4 10             	add    $0x10,%esp
	cwrites( buf );
   175d2:	83 ec 0c             	sub    $0xc,%esp
   175d5:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   175db:	50                   	push   %eax
   175dc:	e8 81 2d 00 00       	call   1a362 <cwrites>
   175e1:	83 c4 10             	add    $0x10,%esp

	for(;;) {
		int32_t status;
		int whom = waitpid( 0, &status );
   175e4:	83 ec 08             	sub    $0x8,%esp
   175e7:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   175ed:	50                   	push   %eax
   175ee:	6a 00                	push   $0x0
   175f0:	e8 de f8 ff ff       	call   16ed3 <waitpid>
   175f5:	83 c4 10             	add    $0x10,%esp
   175f8:	89 45 e0             	mov    %eax,-0x20(%ebp)

		// PIDs must be positive numbers!
		if( whom <= 0 ) {
   175fb:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
   175ff:	7f 2e                	jg     1762f <init+0x1aa>

			usprint( buf, "%s: waitpid() returned %d???\n", name, whom );
   17601:	ff 75 e0             	pushl  -0x20(%ebp)
   17604:	ff 75 e8             	pushl  -0x18(%ebp)
   17607:	68 1e bd 01 00       	push   $0x1bd1e
   1760c:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   17612:	50                   	push   %eax
   17613:	e8 5d 26 00 00       	call   19c75 <usprint>
   17618:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   1761b:	83 ec 0c             	sub    $0xc,%esp
   1761e:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   17624:	50                   	push   %eax
   17625:	e8 38 2d 00 00       	call   1a362 <cwrites>
   1762a:	83 c4 10             	add    $0x10,%esp
   1762d:	eb b5                	jmp    175e4 <init+0x15f>

		} else {

			// got one; report it
			usprint( buf, "%s: pid %d exit(%d)\n", name, whom, status );
   1762f:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
   17635:	83 ec 0c             	sub    $0xc,%esp
   17638:	50                   	push   %eax
   17639:	ff 75 e0             	pushl  -0x20(%ebp)
   1763c:	ff 75 e8             	pushl  -0x18(%ebp)
   1763f:	68 3c bd 01 00       	push   $0x1bd3c
   17644:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   1764a:	50                   	push   %eax
   1764b:	e8 25 26 00 00       	call   19c75 <usprint>
   17650:	83 c4 20             	add    $0x20,%esp
			cwrites( buf );
   17653:	83 ec 0c             	sub    $0xc,%esp
   17656:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
   1765c:	50                   	push   %eax
   1765d:	e8 00 2d 00 00       	call   1a362 <cwrites>
   17662:	83 c4 10             	add    $0x10,%esp

			// figure out if this is one of ours
			for( next = init_spawn_table; next->entry != TBLEND; ++next ) {
   17665:	c7 45 ec a0 d5 01 00 	movl   $0x1d5a0,-0x14(%ebp)
   1766c:	eb 2b                	jmp    17699 <init+0x214>
				if( next->pid == whom ) {
   1766e:	8b 45 ec             	mov    -0x14(%ebp),%eax
   17671:	8b 50 04             	mov    0x4(%eax),%edx
   17674:	8b 45 e0             	mov    -0x20(%ebp),%eax
   17677:	39 c2                	cmp    %eax,%edx
   17679:	75 1a                	jne    17695 <init+0x210>
					// one of ours - reset the PID field
					// (in case the spawn attempt fails)
					next->pid = 0;
   1767b:	8b 45 ec             	mov    -0x14(%ebp),%eax
   1767e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
					// and restart it
					process( next );
   17685:	83 ec 0c             	sub    $0xc,%esp
   17688:	ff 75 ec             	pushl  -0x14(%ebp)
   1768b:	e8 23 fd ff ff       	call   173b3 <process>
   17690:	83 c4 10             	add    $0x10,%esp
					break;
   17693:	eb 10                	jmp    176a5 <init+0x220>
			for( next = init_spawn_table; next->entry != TBLEND; ++next ) {
   17695:	83 45 ec 34          	addl   $0x34,-0x14(%ebp)
   17699:	8b 45 ec             	mov    -0x14(%ebp),%eax
   1769c:	8b 00                	mov    (%eax),%eax
   1769e:	3d ed ad be de       	cmp    $0xdebeaded,%eax
   176a3:	75 c9                	jne    1766e <init+0x1e9>
	for(;;) {
   176a5:	e9 3a ff ff ff       	jmp    175e4 <init+0x15f>
...
USERMAIN( progABC ) {
   176aa:	55                   	push   %ebp
   176ab:	89 e5                	mov    %esp,%ebp
   176ad:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   176b3:	8b 45 0c             	mov    0xc(%ebp),%eax
   176b6:	8b 00                	mov    (%eax),%eax
   176b8:	85 c0                	test   %eax,%eax
   176ba:	74 07                	je     176c3 <progABC+0x19>
   176bc:	8b 45 0c             	mov    0xc(%ebp),%eax
   176bf:	8b 00                	mov    (%eax),%eax
   176c1:	eb 05                	jmp    176c8 <progABC+0x1e>
   176c3:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   176c8:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int count = 30; // default iteration count
   176cb:	c7 45 f4 1e 00 00 00 	movl   $0x1e,-0xc(%ebp)
	char ch = '1';	// default character to print
   176d2:	c6 45 f3 31          	movb   $0x31,-0xd(%ebp)
	char buf[128];	// local char buffer

	// process the command-line arguments
	switch( argc ) {
   176d6:	8b 45 08             	mov    0x8(%ebp),%eax
   176d9:	83 f8 02             	cmp    $0x2,%eax
   176dc:	74 1e                	je     176fc <progABC+0x52>
   176de:	83 f8 03             	cmp    $0x3,%eax
   176e1:	75 2c                	jne    1770f <progABC+0x65>
	case 3:	count = ustr2int( argv[2], 10 );
   176e3:	8b 45 0c             	mov    0xc(%ebp),%eax
   176e6:	83 c0 08             	add    $0x8,%eax
   176e9:	8b 00                	mov    (%eax),%eax
   176eb:	83 ec 08             	sub    $0x8,%esp
   176ee:	6a 0a                	push   $0xa
   176f0:	50                   	push   %eax
   176f1:	e8 f4 27 00 00       	call   19eea <ustr2int>
   176f6:	83 c4 10             	add    $0x10,%esp
   176f9:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   176fc:	8b 45 0c             	mov    0xc(%ebp),%eax
   176ff:	83 c0 04             	add    $0x4,%eax
   17702:	8b 00                	mov    (%eax),%eax
   17704:	0f b6 00             	movzbl (%eax),%eax
   17707:	88 45 f3             	mov    %al,-0xd(%ebp)
			break;
   1770a:	e9 a8 00 00 00       	jmp    177b7 <progABC+0x10d>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   1770f:	ff 75 08             	pushl  0x8(%ebp)
   17712:	ff 75 e0             	pushl  -0x20(%ebp)
   17715:	68 51 bd 01 00       	push   $0x1bd51
   1771a:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17720:	50                   	push   %eax
   17721:	e8 4f 25 00 00       	call   19c75 <usprint>
   17726:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   17729:	83 ec 0c             	sub    $0xc,%esp
   1772c:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17732:	50                   	push   %eax
   17733:	e8 2a 2c 00 00       	call   1a362 <cwrites>
   17738:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   1773b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   17742:	eb 5b                	jmp    1779f <progABC+0xf5>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   17744:	8b 45 08             	mov    0x8(%ebp),%eax
   17747:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   1774e:	8b 45 0c             	mov    0xc(%ebp),%eax
   17751:	01 d0                	add    %edx,%eax
   17753:	8b 00                	mov    (%eax),%eax
   17755:	85 c0                	test   %eax,%eax
   17757:	74 13                	je     1776c <progABC+0xc2>
   17759:	8b 45 08             	mov    0x8(%ebp),%eax
   1775c:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   17763:	8b 45 0c             	mov    0xc(%ebp),%eax
   17766:	01 d0                	add    %edx,%eax
   17768:	8b 00                	mov    (%eax),%eax
   1776a:	eb 05                	jmp    17771 <progABC+0xc7>
   1776c:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   17771:	83 ec 04             	sub    $0x4,%esp
   17774:	50                   	push   %eax
   17775:	68 6c bd 01 00       	push   $0x1bd6c
   1777a:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17780:	50                   	push   %eax
   17781:	e8 ef 24 00 00       	call   19c75 <usprint>
   17786:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   17789:	83 ec 0c             	sub    $0xc,%esp
   1778c:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17792:	50                   	push   %eax
   17793:	e8 ca 2b 00 00       	call   1a362 <cwrites>
   17798:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   1779b:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   1779f:	8b 45 ec             	mov    -0x14(%ebp),%eax
   177a2:	3b 45 08             	cmp    0x8(%ebp),%eax
   177a5:	7e 9d                	jle    17744 <progABC+0x9a>
			}
			cwrites( "\n" );
   177a7:	83 ec 0c             	sub    $0xc,%esp
   177aa:	68 70 bd 01 00       	push   $0x1bd70
   177af:	e8 ae 2b 00 00       	call   1a362 <cwrites>
   177b4:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	int n = swritech( ch );
   177b7:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   177bb:	83 ec 0c             	sub    $0xc,%esp
   177be:	50                   	push   %eax
   177bf:	e8 e3 2b 00 00       	call   1a3a7 <swritech>
   177c4:	83 c4 10             	add    $0x10,%esp
   177c7:	89 45 dc             	mov    %eax,-0x24(%ebp)
	if( n != 1 ) {
   177ca:	83 7d dc 01          	cmpl   $0x1,-0x24(%ebp)
   177ce:	74 2e                	je     177fe <progABC+0x154>
		usprint( buf, "== %c, write #1 returned %d\n", ch, n );
   177d0:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   177d4:	ff 75 dc             	pushl  -0x24(%ebp)
   177d7:	50                   	push   %eax
   177d8:	68 72 bd 01 00       	push   $0x1bd72
   177dd:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   177e3:	50                   	push   %eax
   177e4:	e8 8c 24 00 00       	call   19c75 <usprint>
   177e9:	83 c4 10             	add    $0x10,%esp
		cwrites( buf );
   177ec:	83 ec 0c             	sub    $0xc,%esp
   177ef:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   177f5:	50                   	push   %eax
   177f6:	e8 67 2b 00 00       	call   1a362 <cwrites>
   177fb:	83 c4 10             	add    $0x10,%esp
	}

	// iterate and print the required number of other characters
	for( int i = 0; i < count; ++i ) {
   177fe:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   17805:	eb 61                	jmp    17868 <progABC+0x1be>
		DELAY(STD);
   17807:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
   1780e:	eb 04                	jmp    17814 <progABC+0x16a>
   17810:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
   17814:	81 7d e4 9f 25 26 00 	cmpl   $0x26259f,-0x1c(%ebp)
   1781b:	7e f3                	jle    17810 <progABC+0x166>
		n = swritech( ch );
   1781d:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   17821:	83 ec 0c             	sub    $0xc,%esp
   17824:	50                   	push   %eax
   17825:	e8 7d 2b 00 00       	call   1a3a7 <swritech>
   1782a:	83 c4 10             	add    $0x10,%esp
   1782d:	89 45 dc             	mov    %eax,-0x24(%ebp)
		if( n != 1 ) {
   17830:	83 7d dc 01          	cmpl   $0x1,-0x24(%ebp)
   17834:	74 2e                	je     17864 <progABC+0x1ba>
			usprint( buf, "== %c, write #2 returned %d\n", ch, n );
   17836:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   1783a:	ff 75 dc             	pushl  -0x24(%ebp)
   1783d:	50                   	push   %eax
   1783e:	68 8f bd 01 00       	push   $0x1bd8f
   17843:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17849:	50                   	push   %eax
   1784a:	e8 26 24 00 00       	call   19c75 <usprint>
   1784f:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   17852:	83 ec 0c             	sub    $0xc,%esp
   17855:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   1785b:	50                   	push   %eax
   1785c:	e8 01 2b 00 00       	call   1a362 <cwrites>
   17861:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count; ++i ) {
   17864:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   17868:	8b 45 e8             	mov    -0x18(%ebp),%eax
   1786b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   1786e:	7c 97                	jl     17807 <progABC+0x15d>
		}
	}
   ...
   17873:	6a 00                	push   $0x0
   17875:	e8 51 f6 ff ff       	call   16ecb <exit>
   1787a:	83 c4 10             	add    $0x10,%esp
	...
	char msg[] = "*1*";
   1787d:	c7 85 58 ff ff ff 2a 	movl   $0x2a312a,-0xa8(%ebp)
   17884:	31 2a 00 
	msg[1] = ch;
   17887:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
   1788b:	88 85 59 ff ff ff    	mov    %al,-0xa7(%ebp)
	n = write( CHAN_SIO, msg, 3 );	  /* shouldn't happen! */
   17891:	83 ec 04             	sub    $0x4,%esp
   17894:	6a 03                	push   $0x3
   17896:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   1789c:	50                   	push   %eax
   1789d:	6a 01                	push   $0x1
   1789f:	e8 4f f6 ff ff       	call   16ef3 <write>
   178a4:	83 c4 10             	add    $0x10,%esp
   178a7:	89 45 dc             	mov    %eax,-0x24(%ebp)
	if( n != 3 ) {
   178aa:	83 7d dc 03          	cmpl   $0x3,-0x24(%ebp)
   178ae:	74 2e                	je     178de <progABC+0x234>
		usprint( buf, "User %c, write #3 returned %d\n", ch, n );
   178b0:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   178b4:	ff 75 dc             	pushl  -0x24(%ebp)
   178b7:	50                   	push   %eax
   178b8:	68 ac bd 01 00       	push   $0x1bdac
   178bd:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   178c3:	50                   	push   %eax
   178c4:	e8 ac 23 00 00       	call   19c75 <usprint>
   178c9:	83 c4 10             	add    $0x10,%esp
		cwrites( buf );
   178cc:	83 ec 0c             	sub    $0xc,%esp
   178cf:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   178d5:	50                   	push   %eax
   178d6:	e8 87 2a 00 00       	call   1a362 <cwrites>
   178db:	83 c4 10             	add    $0x10,%esp
	}

	// this should really get us out of here
	return( 42 );
   178de:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   178e3:	c9                   	leave  
   178e4:	c3                   	ret    
...
USERMAIN( progDE ) {
   178e5:	55                   	push   %ebp
   178e6:	89 e5                	mov    %esp,%ebp
   178e8:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   178ee:	8b 45 0c             	mov    0xc(%ebp),%eax
   178f1:	8b 00                	mov    (%eax),%eax
   178f3:	85 c0                	test   %eax,%eax
   178f5:	74 07                	je     178fe <progDE+0x19>
   178f7:	8b 45 0c             	mov    0xc(%ebp),%eax
   178fa:	8b 00                	mov    (%eax),%eax
   178fc:	eb 05                	jmp    17903 <progDE+0x1e>
   178fe:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   17903:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int n;
	int count = 30;	  // default iteration count
   17906:	c7 45 f4 1e 00 00 00 	movl   $0x1e,-0xc(%ebp)
	char ch = '2';	  // default character to print
   1790d:	c6 45 f3 32          	movb   $0x32,-0xd(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   17911:	8b 45 08             	mov    0x8(%ebp),%eax
   17914:	83 f8 02             	cmp    $0x2,%eax
   17917:	74 1e                	je     17937 <progDE+0x52>
   17919:	83 f8 03             	cmp    $0x3,%eax
   1791c:	75 2c                	jne    1794a <progDE+0x65>
	case 3:	count = ustr2int( argv[2], 10 );
   1791e:	8b 45 0c             	mov    0xc(%ebp),%eax
   17921:	83 c0 08             	add    $0x8,%eax
   17924:	8b 00                	mov    (%eax),%eax
   17926:	83 ec 08             	sub    $0x8,%esp
   17929:	6a 0a                	push   $0xa
   1792b:	50                   	push   %eax
   1792c:	e8 b9 25 00 00       	call   19eea <ustr2int>
   17931:	83 c4 10             	add    $0x10,%esp
   17934:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   17937:	8b 45 0c             	mov    0xc(%ebp),%eax
   1793a:	83 c0 04             	add    $0x4,%eax
   1793d:	8b 00                	mov    (%eax),%eax
   1793f:	0f b6 00             	movzbl (%eax),%eax
   17942:	88 45 f3             	mov    %al,-0xd(%ebp)
			break;
   17945:	e9 a8 00 00 00       	jmp    179f2 <progDE+0x10d>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   1794a:	ff 75 08             	pushl  0x8(%ebp)
   1794d:	ff 75 e0             	pushl  -0x20(%ebp)
   17950:	68 51 bd 01 00       	push   $0x1bd51
   17955:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   1795b:	50                   	push   %eax
   1795c:	e8 14 23 00 00       	call   19c75 <usprint>
   17961:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   17964:	83 ec 0c             	sub    $0xc,%esp
   17967:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   1796d:	50                   	push   %eax
   1796e:	e8 ef 29 00 00       	call   1a362 <cwrites>
   17973:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   17976:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   1797d:	eb 5b                	jmp    179da <progDE+0xf5>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   1797f:	8b 45 08             	mov    0x8(%ebp),%eax
   17982:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   17989:	8b 45 0c             	mov    0xc(%ebp),%eax
   1798c:	01 d0                	add    %edx,%eax
   1798e:	8b 00                	mov    (%eax),%eax
   17990:	85 c0                	test   %eax,%eax
   17992:	74 13                	je     179a7 <progDE+0xc2>
   17994:	8b 45 08             	mov    0x8(%ebp),%eax
   17997:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   1799e:	8b 45 0c             	mov    0xc(%ebp),%eax
   179a1:	01 d0                	add    %edx,%eax
   179a3:	8b 00                	mov    (%eax),%eax
   179a5:	eb 05                	jmp    179ac <progDE+0xc7>
   179a7:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   179ac:	83 ec 04             	sub    $0x4,%esp
   179af:	50                   	push   %eax
   179b0:	68 6c bd 01 00       	push   $0x1bd6c
   179b5:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   179bb:	50                   	push   %eax
   179bc:	e8 b4 22 00 00       	call   19c75 <usprint>
   179c1:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   179c4:	83 ec 0c             	sub    $0xc,%esp
   179c7:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   179cd:	50                   	push   %eax
   179ce:	e8 8f 29 00 00       	call   1a362 <cwrites>
   179d3:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   179d6:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   179da:	8b 45 ec             	mov    -0x14(%ebp),%eax
   179dd:	3b 45 08             	cmp    0x8(%ebp),%eax
   179e0:	7e 9d                	jle    1797f <progDE+0x9a>
			}
			cwrites( "\n" );
   179e2:	83 ec 0c             	sub    $0xc,%esp
   179e5:	68 70 bd 01 00       	push   $0x1bd70
   179ea:	e8 73 29 00 00       	call   1a362 <cwrites>
   179ef:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	n = swritech( ch );
   179f2:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   179f6:	83 ec 0c             	sub    $0xc,%esp
   179f9:	50                   	push   %eax
   179fa:	e8 a8 29 00 00       	call   1a3a7 <swritech>
   179ff:	83 c4 10             	add    $0x10,%esp
   17a02:	89 45 dc             	mov    %eax,-0x24(%ebp)
	if( n != 1 ) {
   17a05:	83 7d dc 01          	cmpl   $0x1,-0x24(%ebp)
   17a09:	74 2e                	je     17a39 <progDE+0x154>
		usprint( buf, "== %c, write #1 returned %d\n", ch, n );
   17a0b:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   17a0f:	ff 75 dc             	pushl  -0x24(%ebp)
   17a12:	50                   	push   %eax
   17a13:	68 72 bd 01 00       	push   $0x1bd72
   17a18:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17a1e:	50                   	push   %eax
   17a1f:	e8 51 22 00 00       	call   19c75 <usprint>
   17a24:	83 c4 10             	add    $0x10,%esp
		cwrites( buf );
   17a27:	83 ec 0c             	sub    $0xc,%esp
   17a2a:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17a30:	50                   	push   %eax
   17a31:	e8 2c 29 00 00       	call   1a362 <cwrites>
   17a36:	83 c4 10             	add    $0x10,%esp
	}

	// iterate and print the required number of other characters
	for( int i = 0; i < count; ++i ) {
   17a39:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   17a40:	eb 61                	jmp    17aa3 <progDE+0x1be>
		DELAY(STD);
   17a42:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
   17a49:	eb 04                	jmp    17a4f <progDE+0x16a>
   17a4b:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
   17a4f:	81 7d e4 9f 25 26 00 	cmpl   $0x26259f,-0x1c(%ebp)
   17a56:	7e f3                	jle    17a4b <progDE+0x166>
		n = swritech( ch );
   17a58:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   17a5c:	83 ec 0c             	sub    $0xc,%esp
   17a5f:	50                   	push   %eax
   17a60:	e8 42 29 00 00       	call   1a3a7 <swritech>
   17a65:	83 c4 10             	add    $0x10,%esp
   17a68:	89 45 dc             	mov    %eax,-0x24(%ebp)
		if( n != 1 ) {
   17a6b:	83 7d dc 01          	cmpl   $0x1,-0x24(%ebp)
   17a6f:	74 2e                	je     17a9f <progDE+0x1ba>
			usprint( buf, "== %c, write #2 returned %d\n", ch, n );
   17a71:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   17a75:	ff 75 dc             	pushl  -0x24(%ebp)
   17a78:	50                   	push   %eax
   17a79:	68 8f bd 01 00       	push   $0x1bd8f
   17a7e:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17a84:	50                   	push   %eax
   17a85:	e8 eb 21 00 00       	call   19c75 <usprint>
   17a8a:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   17a8d:	83 ec 0c             	sub    $0xc,%esp
   17a90:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17a96:	50                   	push   %eax
   17a97:	e8 c6 28 00 00       	call   1a362 <cwrites>
   17a9c:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count; ++i ) {
   17a9f:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   17aa3:	8b 45 e8             	mov    -0x18(%ebp),%eax
   17aa6:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   17aa9:	7c 97                	jl     17a42 <progDE+0x15d>
		}
	}

	// all done!
	return( 0 );
   17aab:	b8 00 00 00 00       	mov    $0x0,%eax
}
   17ab0:	c9                   	leave  
   17ab1:	c3                   	ret    
...
USERMAIN( progFG ) {
   17ab2:	55                   	push   %ebp
   17ab3:	89 e5                	mov    %esp,%ebp
   17ab5:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   17abb:	8b 45 0c             	mov    0xc(%ebp),%eax
   17abe:	8b 00                	mov    (%eax),%eax
   17ac0:	85 c0                	test   %eax,%eax
   17ac2:	74 07                	je     17acb <progFG+0x19>
   17ac4:	8b 45 0c             	mov    0xc(%ebp),%eax
   17ac7:	8b 00                	mov    (%eax),%eax
   17ac9:	eb 05                	jmp    17ad0 <progFG+0x1e>
   17acb:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   17ad0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	char ch = '3';	// default character to print
   17ad3:	c6 45 df 33          	movb   $0x33,-0x21(%ebp)
	int nap = 10;	// default sleep time
   17ad7:	c7 45 f4 0a 00 00 00 	movl   $0xa,-0xc(%ebp)
	int count = 30;	// iteration count
   17ade:	c7 45 f0 1e 00 00 00 	movl   $0x1e,-0x10(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   17ae5:	8b 45 08             	mov    0x8(%ebp),%eax
   17ae8:	83 f8 03             	cmp    $0x3,%eax
   17aeb:	74 25                	je     17b12 <progFG+0x60>
   17aed:	83 f8 04             	cmp    $0x4,%eax
   17af0:	74 07                	je     17af9 <progFG+0x47>
   17af2:	83 f8 02             	cmp    $0x2,%eax
   17af5:	74 34                	je     17b2b <progFG+0x79>
   17af7:	eb 45                	jmp    17b3e <progFG+0x8c>
	case 4:	nap = ustr2int( argv[3], 10 );
   17af9:	8b 45 0c             	mov    0xc(%ebp),%eax
   17afc:	83 c0 0c             	add    $0xc,%eax
   17aff:	8b 00                	mov    (%eax),%eax
   17b01:	83 ec 08             	sub    $0x8,%esp
   17b04:	6a 0a                	push   $0xa
   17b06:	50                   	push   %eax
   17b07:	e8 de 23 00 00       	call   19eea <ustr2int>
   17b0c:	83 c4 10             	add    $0x10,%esp
   17b0f:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 3:	count = ustr2int( argv[2], 10 );
   17b12:	8b 45 0c             	mov    0xc(%ebp),%eax
   17b15:	83 c0 08             	add    $0x8,%eax
   17b18:	8b 00                	mov    (%eax),%eax
   17b1a:	83 ec 08             	sub    $0x8,%esp
   17b1d:	6a 0a                	push   $0xa
   17b1f:	50                   	push   %eax
   17b20:	e8 c5 23 00 00       	call   19eea <ustr2int>
   17b25:	83 c4 10             	add    $0x10,%esp
   17b28:	89 45 f0             	mov    %eax,-0x10(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   17b2b:	8b 45 0c             	mov    0xc(%ebp),%eax
   17b2e:	83 c0 04             	add    $0x4,%eax
   17b31:	8b 00                	mov    (%eax),%eax
   17b33:	0f b6 00             	movzbl (%eax),%eax
   17b36:	88 45 df             	mov    %al,-0x21(%ebp)
			break;
   17b39:	e9 a8 00 00 00       	jmp    17be6 <progFG+0x134>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   17b3e:	ff 75 08             	pushl  0x8(%ebp)
   17b41:	ff 75 e4             	pushl  -0x1c(%ebp)
   17b44:	68 51 bd 01 00       	push   $0x1bd51
   17b49:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   17b4f:	50                   	push   %eax
   17b50:	e8 20 21 00 00       	call   19c75 <usprint>
   17b55:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   17b58:	83 ec 0c             	sub    $0xc,%esp
   17b5b:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   17b61:	50                   	push   %eax
   17b62:	e8 fb 27 00 00       	call   1a362 <cwrites>
   17b67:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   17b6a:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   17b71:	eb 5b                	jmp    17bce <progFG+0x11c>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   17b73:	8b 45 08             	mov    0x8(%ebp),%eax
   17b76:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   17b7d:	8b 45 0c             	mov    0xc(%ebp),%eax
   17b80:	01 d0                	add    %edx,%eax
   17b82:	8b 00                	mov    (%eax),%eax
   17b84:	85 c0                	test   %eax,%eax
   17b86:	74 13                	je     17b9b <progFG+0xe9>
   17b88:	8b 45 08             	mov    0x8(%ebp),%eax
   17b8b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   17b92:	8b 45 0c             	mov    0xc(%ebp),%eax
   17b95:	01 d0                	add    %edx,%eax
   17b97:	8b 00                	mov    (%eax),%eax
   17b99:	eb 05                	jmp    17ba0 <progFG+0xee>
   17b9b:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   17ba0:	83 ec 04             	sub    $0x4,%esp
   17ba3:	50                   	push   %eax
   17ba4:	68 6c bd 01 00       	push   $0x1bd6c
   17ba9:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   17baf:	50                   	push   %eax
   17bb0:	e8 c0 20 00 00       	call   19c75 <usprint>
   17bb5:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   17bb8:	83 ec 0c             	sub    $0xc,%esp
   17bbb:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   17bc1:	50                   	push   %eax
   17bc2:	e8 9b 27 00 00       	call   1a362 <cwrites>
   17bc7:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   17bca:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   17bce:	8b 45 ec             	mov    -0x14(%ebp),%eax
   17bd1:	3b 45 08             	cmp    0x8(%ebp),%eax
   17bd4:	7e 9d                	jle    17b73 <progFG+0xc1>
			}
			cwrites( "\n" );
   17bd6:	83 ec 0c             	sub    $0xc,%esp
   17bd9:	68 70 bd 01 00       	push   $0x1bd70
   17bde:	e8 7f 27 00 00       	call   1a362 <cwrites>
   17be3:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	int n = swritech( ch );
   17be6:	0f b6 45 df          	movzbl -0x21(%ebp),%eax
   17bea:	0f be c0             	movsbl %al,%eax
   17bed:	83 ec 0c             	sub    $0xc,%esp
   17bf0:	50                   	push   %eax
   17bf1:	e8 b1 27 00 00       	call   1a3a7 <swritech>
   17bf6:	83 c4 10             	add    $0x10,%esp
   17bf9:	89 45 e0             	mov    %eax,-0x20(%ebp)
	if( n != 1 ) {
   17bfc:	83 7d e0 01          	cmpl   $0x1,-0x20(%ebp)
   17c00:	74 31                	je     17c33 <progFG+0x181>
		usprint( buf, "=== %c, write #1 returned %d\n", ch, n );
   17c02:	0f b6 45 df          	movzbl -0x21(%ebp),%eax
   17c06:	0f be c0             	movsbl %al,%eax
   17c09:	ff 75 e0             	pushl  -0x20(%ebp)
   17c0c:	50                   	push   %eax
   17c0d:	68 cb bd 01 00       	push   $0x1bdcb
   17c12:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   17c18:	50                   	push   %eax
   17c19:	e8 57 20 00 00       	call   19c75 <usprint>
   17c1e:	83 c4 10             	add    $0x10,%esp
		cwrites( buf );
   17c21:	83 ec 0c             	sub    $0xc,%esp
   17c24:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   17c2a:	50                   	push   %eax
   17c2b:	e8 32 27 00 00       	call   1a362 <cwrites>
   17c30:	83 c4 10             	add    $0x10,%esp
	}

	write( CHAN_SIO, &ch, 1 );
   17c33:	83 ec 04             	sub    $0x4,%esp
   17c36:	6a 01                	push   $0x1
   17c38:	8d 45 df             	lea    -0x21(%ebp),%eax
   17c3b:	50                   	push   %eax
   17c3c:	6a 01                	push   $0x1
   17c3e:	e8 b0 f2 ff ff       	call   16ef3 <write>
   17c43:	83 c4 10             	add    $0x10,%esp

	for( int i = 0; i < count ; ++i ) {
   17c46:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   17c4d:	eb 2c                	jmp    17c7b <progFG+0x1c9>
		sleep( SEC_TO_MS(nap) );
   17c4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
   17c52:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   17c58:	83 ec 0c             	sub    $0xc,%esp
   17c5b:	50                   	push   %eax
   17c5c:	e8 ca f2 ff ff       	call   16f2b <sleep>
   17c61:	83 c4 10             	add    $0x10,%esp
		write( CHAN_SIO, &ch, 1 );
   17c64:	83 ec 04             	sub    $0x4,%esp
   17c67:	6a 01                	push   $0x1
   17c69:	8d 45 df             	lea    -0x21(%ebp),%eax
   17c6c:	50                   	push   %eax
   17c6d:	6a 01                	push   $0x1
   17c6f:	e8 7f f2 ff ff       	call   16ef3 <write>
   17c74:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count ; ++i ) {
   17c77:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   17c7b:	8b 45 e8             	mov    -0x18(%ebp),%eax
   17c7e:	3b 45 f0             	cmp    -0x10(%ebp),%eax
   17c81:	7c cc                	jl     17c4f <progFG+0x19d>
	}

	exit( 0 );
   17c83:	83 ec 0c             	sub    $0xc,%esp
   17c86:	6a 00                	push   $0x0
   17c88:	e8 3e f2 ff ff       	call   16ecb <exit>
   17c8d:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   17c90:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   17c95:	c9                   	leave  
   17c96:	c3                   	ret    
...
USERMAIN( progH ) {
   17c97:	55                   	push   %ebp
   17c98:	89 e5                	mov    %esp,%ebp
   17c9a:	81 ec b8 00 00 00    	sub    $0xb8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   17ca0:	8b 45 0c             	mov    0xc(%ebp),%eax
   17ca3:	8b 00                	mov    (%eax),%eax
   17ca5:	85 c0                	test   %eax,%eax
   17ca7:	74 07                	je     17cb0 <progH+0x19>
   17ca9:	8b 45 0c             	mov    0xc(%ebp),%eax
   17cac:	8b 00                	mov    (%eax),%eax
   17cae:	eb 05                	jmp    17cb5 <progH+0x1e>
   17cb0:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   17cb5:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int32_t ret = 0;  // return value
   17cb8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int count = 5;	  // child count
   17cbf:	c7 45 f0 05 00 00 00 	movl   $0x5,-0x10(%ebp)
	char ch = 'h';	  // default character to print
   17cc6:	c6 45 ef 68          	movb   $0x68,-0x11(%ebp)
	char buf[128];
	int whom;

	// process the argument(s)
	switch( argc ) {
   17cca:	8b 45 08             	mov    0x8(%ebp),%eax
   17ccd:	83 f8 02             	cmp    $0x2,%eax
   17cd0:	74 1e                	je     17cf0 <progH+0x59>
   17cd2:	83 f8 03             	cmp    $0x3,%eax
   17cd5:	75 2c                	jne    17d03 <progH+0x6c>
	case 3:	count = ustr2int( argv[2], 10 );
   17cd7:	8b 45 0c             	mov    0xc(%ebp),%eax
   17cda:	83 c0 08             	add    $0x8,%eax
   17cdd:	8b 00                	mov    (%eax),%eax
   17cdf:	83 ec 08             	sub    $0x8,%esp
   17ce2:	6a 0a                	push   $0xa
   17ce4:	50                   	push   %eax
   17ce5:	e8 00 22 00 00       	call   19eea <ustr2int>
   17cea:	83 c4 10             	add    $0x10,%esp
   17ced:	89 45 f0             	mov    %eax,-0x10(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   17cf0:	8b 45 0c             	mov    0xc(%ebp),%eax
   17cf3:	83 c0 04             	add    $0x4,%eax
   17cf6:	8b 00                	mov    (%eax),%eax
   17cf8:	0f b6 00             	movzbl (%eax),%eax
   17cfb:	88 45 ef             	mov    %al,-0x11(%ebp)
			break;
   17cfe:	e9 a8 00 00 00       	jmp    17dab <progH+0x114>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   17d03:	ff 75 08             	pushl  0x8(%ebp)
   17d06:	ff 75 e0             	pushl  -0x20(%ebp)
   17d09:	68 51 bd 01 00       	push   $0x1bd51
   17d0e:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17d14:	50                   	push   %eax
   17d15:	e8 5b 1f 00 00       	call   19c75 <usprint>
   17d1a:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   17d1d:	83 ec 0c             	sub    $0xc,%esp
   17d20:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17d26:	50                   	push   %eax
   17d27:	e8 36 26 00 00       	call   1a362 <cwrites>
   17d2c:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   17d2f:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   17d36:	eb 5b                	jmp    17d93 <progH+0xfc>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   17d38:	8b 45 08             	mov    0x8(%ebp),%eax
   17d3b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   17d42:	8b 45 0c             	mov    0xc(%ebp),%eax
   17d45:	01 d0                	add    %edx,%eax
   17d47:	8b 00                	mov    (%eax),%eax
   17d49:	85 c0                	test   %eax,%eax
   17d4b:	74 13                	je     17d60 <progH+0xc9>
   17d4d:	8b 45 08             	mov    0x8(%ebp),%eax
   17d50:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   17d57:	8b 45 0c             	mov    0xc(%ebp),%eax
   17d5a:	01 d0                	add    %edx,%eax
   17d5c:	8b 00                	mov    (%eax),%eax
   17d5e:	eb 05                	jmp    17d65 <progH+0xce>
   17d60:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   17d65:	83 ec 04             	sub    $0x4,%esp
   17d68:	50                   	push   %eax
   17d69:	68 6c bd 01 00       	push   $0x1bd6c
   17d6e:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17d74:	50                   	push   %eax
   17d75:	e8 fb 1e 00 00       	call   19c75 <usprint>
   17d7a:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   17d7d:	83 ec 0c             	sub    $0xc,%esp
   17d80:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17d86:	50                   	push   %eax
   17d87:	e8 d6 25 00 00       	call   1a362 <cwrites>
   17d8c:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   17d8f:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   17d93:	8b 45 e8             	mov    -0x18(%ebp),%eax
   17d96:	3b 45 08             	cmp    0x8(%ebp),%eax
   17d99:	7e 9d                	jle    17d38 <progH+0xa1>
			}
			cwrites( "\n" );
   17d9b:	83 ec 0c             	sub    $0xc,%esp
   17d9e:	68 70 bd 01 00       	push   $0x1bd70
   17da3:	e8 ba 25 00 00       	call   1a362 <cwrites>
   17da8:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	swritech( ch );
   17dab:	0f be 45 ef          	movsbl -0x11(%ebp),%eax
   17daf:	83 ec 0c             	sub    $0xc,%esp
   17db2:	50                   	push   %eax
   17db3:	e8 ef 25 00 00       	call   1a3a7 <swritech>
   ...
   17dbb:	c7 85 4c ff ff ff e9 	movl   $0x1bde9,-0xb4(%ebp)
   17dc2:	bd 01 00 
   17dc5:	c7 85 50 ff ff ff ef 	movl   $0x1bdef,-0xb0(%ebp)
   17dcc:	bd 01 00 
   17dcf:	c7 85 54 ff ff ff c4 	movl   $0x1bac4,-0xac(%ebp)
   17dd6:	ba 01 00 
   17dd9:	c7 85 58 ff ff ff 00 	movl   $0x0,-0xa8(%ebp)
   17de0:	00 00 00 

	for( int i = 0; i < count; ++i ) {
   17de3:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
   17dea:	eb 57                	jmp    17e43 <progH+0x1ac>

		// spawn a child
		whom = spawn( (uint32_t) progZ, argsz );
   17dec:	ba 7d 7e 01 00       	mov    $0x17e7d,%edx
   17df1:	83 ec 08             	sub    $0x8,%esp
   17df4:	8d 85 4c ff ff ff    	lea    -0xb4(%ebp),%eax
   17dfa:	50                   	push   %eax
   17dfb:	52                   	push   %edx
   17dfc:	e8 cb 24 00 00       	call   1a2cc <spawn>
   17e01:	83 c4 10             	add    $0x10,%esp
   17e04:	89 45 dc             	mov    %eax,-0x24(%ebp)

		// our exit status is the number of failed spawn() calls
		if( whom < 0 ) {
   17e07:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
   17e0b:	79 32                	jns    17e3f <progH+0x1a8>
			usprint( buf, "!! %c spawn() failed, returned %d\n", ch, whom );
   17e0d:	0f be 45 ef          	movsbl -0x11(%ebp),%eax
   17e11:	ff 75 dc             	pushl  -0x24(%ebp)
   17e14:	50                   	push   %eax
   17e15:	68 f4 bd 01 00       	push   $0x1bdf4
   17e1a:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17e20:	50                   	push   %eax
   17e21:	e8 4f 1e 00 00       	call   19c75 <usprint>
   17e26:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   17e29:	83 ec 0c             	sub    $0xc,%esp
   17e2c:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17e32:	50                   	push   %eax
   17e33:	e8 2a 25 00 00       	call   1a362 <cwrites>
   17e38:	83 c4 10             	add    $0x10,%esp
			ret += 1;
   17e3b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
	for( int i = 0; i < count; ++i ) {
   17e3f:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
   17e43:	8b 45 e4             	mov    -0x1c(%ebp),%eax
   17e46:	3b 45 f0             	cmp    -0x10(%ebp),%eax
   17e49:	7c a1                	jl     17dec <progH+0x155>
		}
	}

	// yield the CPU so that our child(ren) can run
	sleep( 0 );
   17e4b:	83 ec 0c             	sub    $0xc,%esp
   17e4e:	6a 00                	push   $0x0
   17e50:	e8 d6 f0 ff ff       	call   16f2b <sleep>
   17e55:	83 c4 10             	add    $0x10,%esp

	// announce our departure
	swritech( ch );
   17e58:	0f be 45 ef          	movsbl -0x11(%ebp),%eax
   17e5c:	83 ec 0c             	sub    $0xc,%esp
   17e5f:	50                   	push   %eax
   17e60:	e8 42 25 00 00       	call   1a3a7 <swritech>
   17e65:	83 c4 10             	add    $0x10,%esp

	exit( ret );
   17e68:	83 ec 0c             	sub    $0xc,%esp
   17e6b:	ff 75 f4             	pushl  -0xc(%ebp)
   17e6e:	e8 58 f0 ff ff       	call   16ecb <exit>
   17e73:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   17e76:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   17e7b:	c9                   	leave  
   17e7c:	c3                   	ret    
...
USERMAIN( progZ ) {
   17e7d:	55                   	push   %ebp
   17e7e:	89 e5                	mov    %esp,%ebp
   17e80:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   17e86:	8b 45 0c             	mov    0xc(%ebp),%eax
   17e89:	8b 00                	mov    (%eax),%eax
   17e8b:	85 c0                	test   %eax,%eax
   17e8d:	74 07                	je     17e96 <progZ+0x19>
   17e8f:	8b 45 0c             	mov    0xc(%ebp),%eax
   17e92:	8b 00                	mov    (%eax),%eax
   17e94:	eb 05                	jmp    17e9b <progZ+0x1e>
   17e96:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   17e9b:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int count = 10;	  // default iteration count
   17e9e:	c7 45 f4 0a 00 00 00 	movl   $0xa,-0xc(%ebp)
	char ch = 'z';	  // default character to print
   17ea5:	c6 45 f3 7a          	movb   $0x7a,-0xd(%ebp)
	char buf[128];
	...
	// process the command-line arguments
	switch( argc ) {
   17ea9:	8b 45 08             	mov    0x8(%ebp),%eax
   17eac:	83 f8 02             	cmp    $0x2,%eax
   17eaf:	74 1e                	je     17ecf <progZ+0x52>
   17eb1:	83 f8 03             	cmp    $0x3,%eax
   17eb4:	75 2c                	jne    17ee2 <progZ+0x65>
	case 3:	count = ustr2int( argv[2], 10 );
   17eb6:	8b 45 0c             	mov    0xc(%ebp),%eax
   17eb9:	83 c0 08             	add    $0x8,%eax
   17ebc:	8b 00                	mov    (%eax),%eax
   17ebe:	83 ec 08             	sub    $0x8,%esp
   17ec1:	6a 0a                	push   $0xa
   17ec3:	50                   	push   %eax
   17ec4:	e8 21 20 00 00       	call   19eea <ustr2int>
   17ec9:	83 c4 10             	add    $0x10,%esp
   17ecc:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   17ecf:	8b 45 0c             	mov    0xc(%ebp),%eax
   17ed2:	83 c0 04             	add    $0x4,%eax
   17ed5:	8b 00                	mov    (%eax),%eax
   17ed7:	0f b6 00             	movzbl (%eax),%eax
   17eda:	88 45 f3             	mov    %al,-0xd(%ebp)
			break;
   17edd:	e9 a8 00 00 00       	jmp    17f8a <progZ+0x10d>
	default:
			usprint( buf, "?: argc %d, args: ", argc );
   17ee2:	83 ec 04             	sub    $0x4,%esp
   17ee5:	ff 75 08             	pushl  0x8(%ebp)
   17ee8:	68 17 be 01 00       	push   $0x1be17
   17eed:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17ef3:	50                   	push   %eax
   17ef4:	e8 7c 1d 00 00       	call   19c75 <usprint>
   17ef9:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   17efc:	83 ec 0c             	sub    $0xc,%esp
   17eff:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17f05:	50                   	push   %eax
   17f06:	e8 57 24 00 00       	call   1a362 <cwrites>
   17f0b:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   17f0e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   17f15:	eb 5b                	jmp    17f72 <progZ+0xf5>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   17f17:	8b 45 08             	mov    0x8(%ebp),%eax
   17f1a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   17f21:	8b 45 0c             	mov    0xc(%ebp),%eax
   17f24:	01 d0                	add    %edx,%eax
   17f26:	8b 00                	mov    (%eax),%eax
   17f28:	85 c0                	test   %eax,%eax
   17f2a:	74 13                	je     17f3f <progZ+0xc2>
   17f2c:	8b 45 08             	mov    0x8(%ebp),%eax
   17f2f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   17f36:	8b 45 0c             	mov    0xc(%ebp),%eax
   17f39:	01 d0                	add    %edx,%eax
   17f3b:	8b 00                	mov    (%eax),%eax
   17f3d:	eb 05                	jmp    17f44 <progZ+0xc7>
   17f3f:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   17f44:	83 ec 04             	sub    $0x4,%esp
   17f47:	50                   	push   %eax
   17f48:	68 6c bd 01 00       	push   $0x1bd6c
   17f4d:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17f53:	50                   	push   %eax
   17f54:	e8 1c 1d 00 00       	call   19c75 <usprint>
   17f59:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   17f5c:	83 ec 0c             	sub    $0xc,%esp
   17f5f:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17f65:	50                   	push   %eax
   17f66:	e8 f7 23 00 00       	call   1a362 <cwrites>
   17f6b:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   17f6e:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   17f72:	8b 45 ec             	mov    -0x14(%ebp),%eax
   17f75:	3b 45 08             	cmp    0x8(%ebp),%eax
   17f78:	7e 9d                	jle    17f17 <progZ+0x9a>
			}
			cwrites( "\n" );
   17f7a:	83 ec 0c             	sub    $0xc,%esp
   17f7d:	68 70 bd 01 00       	push   $0x1bd70
   17f82:	e8 db 23 00 00       	call   1a362 <cwrites>
   17f87:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	int pid = getpid();
   17f8a:	e8 6c ef ff ff       	call   16efb <getpid>
   17f8f:	89 45 dc             	mov    %eax,-0x24(%ebp)
	usprint( buf, " %c[%d]", ch, pid );
   17f92:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   17f96:	ff 75 dc             	pushl  -0x24(%ebp)
   17f99:	50                   	push   %eax
   17f9a:	68 2a be 01 00       	push   $0x1be2a
   17f9f:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17fa5:	50                   	push   %eax
   17fa6:	e8 ca 1c 00 00       	call   19c75 <usprint>
   17fab:	83 c4 10             	add    $0x10,%esp
	swrites( buf );
   17fae:	83 ec 0c             	sub    $0xc,%esp
   17fb1:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17fb7:	50                   	push   %eax
   17fb8:	e8 0b 24 00 00       	call   1a3c8 <swrites>
   17fbd:	83 c4 10             	add    $0x10,%esp

	// iterate for a while; occasionally yield the CPU
	for( int i = 0; i < count ; ++i ) {
   17fc0:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   17fc7:	eb 5f                	jmp    18028 <progZ+0x1ab>
		usprint( buf, " %c[%d]", ch, i );
   17fc9:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   17fcd:	ff 75 e8             	pushl  -0x18(%ebp)
   17fd0:	50                   	push   %eax
   17fd1:	68 2a be 01 00       	push   $0x1be2a
   17fd6:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17fdc:	50                   	push   %eax
   17fdd:	e8 93 1c 00 00       	call   19c75 <usprint>
   17fe2:	83 c4 10             	add    $0x10,%esp
		swrites( buf );
   17fe5:	83 ec 0c             	sub    $0xc,%esp
   17fe8:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   17fee:	50                   	push   %eax
   17fef:	e8 d4 23 00 00       	call   1a3c8 <swrites>
   17ff4:	83 c4 10             	add    $0x10,%esp
		DELAY(STD);
   17ff7:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
   17ffe:	eb 04                	jmp    18004 <progZ+0x187>
   18000:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
   18004:	81 7d e4 9f 25 26 00 	cmpl   $0x26259f,-0x1c(%ebp)
   1800b:	7e f3                	jle    18000 <progZ+0x183>
		if( i & 1 ) {
   1800d:	8b 45 e8             	mov    -0x18(%ebp),%eax
   18010:	83 e0 01             	and    $0x1,%eax
   18013:	85 c0                	test   %eax,%eax
   18015:	74 0d                	je     18024 <progZ+0x1a7>
			sleep( 0 );
   18017:	83 ec 0c             	sub    $0xc,%esp
   1801a:	6a 00                	push   $0x0
   1801c:	e8 0a ef ff ff       	call   16f2b <sleep>
   18021:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count ; ++i ) {
   18024:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   18028:	8b 45 e8             	mov    -0x18(%ebp),%eax
   1802b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   1802e:	7c 99                	jl     17fc9 <progZ+0x14c>
		}
	}

	exit( 0 );
   18030:	83 ec 0c             	sub    $0xc,%esp
   18033:	6a 00                	push   $0x0
   18035:	e8 91 ee ff ff       	call   16ecb <exit>
   1803a:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   1803d:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   18042:	c9                   	leave  
   18043:	c3                   	ret    
...
USERMAIN( progI ) {
   18044:	55                   	push   %ebp
   18045:	89 e5                	mov    %esp,%ebp
   18047:	81 ec 98 01 00 00    	sub    $0x198,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   1804d:	8b 45 0c             	mov    0xc(%ebp),%eax
   18050:	8b 00                	mov    (%eax),%eax
   18052:	85 c0                	test   %eax,%eax
   18054:	74 07                	je     1805d <progI+0x19>
   18056:	8b 45 0c             	mov    0xc(%ebp),%eax
   18059:	8b 00                	mov    (%eax),%eax
   1805b:	eb 05                	jmp    18062 <progI+0x1e>
   1805d:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   18062:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int count = 5;	  // default child count
   18065:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
	char ch = 'i';	  // default character to print
   1806c:	c6 45 cf 69          	movb   $0x69,-0x31(%ebp)
	int nap = 5;	  // nap time
   18070:	c7 45 dc 05 00 00 00 	movl   $0x5,-0x24(%ebp)
	char buf[128];
	char ch2[] = "*?*";
   18077:	c7 85 4b ff ff ff 2a 	movl   $0x2a3f2a,-0xb5(%ebp)
   1807e:	3f 2a 00 
	uint_t children[MAX_CHILDREN];
	int nkids = 0;
   18081:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

	// process the command-line arguments
	switch( argc ) {
   18088:	8b 45 08             	mov    0x8(%ebp),%eax
   1808b:	83 f8 02             	cmp    $0x2,%eax
   1808e:	74 29                	je     180b9 <progI+0x75>
   18090:	83 f8 03             	cmp    $0x3,%eax
   18093:	74 0b                	je     180a0 <progI+0x5c>
   18095:	83 f8 01             	cmp    $0x1,%eax
   18098:	0f 84 d8 00 00 00    	je     18176 <progI+0x132>
   1809e:	eb 2c                	jmp    180cc <progI+0x88>
	case 3:	count = ustr2int( argv[2], 10 );
   180a0:	8b 45 0c             	mov    0xc(%ebp),%eax
   180a3:	83 c0 08             	add    $0x8,%eax
   180a6:	8b 00                	mov    (%eax),%eax
   180a8:	83 ec 08             	sub    $0x8,%esp
   180ab:	6a 0a                	push   $0xa
   180ad:	50                   	push   %eax
   180ae:	e8 37 1e 00 00       	call   19eea <ustr2int>
   180b3:	83 c4 10             	add    $0x10,%esp
   180b6:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   180b9:	8b 45 0c             	mov    0xc(%ebp),%eax
   180bc:	83 c0 04             	add    $0x4,%eax
   180bf:	8b 00                	mov    (%eax),%eax
   180c1:	0f b6 00             	movzbl (%eax),%eax
   180c4:	88 45 cf             	mov    %al,-0x31(%ebp)
			break;
   180c7:	e9 ab 00 00 00       	jmp    18177 <progI+0x133>
	case 1:	// just use the defaults
			break;
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   180cc:	ff 75 08             	pushl  0x8(%ebp)
   180cf:	ff 75 e0             	pushl  -0x20(%ebp)
   180d2:	68 51 bd 01 00       	push   $0x1bd51
   180d7:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   180dd:	50                   	push   %eax
   180de:	e8 92 1b 00 00       	call   19c75 <usprint>
   180e3:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   180e6:	83 ec 0c             	sub    $0xc,%esp
   180e9:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   180ef:	50                   	push   %eax
   180f0:	e8 6d 22 00 00       	call   1a362 <cwrites>
   180f5:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   180f8:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   180ff:	eb 5b                	jmp    1815c <progI+0x118>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   18101:	8b 45 08             	mov    0x8(%ebp),%eax
   18104:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   1810b:	8b 45 0c             	mov    0xc(%ebp),%eax
   1810e:	01 d0                	add    %edx,%eax
   18110:	8b 00                	mov    (%eax),%eax
   18112:	85 c0                	test   %eax,%eax
   18114:	74 13                	je     18129 <progI+0xe5>
   18116:	8b 45 08             	mov    0x8(%ebp),%eax
   18119:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18120:	8b 45 0c             	mov    0xc(%ebp),%eax
   18123:	01 d0                	add    %edx,%eax
   18125:	8b 00                	mov    (%eax),%eax
   18127:	eb 05                	jmp    1812e <progI+0xea>
   18129:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   1812e:	83 ec 04             	sub    $0x4,%esp
   18131:	50                   	push   %eax
   18132:	68 6c bd 01 00       	push   $0x1bd6c
   18137:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   1813d:	50                   	push   %eax
   1813e:	e8 32 1b 00 00       	call   19c75 <usprint>
   18143:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   18146:	83 ec 0c             	sub    $0xc,%esp
   18149:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   1814f:	50                   	push   %eax
   18150:	e8 0d 22 00 00       	call   1a362 <cwrites>
   18155:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   18158:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   1815c:	8b 45 ec             	mov    -0x14(%ebp),%eax
   1815f:	3b 45 08             	cmp    0x8(%ebp),%eax
   18162:	7e 9d                	jle    18101 <progI+0xbd>
			}
			cwrites( "\n" );
   18164:	83 ec 0c             	sub    $0xc,%esp
   18167:	68 70 bd 01 00       	push   $0x1bd70
   1816c:	e8 f1 21 00 00       	call   1a362 <cwrites>
   18171:	83 c4 10             	add    $0x10,%esp
   18174:	eb 01                	jmp    18177 <progI+0x133>
			break;
   18176:	90                   	nop
	}
	...
	ch2[1] = ch;
   18177:	0f b6 45 cf          	movzbl -0x31(%ebp),%eax
   1817b:	88 85 4c ff ff ff    	mov    %al,-0xb4(%ebp)

	// announce our presence
	write( CHAN_SIO, &ch, 1 );
   18181:	83 ec 04             	sub    $0x4,%esp
   18184:	6a 01                	push   $0x1
   18186:	8d 45 cf             	lea    -0x31(%ebp),%eax
   18189:	50                   	push   %eax
   1818a:	6a 01                	push   $0x1
   1818c:	e8 62 ed ff ff       	call   16ef3 <write>
   18191:	83 c4 10             	add    $0x10,%esp

	// set up the argument vector
	// we run:	progW 10 5

	char *argsw[] = { "progW", "W", "10", "5", NULL };
   18194:	c7 85 6c fe ff ff 32 	movl   $0x1be32,-0x194(%ebp)
   1819b:	be 01 00 
   1819e:	c7 85 70 fe ff ff 46 	movl   $0x1bb46,-0x190(%ebp)
   181a5:	bb 01 00 
   181a8:	c7 85 74 fe ff ff c4 	movl   $0x1bac4,-0x18c(%ebp)
   181af:	ba 01 00 
   181b2:	c7 85 78 fe ff ff f3 	movl   $0x1baf3,-0x188(%ebp)
   181b9:	ba 01 00 
   181bc:	c7 85 7c fe ff ff 00 	movl   $0x0,-0x184(%ebp)
   181c3:	00 00 00 

	for( int i = 0; i < count; ++i ) {
   181c6:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   181cd:	eb 5f                	jmp    1822e <progI+0x1ea>
		int whom = spawn( (uint32_t) progW, argsw );
   181cf:	ba b7 83 01 00       	mov    $0x183b7,%edx
   181d4:	83 ec 08             	sub    $0x8,%esp
   181d7:	8d 85 6c fe ff ff    	lea    -0x194(%ebp),%eax
   181dd:	50                   	push   %eax
   181de:	52                   	push   %edx
   181df:	e8 e8 20 00 00       	call   1a2cc <spawn>
   181e4:	83 c4 10             	add    $0x10,%esp
   181e7:	89 45 d0             	mov    %eax,-0x30(%ebp)
		if( whom < 0 ) {
   181ea:	83 7d d0 00          	cmpl   $0x0,-0x30(%ebp)
   181ee:	79 14                	jns    18204 <progI+0x1c0>
			swrites( ch2 );
   181f0:	83 ec 0c             	sub    $0xc,%esp
   181f3:	8d 85 4b ff ff ff    	lea    -0xb5(%ebp),%eax
   181f9:	50                   	push   %eax
   181fa:	e8 c9 21 00 00       	call   1a3c8 <swrites>
   181ff:	83 c4 10             	add    $0x10,%esp
   18202:	eb 26                	jmp    1822a <progI+0x1e6>
		} else {
			swritech( ch );
   18204:	0f b6 45 cf          	movzbl -0x31(%ebp),%eax
   18208:	0f be c0             	movsbl %al,%eax
   1820b:	83 ec 0c             	sub    $0xc,%esp
   1820e:	50                   	push   %eax
   1820f:	e8 93 21 00 00       	call   1a3a7 <swritech>
   18214:	83 c4 10             	add    $0x10,%esp
			children[nkids++] = whom;
   18217:	8b 45 f0             	mov    -0x10(%ebp),%eax
   1821a:	8d 50 01             	lea    0x1(%eax),%edx
   1821d:	89 55 f0             	mov    %edx,-0x10(%ebp)
   18220:	8b 55 d0             	mov    -0x30(%ebp),%edx
   18223:	89 94 85 80 fe ff ff 	mov    %edx,-0x180(%ebp,%eax,4)
	for( int i = 0; i < count; ++i ) {
   1822a:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   1822e:	8b 45 e8             	mov    -0x18(%ebp),%eax
   18231:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   18234:	7c 99                	jl     181cf <progI+0x18b>
		}
	}

	// let the children start
	sleep( SEC_TO_MS(nap) );
   18236:	8b 45 dc             	mov    -0x24(%ebp),%eax
   18239:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   1823f:	83 ec 0c             	sub    $0xc,%esp
   18242:	50                   	push   %eax
   18243:	e8 e3 ec ff ff       	call   16f2b <sleep>
   18248:	83 c4 10             	add    $0x10,%esp

	// kill two of them
	int32_t status = kill( children[1] );
   1824b:	8b 85 84 fe ff ff    	mov    -0x17c(%ebp),%eax
   18251:	83 ec 0c             	sub    $0xc,%esp
   18254:	50                   	push   %eax
   18255:	e8 c9 ec ff ff       	call   16f23 <kill>
   1825a:	83 c4 10             	add    $0x10,%esp
   1825d:	89 45 d8             	mov    %eax,-0x28(%ebp)
	if( status ) {
   18260:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
   18264:	74 45                	je     182ab <progI+0x267>
		usprint( buf, "!! %c: kill(%d) status %d\n", ch, children[1], status );
   18266:	8b 95 84 fe ff ff    	mov    -0x17c(%ebp),%edx
   1826c:	0f b6 45 cf          	movzbl -0x31(%ebp),%eax
   18270:	0f be c0             	movsbl %al,%eax
   18273:	83 ec 0c             	sub    $0xc,%esp
   18276:	ff 75 d8             	pushl  -0x28(%ebp)
   18279:	52                   	push   %edx
   1827a:	50                   	push   %eax
   1827b:	68 38 be 01 00       	push   $0x1be38
   18280:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   18286:	50                   	push   %eax
   18287:	e8 e9 19 00 00       	call   19c75 <usprint>
   1828c:	83 c4 20             	add    $0x20,%esp
		cwrites( buf );
   1828f:	83 ec 0c             	sub    $0xc,%esp
   18292:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   18298:	50                   	push   %eax
   18299:	e8 c4 20 00 00       	call   1a362 <cwrites>
   1829e:	83 c4 10             	add    $0x10,%esp
		children[1] = -42;
   182a1:	c7 85 84 fe ff ff d6 	movl   $0xffffffd6,-0x17c(%ebp)
   182a8:	ff ff ff 
	}
	status = kill( children[3] );
   182ab:	8b 85 8c fe ff ff    	mov    -0x174(%ebp),%eax
   182b1:	83 ec 0c             	sub    $0xc,%esp
   182b4:	50                   	push   %eax
   182b5:	e8 69 ec ff ff       	call   16f23 <kill>
   182ba:	83 c4 10             	add    $0x10,%esp
   182bd:	89 45 d8             	mov    %eax,-0x28(%ebp)
	if( status ) {
   182c0:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
   182c4:	74 45                	je     1830b <progI+0x2c7>
		usprint( buf, "!! %c: kill(%d) status %d\n", ch, children[3], status );
   182c6:	8b 95 8c fe ff ff    	mov    -0x174(%ebp),%edx
   182cc:	0f b6 45 cf          	movzbl -0x31(%ebp),%eax
   182d0:	0f be c0             	movsbl %al,%eax
   182d3:	83 ec 0c             	sub    $0xc,%esp
   182d6:	ff 75 d8             	pushl  -0x28(%ebp)
   182d9:	52                   	push   %edx
   182da:	50                   	push   %eax
   182db:	68 38 be 01 00       	push   $0x1be38
   182e0:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   182e6:	50                   	push   %eax
   182e7:	e8 89 19 00 00       	call   19c75 <usprint>
   182ec:	83 c4 20             	add    $0x20,%esp
		cwrites( buf );
   182ef:	83 ec 0c             	sub    $0xc,%esp
   182f2:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   182f8:	50                   	push   %eax
   182f9:	e8 64 20 00 00       	call   1a362 <cwrites>
   182fe:	83 c4 10             	add    $0x10,%esp
		children[3] = -42;
   18301:	c7 85 8c fe ff ff d6 	movl   $0xffffffd6,-0x174(%ebp)
   18308:	ff ff ff 
	}
   ...
   1830b:	83 ec 08             	sub    $0x8,%esp
   1830e:	6a 00                	push   $0x0
   18310:	6a 00                	push   $0x0
   18312:	e8 bc eb ff ff       	call   16ed3 <waitpid>
   18317:	83 c4 10             	add    $0x10,%esp
   1831a:	89 45 d4             	mov    %eax,-0x2c(%ebp)
		if( n == E_NO_CHILDREN ) {
   1831d:	83 7d d4 fc          	cmpl   $0xfffffffc,-0x2c(%ebp)
   18321:	74 7f                	je     183a2 <progI+0x35e>
			// all done!
			break;
		}
		for( int i = 0; i < count; ++i ) {
   18323:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
   1832a:	eb 54                	jmp    18380 <progI+0x33c>
			if( children[i] == n ) {
   1832c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
   1832f:	8b 94 85 80 fe ff ff 	mov    -0x180(%ebp,%eax,4),%edx
   18336:	8b 45 d4             	mov    -0x2c(%ebp),%eax
   18339:	39 c2                	cmp    %eax,%edx
   1833b:	75 3f                	jne    1837c <progI+0x338>
				usprint( buf, "== %c: child %d (%d)\n", ch, i, children[i] );
   1833d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
   18340:	8b 94 85 80 fe ff ff 	mov    -0x180(%ebp,%eax,4),%edx
   18347:	0f b6 45 cf          	movzbl -0x31(%ebp),%eax
   1834b:	0f be c0             	movsbl %al,%eax
   1834e:	83 ec 0c             	sub    $0xc,%esp
   18351:	52                   	push   %edx
   18352:	ff 75 e4             	pushl  -0x1c(%ebp)
   18355:	50                   	push   %eax
   18356:	68 53 be 01 00       	push   $0x1be53
   1835b:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   18361:	50                   	push   %eax
   18362:	e8 0e 19 00 00       	call   19c75 <usprint>
   18367:	83 c4 20             	add    $0x20,%esp
				cwrites( buf );
   1836a:	83 ec 0c             	sub    $0xc,%esp
   1836d:	8d 85 4f ff ff ff    	lea    -0xb1(%ebp),%eax
   18373:	50                   	push   %eax
   18374:	e8 e9 1f 00 00       	call   1a362 <cwrites>
   18379:	83 c4 10             	add    $0x10,%esp
		for( int i = 0; i < count; ++i ) {
   1837c:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
   18380:	8b 45 e4             	mov    -0x1c(%ebp),%eax
   18383:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   18386:	7c a4                	jl     1832c <progI+0x2e8>
			}
		}
		sleep( SEC_TO_MS(nap) );
   18388:	8b 45 dc             	mov    -0x24(%ebp),%eax
   1838b:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   18391:	83 ec 0c             	sub    $0xc,%esp
   18394:	50                   	push   %eax
   18395:	e8 91 eb ff ff       	call   16f2b <sleep>
   1839a:	83 c4 10             	add    $0x10,%esp
	while( 1 ) {
   1839d:	e9 69 ff ff ff       	jmp    1830b <progI+0x2c7>
			break;
   183a2:	90                   	nop
	};
	...
	exit( 0 );
   183a3:	83 ec 0c             	sub    $0xc,%esp
   183a6:	6a 00                	push   $0x0
   183a8:	e8 1e eb ff ff       	call   16ecb <exit>
   183ad:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   183b0:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   183b5:	c9                   	leave  
   183b6:	c3                   	ret    
...
USERMAIN( progW ) {
   183b7:	55                   	push   %ebp
   183b8:	89 e5                	mov    %esp,%ebp
   183ba:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   183c0:	8b 45 0c             	mov    0xc(%ebp),%eax
   183c3:	8b 00                	mov    (%eax),%eax
   183c5:	85 c0                	test   %eax,%eax
   183c7:	74 07                	je     183d0 <progW+0x19>
   183c9:	8b 45 0c             	mov    0xc(%ebp),%eax
   183cc:	8b 00                	mov    (%eax),%eax
   183ce:	eb 05                	jmp    183d5 <progW+0x1e>
   183d0:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   183d5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	int count = 20;	  // default iteration count
   183d8:	c7 45 f4 14 00 00 00 	movl   $0x14,-0xc(%ebp)
	char ch = 'w';	  // default character to print
   183df:	c6 45 db 77          	movb   $0x77,-0x25(%ebp)
	int nap = 3;	  // nap length
   183e3:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   183ea:	8b 45 08             	mov    0x8(%ebp),%eax
   183ed:	83 f8 03             	cmp    $0x3,%eax
   183f0:	74 25                	je     18417 <progW+0x60>
   183f2:	83 f8 04             	cmp    $0x4,%eax
   183f5:	74 07                	je     183fe <progW+0x47>
   183f7:	83 f8 02             	cmp    $0x2,%eax
   183fa:	74 34                	je     18430 <progW+0x79>
   183fc:	eb 45                	jmp    18443 <progW+0x8c>
	case 4:	nap = ustr2int( argv[3], 10 );
   183fe:	8b 45 0c             	mov    0xc(%ebp),%eax
   18401:	83 c0 0c             	add    $0xc,%eax
   18404:	8b 00                	mov    (%eax),%eax
   18406:	83 ec 08             	sub    $0x8,%esp
   18409:	6a 0a                	push   $0xa
   1840b:	50                   	push   %eax
   1840c:	e8 d9 1a 00 00       	call   19eea <ustr2int>
   18411:	83 c4 10             	add    $0x10,%esp
   18414:	89 45 f0             	mov    %eax,-0x10(%ebp)
			// FALL THROUGH
	case 3:	count = ustr2int( argv[2], 10 );
   18417:	8b 45 0c             	mov    0xc(%ebp),%eax
   1841a:	83 c0 08             	add    $0x8,%eax
   1841d:	8b 00                	mov    (%eax),%eax
   1841f:	83 ec 08             	sub    $0x8,%esp
   18422:	6a 0a                	push   $0xa
   18424:	50                   	push   %eax
   18425:	e8 c0 1a 00 00       	call   19eea <ustr2int>
   1842a:	83 c4 10             	add    $0x10,%esp
   1842d:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   18430:	8b 45 0c             	mov    0xc(%ebp),%eax
   18433:	83 c0 04             	add    $0x4,%eax
   18436:	8b 00                	mov    (%eax),%eax
   18438:	0f b6 00             	movzbl (%eax),%eax
   1843b:	88 45 db             	mov    %al,-0x25(%ebp)
			break;
   1843e:	e9 a8 00 00 00       	jmp    184eb <progW+0x134>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   18443:	ff 75 08             	pushl  0x8(%ebp)
   18446:	ff 75 e4             	pushl  -0x1c(%ebp)
   18449:	68 51 bd 01 00       	push   $0x1bd51
   1844e:	8d 85 5b ff ff ff    	lea    -0xa5(%ebp),%eax
   18454:	50                   	push   %eax
   18455:	e8 1b 18 00 00       	call   19c75 <usprint>
   1845a:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   1845d:	83 ec 0c             	sub    $0xc,%esp
   18460:	8d 85 5b ff ff ff    	lea    -0xa5(%ebp),%eax
   18466:	50                   	push   %eax
   18467:	e8 f6 1e 00 00       	call   1a362 <cwrites>
   1846c:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   1846f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   18476:	eb 5b                	jmp    184d3 <progW+0x11c>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   18478:	8b 45 08             	mov    0x8(%ebp),%eax
   1847b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18482:	8b 45 0c             	mov    0xc(%ebp),%eax
   18485:	01 d0                	add    %edx,%eax
   18487:	8b 00                	mov    (%eax),%eax
   18489:	85 c0                	test   %eax,%eax
   1848b:	74 13                	je     184a0 <progW+0xe9>
   1848d:	8b 45 08             	mov    0x8(%ebp),%eax
   18490:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18497:	8b 45 0c             	mov    0xc(%ebp),%eax
   1849a:	01 d0                	add    %edx,%eax
   1849c:	8b 00                	mov    (%eax),%eax
   1849e:	eb 05                	jmp    184a5 <progW+0xee>
   184a0:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   184a5:	83 ec 04             	sub    $0x4,%esp
   184a8:	50                   	push   %eax
   184a9:	68 6c bd 01 00       	push   $0x1bd6c
   184ae:	8d 85 5b ff ff ff    	lea    -0xa5(%ebp),%eax
   184b4:	50                   	push   %eax
   184b5:	e8 bb 17 00 00       	call   19c75 <usprint>
   184ba:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   184bd:	83 ec 0c             	sub    $0xc,%esp
   184c0:	8d 85 5b ff ff ff    	lea    -0xa5(%ebp),%eax
   184c6:	50                   	push   %eax
   184c7:	e8 96 1e 00 00       	call   1a362 <cwrites>
   184cc:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   184cf:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   184d3:	8b 45 ec             	mov    -0x14(%ebp),%eax
   184d6:	3b 45 08             	cmp    0x8(%ebp),%eax
   184d9:	7e 9d                	jle    18478 <progW+0xc1>
			}
			cwrites( "\n" );
   184db:	83 ec 0c             	sub    $0xc,%esp
   184de:	68 70 bd 01 00       	push   $0x1bd70
   184e3:	e8 7a 1e 00 00       	call   1a362 <cwrites>
   184e8:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	int pid = getpid();
   184eb:	e8 0b ea ff ff       	call   16efb <getpid>
   184f0:	89 45 e0             	mov    %eax,-0x20(%ebp)
	uint32_t now = gettime();
   184f3:	e8 13 ea ff ff       	call   16f0b <gettime>
   184f8:	89 45 dc             	mov    %eax,-0x24(%ebp)
	usprint( buf, " %c[%d,%u]", ch, pid, now );
   184fb:	0f b6 45 db          	movzbl -0x25(%ebp),%eax
   184ff:	0f be c0             	movsbl %al,%eax
   18502:	83 ec 0c             	sub    $0xc,%esp
   18505:	ff 75 dc             	pushl  -0x24(%ebp)
   18508:	ff 75 e0             	pushl  -0x20(%ebp)
   1850b:	50                   	push   %eax
   1850c:	68 69 be 01 00       	push   $0x1be69
   18511:	8d 85 5b ff ff ff    	lea    -0xa5(%ebp),%eax
   18517:	50                   	push   %eax
   18518:	e8 58 17 00 00       	call   19c75 <usprint>
   1851d:	83 c4 20             	add    $0x20,%esp
	swrites( buf );
   18520:	83 ec 0c             	sub    $0xc,%esp
   18523:	8d 85 5b ff ff ff    	lea    -0xa5(%ebp),%eax
   18529:	50                   	push   %eax
   1852a:	e8 99 1e 00 00       	call   1a3c8 <swrites>
   1852f:	83 c4 10             	add    $0x10,%esp

	write( CHAN_SIO, &ch, 1 );
   18532:	83 ec 04             	sub    $0x4,%esp
   18535:	6a 01                	push   $0x1
   18537:	8d 45 db             	lea    -0x25(%ebp),%eax
   1853a:	50                   	push   %eax
   1853b:	6a 01                	push   $0x1
   1853d:	e8 b1 e9 ff ff       	call   16ef3 <write>
   18542:	83 c4 10             	add    $0x10,%esp

	for( int i = 0; i < count ; ++i ) {
   18545:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   1854c:	eb 58                	jmp    185a6 <progW+0x1ef>
		now = gettime();
   1854e:	e8 b8 e9 ff ff       	call   16f0b <gettime>
   18553:	89 45 dc             	mov    %eax,-0x24(%ebp)
		usprint( buf, " %c[%d,%u] ", ch, pid, now );
   18556:	0f b6 45 db          	movzbl -0x25(%ebp),%eax
   1855a:	0f be c0             	movsbl %al,%eax
   1855d:	83 ec 0c             	sub    $0xc,%esp
   18560:	ff 75 dc             	pushl  -0x24(%ebp)
   18563:	ff 75 e0             	pushl  -0x20(%ebp)
   18566:	50                   	push   %eax
   18567:	68 74 be 01 00       	push   $0x1be74
   1856c:	8d 85 5b ff ff ff    	lea    -0xa5(%ebp),%eax
   18572:	50                   	push   %eax
   18573:	e8 fd 16 00 00       	call   19c75 <usprint>
   18578:	83 c4 20             	add    $0x20,%esp
		swrites( buf );
   1857b:	83 ec 0c             	sub    $0xc,%esp
   1857e:	8d 85 5b ff ff ff    	lea    -0xa5(%ebp),%eax
   18584:	50                   	push   %eax
   18585:	e8 3e 1e 00 00       	call   1a3c8 <swrites>
   1858a:	83 c4 10             	add    $0x10,%esp
		sleep( SEC_TO_MS(nap) );
   1858d:	8b 45 f0             	mov    -0x10(%ebp),%eax
   18590:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   18596:	83 ec 0c             	sub    $0xc,%esp
   18599:	50                   	push   %eax
   1859a:	e8 8c e9 ff ff       	call   16f2b <sleep>
   1859f:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count ; ++i ) {
   185a2:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   185a6:	8b 45 e8             	mov    -0x18(%ebp),%eax
   185a9:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   185ac:	7c a0                	jl     1854e <progW+0x197>
	}

	exit( 0 );
   185ae:	83 ec 0c             	sub    $0xc,%esp
   185b1:	6a 00                	push   $0x0
   185b3:	e8 13 e9 ff ff       	call   16ecb <exit>
   185b8:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   185bb:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   185c0:	c9                   	leave  
   185c1:	c3                   	ret    
...
USERMAIN( progJ ) {
   185c2:	55                   	push   %ebp
   185c3:	89 e5                	mov    %esp,%ebp
   185c5:	81 ec b8 00 00 00    	sub    $0xb8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   185cb:	8b 45 0c             	mov    0xc(%ebp),%eax
   185ce:	8b 00                	mov    (%eax),%eax
   185d0:	85 c0                	test   %eax,%eax
   185d2:	74 07                	je     185db <progJ+0x19>
   185d4:	8b 45 0c             	mov    0xc(%ebp),%eax
   185d7:	8b 00                	mov    (%eax),%eax
   185d9:	eb 05                	jmp    185e0 <progJ+0x1e>
   185db:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   185e0:	89 45 e8             	mov    %eax,-0x18(%ebp)
	int count = 2 * N_PROCS;	// number of children to spawn
   185e3:	c7 45 f4 32 00 00 00 	movl   $0x32,-0xc(%ebp)
	char ch = 'j';				// default character to print
   185ea:	c6 45 e3 6a          	movb   $0x6a,-0x1d(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   185ee:	8b 45 08             	mov    0x8(%ebp),%eax
   185f1:	83 f8 02             	cmp    $0x2,%eax
   185f4:	74 1e                	je     18614 <progJ+0x52>
   185f6:	83 f8 03             	cmp    $0x3,%eax
   185f9:	75 2c                	jne    18627 <progJ+0x65>
	case 3:	count = ustr2int( argv[2], 10 );
   185fb:	8b 45 0c             	mov    0xc(%ebp),%eax
   185fe:	83 c0 08             	add    $0x8,%eax
   18601:	8b 00                	mov    (%eax),%eax
   18603:	83 ec 08             	sub    $0x8,%esp
   18606:	6a 0a                	push   $0xa
   18608:	50                   	push   %eax
   18609:	e8 dc 18 00 00       	call   19eea <ustr2int>
   1860e:	83 c4 10             	add    $0x10,%esp
   18611:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   18614:	8b 45 0c             	mov    0xc(%ebp),%eax
   18617:	83 c0 04             	add    $0x4,%eax
   1861a:	8b 00                	mov    (%eax),%eax
   1861c:	0f b6 00             	movzbl (%eax),%eax
   1861f:	88 45 e3             	mov    %al,-0x1d(%ebp)
			break;
   18622:	e9 a8 00 00 00       	jmp    186cf <progJ+0x10d>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   18627:	ff 75 08             	pushl  0x8(%ebp)
   1862a:	ff 75 e8             	pushl  -0x18(%ebp)
   1862d:	68 51 bd 01 00       	push   $0x1bd51
   18632:	8d 85 63 ff ff ff    	lea    -0x9d(%ebp),%eax
   18638:	50                   	push   %eax
   18639:	e8 37 16 00 00       	call   19c75 <usprint>
   1863e:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   18641:	83 ec 0c             	sub    $0xc,%esp
   18644:	8d 85 63 ff ff ff    	lea    -0x9d(%ebp),%eax
   1864a:	50                   	push   %eax
   1864b:	e8 12 1d 00 00       	call   1a362 <cwrites>
   18650:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   18653:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
   1865a:	eb 5b                	jmp    186b7 <progJ+0xf5>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   1865c:	8b 45 08             	mov    0x8(%ebp),%eax
   1865f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18666:	8b 45 0c             	mov    0xc(%ebp),%eax
   18669:	01 d0                	add    %edx,%eax
   1866b:	8b 00                	mov    (%eax),%eax
   1866d:	85 c0                	test   %eax,%eax
   1866f:	74 13                	je     18684 <progJ+0xc2>
   18671:	8b 45 08             	mov    0x8(%ebp),%eax
   18674:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   1867b:	8b 45 0c             	mov    0xc(%ebp),%eax
   1867e:	01 d0                	add    %edx,%eax
   18680:	8b 00                	mov    (%eax),%eax
   18682:	eb 05                	jmp    18689 <progJ+0xc7>
   18684:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   18689:	83 ec 04             	sub    $0x4,%esp
   1868c:	50                   	push   %eax
   1868d:	68 6c bd 01 00       	push   $0x1bd6c
   18692:	8d 85 63 ff ff ff    	lea    -0x9d(%ebp),%eax
   18698:	50                   	push   %eax
   18699:	e8 d7 15 00 00       	call   19c75 <usprint>
   1869e:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   186a1:	83 ec 0c             	sub    $0xc,%esp
   186a4:	8d 85 63 ff ff ff    	lea    -0x9d(%ebp),%eax
   186aa:	50                   	push   %eax
   186ab:	e8 b2 1c 00 00       	call   1a362 <cwrites>
   186b0:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   186b3:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
   186b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
   186ba:	3b 45 08             	cmp    0x8(%ebp),%eax
   186bd:	7e 9d                	jle    1865c <progJ+0x9a>
			}
			cwrites( "\n" );
   186bf:	83 ec 0c             	sub    $0xc,%esp
   186c2:	68 70 bd 01 00       	push   $0x1bd70
   186c7:	e8 96 1c 00 00       	call   1a362 <cwrites>
   186cc:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	write( CHAN_SIO, &ch, 1 );
   186cf:	83 ec 04             	sub    $0x4,%esp
   186d2:	6a 01                	push   $0x1
   186d4:	8d 45 e3             	lea    -0x1d(%ebp),%eax
   186d7:	50                   	push   %eax
   186d8:	6a 01                	push   $0x1
   186da:	e8 14 e8 ff ff       	call   16ef3 <write>
   186df:	83 c4 10             	add    $0x10,%esp

	// set up the command-line arguments
	char *argsy[] = { "progY", "Y", "10", NULL };
   186e2:	c7 85 50 ff ff ff 80 	movl   $0x1be80,-0xb0(%ebp)
   186e9:	be 01 00 
   186ec:	c7 85 54 ff ff ff 86 	movl   $0x1be86,-0xac(%ebp)
   186f3:	be 01 00 
   186f6:	c7 85 58 ff ff ff c4 	movl   $0x1bac4,-0xa8(%ebp)
   186fd:	ba 01 00 
   18700:	c7 85 5c ff ff ff 00 	movl   $0x0,-0xa4(%ebp)
   18707:	00 00 00 

	for( int i = 0; i < count ; ++i ) {
   1870a:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   18711:	eb 4e                	jmp    18761 <progJ+0x19f>
		int whom = spawn( (uint32_t) progY, argsy );
   18713:	ba 7d 87 01 00       	mov    $0x1877d,%edx
   18718:	83 ec 08             	sub    $0x8,%esp
   1871b:	8d 85 50 ff ff ff    	lea    -0xb0(%ebp),%eax
   18721:	50                   	push   %eax
   18722:	52                   	push   %edx
   18723:	e8 a4 1b 00 00       	call   1a2cc <spawn>
   18728:	83 c4 10             	add    $0x10,%esp
   1872b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		if( whom < 0 ) {
   1872e:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
   18732:	79 16                	jns    1874a <progJ+0x188>
			write( CHAN_SIO, "!j!", 3 );
   18734:	83 ec 04             	sub    $0x4,%esp
   18737:	6a 03                	push   $0x3
   18739:	68 88 be 01 00       	push   $0x1be88
   1873e:	6a 01                	push   $0x1
   18740:	e8 ae e7 ff ff       	call   16ef3 <write>
   18745:	83 c4 10             	add    $0x10,%esp
   18748:	eb 13                	jmp    1875d <progJ+0x19b>
		} else {
			write( CHAN_SIO, &ch, 1 );
   1874a:	83 ec 04             	sub    $0x4,%esp
   1874d:	6a 01                	push   $0x1
   1874f:	8d 45 e3             	lea    -0x1d(%ebp),%eax
   18752:	50                   	push   %eax
   18753:	6a 01                	push   $0x1
   18755:	e8 99 e7 ff ff       	call   16ef3 <write>
   1875a:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count ; ++i ) {
   1875d:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   18761:	8b 45 ec             	mov    -0x14(%ebp),%eax
   18764:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   18767:	7c aa                	jl     18713 <progJ+0x151>
		}
	}

	exit( 0 );
   18769:	83 ec 0c             	sub    $0xc,%esp
   1876c:	6a 00                	push   $0x0
   1876e:	e8 58 e7 ff ff       	call   16ecb <exit>
   18773:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   18776:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   1877b:	c9                   	leave  
   1877c:	c3                   	ret    
...
USERMAIN( progY ) {
   1877d:	55                   	push   %ebp
   1877e:	89 e5                	mov    %esp,%ebp
   18780:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   18786:	8b 45 0c             	mov    0xc(%ebp),%eax
   18789:	8b 00                	mov    (%eax),%eax
   1878b:	85 c0                	test   %eax,%eax
   1878d:	74 07                	je     18796 <progY+0x19>
   1878f:	8b 45 0c             	mov    0xc(%ebp),%eax
   18792:	8b 00                	mov    (%eax),%eax
   18794:	eb 05                	jmp    1879b <progY+0x1e>
   18796:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   1879b:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int count = 10;	  // default iteration count
   1879e:	c7 45 f4 0a 00 00 00 	movl   $0xa,-0xc(%ebp)
	char ch = 'y';	  // default character to print
   187a5:	c6 45 f3 79          	movb   $0x79,-0xd(%ebp)
	char buf[128];
   ...
   187ac:	83 f8 02             	cmp    $0x2,%eax
   187af:	74 1e                	je     187cf <progY+0x52>
   187b1:	83 f8 03             	cmp    $0x3,%eax
   187b4:	75 2c                	jne    187e2 <progY+0x65>
	case 3:	count = ustr2int( argv[2], 10 );
   187b6:	8b 45 0c             	mov    0xc(%ebp),%eax
   187b9:	83 c0 08             	add    $0x8,%eax
   187bc:	8b 00                	mov    (%eax),%eax
   187be:	83 ec 08             	sub    $0x8,%esp
   187c1:	6a 0a                	push   $0xa
   187c3:	50                   	push   %eax
   187c4:	e8 21 17 00 00       	call   19eea <ustr2int>
   187c9:	83 c4 10             	add    $0x10,%esp
   187cc:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   187cf:	8b 45 0c             	mov    0xc(%ebp),%eax
   187d2:	83 c0 04             	add    $0x4,%eax
   187d5:	8b 00                	mov    (%eax),%eax
   187d7:	0f b6 00             	movzbl (%eax),%eax
   187da:	88 45 f3             	mov    %al,-0xd(%ebp)
			break;
   187dd:	e9 a8 00 00 00       	jmp    1888a <progY+0x10d>
	default:
			usprint( buf, "?: argc %d, args: ", argc );
   187e2:	83 ec 04             	sub    $0x4,%esp
   187e5:	ff 75 08             	pushl  0x8(%ebp)
   187e8:	68 17 be 01 00       	push   $0x1be17
   187ed:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   187f3:	50                   	push   %eax
   187f4:	e8 7c 14 00 00       	call   19c75 <usprint>
   187f9:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   187fc:	83 ec 0c             	sub    $0xc,%esp
   187ff:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18805:	50                   	push   %eax
   18806:	e8 57 1b 00 00       	call   1a362 <cwrites>
   1880b:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   1880e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   18815:	eb 5b                	jmp    18872 <progY+0xf5>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   18817:	8b 45 08             	mov    0x8(%ebp),%eax
   1881a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18821:	8b 45 0c             	mov    0xc(%ebp),%eax
   18824:	01 d0                	add    %edx,%eax
   18826:	8b 00                	mov    (%eax),%eax
   18828:	85 c0                	test   %eax,%eax
   1882a:	74 13                	je     1883f <progY+0xc2>
   1882c:	8b 45 08             	mov    0x8(%ebp),%eax
   1882f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18836:	8b 45 0c             	mov    0xc(%ebp),%eax
   18839:	01 d0                	add    %edx,%eax
   1883b:	8b 00                	mov    (%eax),%eax
   1883d:	eb 05                	jmp    18844 <progY+0xc7>
   1883f:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   18844:	83 ec 04             	sub    $0x4,%esp
   18847:	50                   	push   %eax
   18848:	68 6c bd 01 00       	push   $0x1bd6c
   1884d:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18853:	50                   	push   %eax
   18854:	e8 1c 14 00 00       	call   19c75 <usprint>
   18859:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   1885c:	83 ec 0c             	sub    $0xc,%esp
   1885f:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18865:	50                   	push   %eax
   18866:	e8 f7 1a 00 00       	call   1a362 <cwrites>
   1886b:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   1886e:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   18872:	8b 45 ec             	mov    -0x14(%ebp),%eax
   18875:	3b 45 08             	cmp    0x8(%ebp),%eax
   18878:	7e 9d                	jle    18817 <progY+0x9a>
			}
			cwrites( "\n" );
   1887a:	83 ec 0c             	sub    $0xc,%esp
   1887d:	68 70 bd 01 00       	push   $0x1bd70
   18882:	e8 db 1a 00 00       	call   1a362 <cwrites>
   18887:	83 c4 10             	add    $0x10,%esp
	}

	// report our presence
	int pid = getpid();
   1888a:	e8 6c e6 ff ff       	call   16efb <getpid>
   1888f:	89 45 dc             	mov    %eax,-0x24(%ebp)
	usprint( buf, " %c[%d]", ch, pid );
   18892:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   18896:	ff 75 dc             	pushl  -0x24(%ebp)
   18899:	50                   	push   %eax
   1889a:	68 2a be 01 00       	push   $0x1be2a
   1889f:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   188a5:	50                   	push   %eax
   188a6:	e8 ca 13 00 00       	call   19c75 <usprint>
   188ab:	83 c4 10             	add    $0x10,%esp
	swrites( buf );
   188ae:	83 ec 0c             	sub    $0xc,%esp
   188b1:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   188b7:	50                   	push   %eax
   188b8:	e8 0b 1b 00 00       	call   1a3c8 <swrites>
   188bd:	83 c4 10             	add    $0x10,%esp

	for( int i = 0; i < count ; ++i ) {
   188c0:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   188c7:	eb 3c                	jmp    18905 <progY+0x188>
		swrites( buf );
   188c9:	83 ec 0c             	sub    $0xc,%esp
   188cc:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   188d2:	50                   	push   %eax
   188d3:	e8 f0 1a 00 00       	call   1a3c8 <swrites>
   188d8:	83 c4 10             	add    $0x10,%esp
		DELAY(STD);
   188db:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
   188e2:	eb 04                	jmp    188e8 <progY+0x16b>
   188e4:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
   188e8:	81 7d e4 9f 25 26 00 	cmpl   $0x26259f,-0x1c(%ebp)
   188ef:	7e f3                	jle    188e4 <progY+0x167>
		sleep( SEC_TO_MS(1) );
   188f1:	83 ec 0c             	sub    $0xc,%esp
   188f4:	68 e8 03 00 00       	push   $0x3e8
   188f9:	e8 2d e6 ff ff       	call   16f2b <sleep>
   188fe:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count ; ++i ) {
   18901:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   18905:	8b 45 e8             	mov    -0x18(%ebp),%eax
   18908:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   1890b:	7c bc                	jl     188c9 <progY+0x14c>
	}

	exit( 0 );
   1890d:	83 ec 0c             	sub    $0xc,%esp
   18910:	6a 00                	push   $0x0
   18912:	e8 b4 e5 ff ff       	call   16ecb <exit>
   18917:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   1891a:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   1891f:	c9                   	leave  
   18920:	c3                   	ret    
...
USERMAIN( progKL ) {
   18921:	55                   	push   %ebp
   18922:	89 e5                	mov    %esp,%ebp
   18924:	83 ec 58             	sub    $0x58,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   18927:	8b 45 0c             	mov    0xc(%ebp),%eax
   1892a:	8b 00                	mov    (%eax),%eax
   1892c:	85 c0                	test   %eax,%eax
   1892e:	74 07                	je     18937 <progKL+0x16>
   18930:	8b 45 0c             	mov    0xc(%ebp),%eax
   18933:	8b 00                	mov    (%eax),%eax
   18935:	eb 05                	jmp    1893c <progKL+0x1b>
   18937:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   1893c:	89 45 e8             	mov    %eax,-0x18(%ebp)
	int count = 5;			// default iteration count
   1893f:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
	char ch = '4';			// default character to print
   18946:	c6 45 df 34          	movb   $0x34,-0x21(%ebp)
	int nap = 30;			// nap time
   1894a:	c7 45 e4 1e 00 00 00 	movl   $0x1e,-0x1c(%ebp)
	char msg2[] = "*4*";	// "error" message to print
   18951:	c7 45 db 2a 34 2a 00 	movl   $0x2a342a,-0x25(%ebp)
	char buf[32];

	// process the command-line arguments
	switch( argc ) {
   18958:	8b 45 08             	mov    0x8(%ebp),%eax
   1895b:	83 f8 02             	cmp    $0x2,%eax
   1895e:	74 1e                	je     1897e <progKL+0x5d>
   18960:	83 f8 03             	cmp    $0x3,%eax
   18963:	75 2c                	jne    18991 <progKL+0x70>
	case 3:	count = ustr2int( argv[2], 10 );
   18965:	8b 45 0c             	mov    0xc(%ebp),%eax
   18968:	83 c0 08             	add    $0x8,%eax
   1896b:	8b 00                	mov    (%eax),%eax
   1896d:	83 ec 08             	sub    $0x8,%esp
   18970:	6a 0a                	push   $0xa
   18972:	50                   	push   %eax
   18973:	e8 72 15 00 00       	call   19eea <ustr2int>
   18978:	83 c4 10             	add    $0x10,%esp
   1897b:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   1897e:	8b 45 0c             	mov    0xc(%ebp),%eax
   18981:	83 c0 04             	add    $0x4,%eax
   18984:	8b 00                	mov    (%eax),%eax
   18986:	0f b6 00             	movzbl (%eax),%eax
   18989:	88 45 df             	mov    %al,-0x21(%ebp)
			break;
   1898c:	e9 9c 00 00 00       	jmp    18a2d <progKL+0x10c>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   18991:	ff 75 08             	pushl  0x8(%ebp)
   18994:	ff 75 e8             	pushl  -0x18(%ebp)
   18997:	68 51 bd 01 00       	push   $0x1bd51
   1899c:	8d 45 bb             	lea    -0x45(%ebp),%eax
   1899f:	50                   	push   %eax
   189a0:	e8 d0 12 00 00       	call   19c75 <usprint>
   189a5:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   189a8:	83 ec 0c             	sub    $0xc,%esp
   189ab:	8d 45 bb             	lea    -0x45(%ebp),%eax
   189ae:	50                   	push   %eax
   189af:	e8 ae 19 00 00       	call   1a362 <cwrites>
   189b4:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   189b7:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
   189be:	eb 55                	jmp    18a15 <progKL+0xf4>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   189c0:	8b 45 08             	mov    0x8(%ebp),%eax
   189c3:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   189ca:	8b 45 0c             	mov    0xc(%ebp),%eax
   189cd:	01 d0                	add    %edx,%eax
   189cf:	8b 00                	mov    (%eax),%eax
   189d1:	85 c0                	test   %eax,%eax
   189d3:	74 13                	je     189e8 <progKL+0xc7>
   189d5:	8b 45 08             	mov    0x8(%ebp),%eax
   189d8:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   189df:	8b 45 0c             	mov    0xc(%ebp),%eax
   189e2:	01 d0                	add    %edx,%eax
   189e4:	8b 00                	mov    (%eax),%eax
   189e6:	eb 05                	jmp    189ed <progKL+0xcc>
   189e8:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   189ed:	83 ec 04             	sub    $0x4,%esp
   189f0:	50                   	push   %eax
   189f1:	68 6c bd 01 00       	push   $0x1bd6c
   189f6:	8d 45 bb             	lea    -0x45(%ebp),%eax
   189f9:	50                   	push   %eax
   189fa:	e8 76 12 00 00       	call   19c75 <usprint>
   189ff:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   18a02:	83 ec 0c             	sub    $0xc,%esp
   18a05:	8d 45 bb             	lea    -0x45(%ebp),%eax
   18a08:	50                   	push   %eax
   18a09:	e8 54 19 00 00       	call   1a362 <cwrites>
   18a0e:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   18a11:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
   18a15:	8b 45 f0             	mov    -0x10(%ebp),%eax
   18a18:	3b 45 08             	cmp    0x8(%ebp),%eax
   18a1b:	7e a3                	jle    189c0 <progKL+0x9f>
			}
			cwrites( "\n" );
   18a1d:	83 ec 0c             	sub    $0xc,%esp
   18a20:	68 70 bd 01 00       	push   $0x1bd70
   18a25:	e8 38 19 00 00       	call   1a362 <cwrites>
   18a2a:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	write( CHAN_SIO, &ch, 1 );
   18a2d:	83 ec 04             	sub    $0x4,%esp
   18a30:	6a 01                	push   $0x1
   18a32:	8d 45 df             	lea    -0x21(%ebp),%eax
   18a35:	50                   	push   %eax
   18a36:	6a 01                	push   $0x1
   18a38:	e8 b6 e4 ff ff       	call   16ef3 <write>
   18a3d:	83 c4 10             	add    $0x10,%esp

	// argument vector for the processes we will spawn
	char *arglist[] = { "progX", "X", buf, NULL };
   18a40:	c7 45 a8 8c be 01 00 	movl   $0x1be8c,-0x58(%ebp)
   18a47:	c7 45 ac 92 be 01 00 	movl   $0x1be92,-0x54(%ebp)
   18a4e:	8d 45 bb             	lea    -0x45(%ebp),%eax
   18a51:	89 45 b0             	mov    %eax,-0x50(%ebp)
   18a54:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%ebp)

	for( int i = 0; i < count ; ++i ) {
   18a5b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   18a62:	e9 89 00 00 00       	jmp    18af0 <progKL+0x1cf>

		write( CHAN_SIO, &ch, 1 );
   18a67:	83 ec 04             	sub    $0x4,%esp
   18a6a:	6a 01                	push   $0x1
   18a6c:	8d 45 df             	lea    -0x21(%ebp),%eax
   18a6f:	50                   	push   %eax
   18a70:	6a 01                	push   $0x1
   18a72:	e8 7c e4 ff ff       	call   16ef3 <write>
   18a77:	83 c4 10             	add    $0x10,%esp

		// second argument to X is 100 plus the iteration number
		usprint( buf, "%d", 100 + i );
   18a7a:	8b 45 ec             	mov    -0x14(%ebp),%eax
   18a7d:	83 c0 64             	add    $0x64,%eax
   18a80:	83 ec 04             	sub    $0x4,%esp
   18a83:	50                   	push   %eax
   18a84:	68 94 be 01 00       	push   $0x1be94
   18a89:	8d 45 bb             	lea    -0x45(%ebp),%eax
   18a8c:	50                   	push   %eax
   18a8d:	e8 e3 11 00 00       	call   19c75 <usprint>
   18a92:	83 c4 10             	add    $0x10,%esp
		int whom = spawn( (uint32_t) progX, arglist );
   18a95:	ba 10 8b 01 00       	mov    $0x18b10,%edx
   18a9a:	83 ec 08             	sub    $0x8,%esp
   18a9d:	8d 45 a8             	lea    -0x58(%ebp),%eax
   18aa0:	50                   	push   %eax
   18aa1:	52                   	push   %edx
   18aa2:	e8 25 18 00 00       	call   1a2cc <spawn>
   18aa7:	83 c4 10             	add    $0x10,%esp
   18aaa:	89 45 e0             	mov    %eax,-0x20(%ebp)
		if( whom < 0 ) {
   18aad:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
   18ab1:	79 11                	jns    18ac4 <progKL+0x1a3>
			swrites( msg2 );
   18ab3:	83 ec 0c             	sub    $0xc,%esp
   18ab6:	8d 45 db             	lea    -0x25(%ebp),%eax
   18ab9:	50                   	push   %eax
   18aba:	e8 09 19 00 00       	call   1a3c8 <swrites>
   18abf:	83 c4 10             	add    $0x10,%esp
   18ac2:	eb 13                	jmp    18ad7 <progKL+0x1b6>
		} else {
			write( CHAN_SIO, &ch, 1 );
   ...
   18acf:	e8 1f e4 ff ff       	call   16ef3 <write>
   18ad4:	83 c4 10             	add    $0x10,%esp
		}

		sleep( SEC_TO_MS(nap) );
   18ad7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
   18ada:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   18ae0:	83 ec 0c             	sub    $0xc,%esp
   18ae3:	50                   	push   %eax
   18ae4:	e8 42 e4 ff ff       	call   16f2b <sleep>
   18ae9:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count ; ++i ) {
   18aec:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   18af0:	8b 45 ec             	mov    -0x14(%ebp),%eax
   18af3:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   18af6:	0f 8c 6b ff ff ff    	jl     18a67 <progKL+0x146>
	}

	exit( 0 );
   18afc:	83 ec 0c             	sub    $0xc,%esp
   18aff:	6a 00                	push   $0x0
   18b01:	e8 c5 e3 ff ff       	call   16ecb <exit>
   18b06:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   18b09:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   18b0e:	c9                   	leave  
   18b0f:	c3                   	ret    
...
USERMAIN( progX ) {
   18b10:	55                   	push   %ebp
   18b11:	89 e5                	mov    %esp,%ebp
   18b13:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   18b19:	8b 45 0c             	mov    0xc(%ebp),%eax
   18b1c:	8b 00                	mov    (%eax),%eax
   18b1e:	85 c0                	test   %eax,%eax
   18b20:	74 07                	je     18b29 <progX+0x19>
   18b22:	8b 45 0c             	mov    0xc(%ebp),%eax
   18b25:	8b 00                	mov    (%eax),%eax
   18b27:	eb 05                	jmp    18b2e <progX+0x1e>
   18b29:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   18b2e:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int count = 20;	  // iteration count
   18b31:	c7 45 f4 14 00 00 00 	movl   $0x14,-0xc(%ebp)
	char ch = 'x';	  // default character to print
   18b38:	c6 45 f3 78          	movb   $0x78,-0xd(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   18b3c:	8b 45 08             	mov    0x8(%ebp),%eax
   18b3f:	83 f8 02             	cmp    $0x2,%eax
   18b42:	74 1e                	je     18b62 <progX+0x52>
   18b44:	83 f8 03             	cmp    $0x3,%eax
   18b47:	75 2c                	jne    18b75 <progX+0x65>
	case 3:	count = ustr2int( argv[2], 10 );
   18b49:	8b 45 0c             	mov    0xc(%ebp),%eax
   18b4c:	83 c0 08             	add    $0x8,%eax
   18b4f:	8b 00                	mov    (%eax),%eax
   18b51:	83 ec 08             	sub    $0x8,%esp
   18b54:	6a 0a                	push   $0xa
   18b56:	50                   	push   %eax
   18b57:	e8 8e 13 00 00       	call   19eea <ustr2int>
   18b5c:	83 c4 10             	add    $0x10,%esp
   18b5f:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   18b62:	8b 45 0c             	mov    0xc(%ebp),%eax
   18b65:	83 c0 04             	add    $0x4,%eax
   18b68:	8b 00                	mov    (%eax),%eax
   18b6a:	0f b6 00             	movzbl (%eax),%eax
   18b6d:	88 45 f3             	mov    %al,-0xd(%ebp)
			break;
   18b70:	e9 a8 00 00 00       	jmp    18c1d <progX+0x10d>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   18b75:	ff 75 08             	pushl  0x8(%ebp)
   18b78:	ff 75 e0             	pushl  -0x20(%ebp)
   18b7b:	68 51 bd 01 00       	push   $0x1bd51
   18b80:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18b86:	50                   	push   %eax
   18b87:	e8 e9 10 00 00       	call   19c75 <usprint>
   18b8c:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   18b8f:	83 ec 0c             	sub    $0xc,%esp
   18b92:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18b98:	50                   	push   %eax
   18b99:	e8 c4 17 00 00       	call   1a362 <cwrites>
   18b9e:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   18ba1:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   18ba8:	eb 5b                	jmp    18c05 <progX+0xf5>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   18baa:	8b 45 08             	mov    0x8(%ebp),%eax
   18bad:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18bb4:	8b 45 0c             	mov    0xc(%ebp),%eax
   18bb7:	01 d0                	add    %edx,%eax
   18bb9:	8b 00                	mov    (%eax),%eax
   18bbb:	85 c0                	test   %eax,%eax
   18bbd:	74 13                	je     18bd2 <progX+0xc2>
   18bbf:	8b 45 08             	mov    0x8(%ebp),%eax
   18bc2:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18bc9:	8b 45 0c             	mov    0xc(%ebp),%eax
   18bcc:	01 d0                	add    %edx,%eax
   18bce:	8b 00                	mov    (%eax),%eax
   18bd0:	eb 05                	jmp    18bd7 <progX+0xc7>
   18bd2:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   18bd7:	83 ec 04             	sub    $0x4,%esp
   18bda:	50                   	push   %eax
   18bdb:	68 6c bd 01 00       	push   $0x1bd6c
   18be0:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18be6:	50                   	push   %eax
   18be7:	e8 89 10 00 00       	call   19c75 <usprint>
   18bec:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   18bef:	83 ec 0c             	sub    $0xc,%esp
   18bf2:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18bf8:	50                   	push   %eax
   18bf9:	e8 64 17 00 00       	call   1a362 <cwrites>
   18bfe:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   18c01:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   18c05:	8b 45 ec             	mov    -0x14(%ebp),%eax
   18c08:	3b 45 08             	cmp    0x8(%ebp),%eax
   18c0b:	7e 9d                	jle    18baa <progX+0x9a>
			}
			cwrites( "\n" );
   18c0d:	83 ec 0c             	sub    $0xc,%esp
   18c10:	68 70 bd 01 00       	push   $0x1bd70
   18c15:	e8 48 17 00 00       	call   1a362 <cwrites>
   18c1a:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	int pid = getpid();
   18c1d:	e8 d9 e2 ff ff       	call   16efb <getpid>
   18c22:	89 45 dc             	mov    %eax,-0x24(%ebp)
	usprint( buf, " %c[%d]", ch, pid );
   18c25:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   18c29:	ff 75 dc             	pushl  -0x24(%ebp)
   18c2c:	50                   	push   %eax
   18c2d:	68 2a be 01 00       	push   $0x1be2a
   18c32:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18c38:	50                   	push   %eax
   18c39:	e8 37 10 00 00       	call   19c75 <usprint>
   18c3e:	83 c4 10             	add    $0x10,%esp
	swrites( buf );
   18c41:	83 ec 0c             	sub    $0xc,%esp
   18c44:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18c4a:	50                   	push   %eax
   18c4b:	e8 78 17 00 00       	call   1a3c8 <swrites>
   18c50:	83 c4 10             	add    $0x10,%esp

	for( int i = 0; i < count ; ++i ) {
   18c53:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   18c5a:	eb 2c                	jmp    18c88 <progX+0x178>
		swrites( buf );
   18c5c:	83 ec 0c             	sub    $0xc,%esp
   18c5f:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
   18c65:	50                   	push   %eax
   18c66:	e8 5d 17 00 00       	call   1a3c8 <swrites>
   18c6b:	83 c4 10             	add    $0x10,%esp
		DELAY(STD);
   18c6e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
   18c75:	eb 04                	jmp    18c7b <progX+0x16b>
   18c77:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
   18c7b:	81 7d e4 9f 25 26 00 	cmpl   $0x26259f,-0x1c(%ebp)
   18c82:	7e f3                	jle    18c77 <progX+0x167>
	for( int i = 0; i < count ; ++i ) {
   18c84:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   18c88:	8b 45 e8             	mov    -0x18(%ebp),%eax
   18c8b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   18c8e:	7c cc                	jl     18c5c <progX+0x14c>
	}

	exit( 12 );
   18c90:	83 ec 0c             	sub    $0xc,%esp
   18c93:	6a 0c                	push   $0xc
   18c95:	e8 31 e2 ff ff       	call   16ecb <exit>
   18c9a:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   18c9d:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   18ca2:	c9                   	leave  
   18ca3:	c3                   	ret    
...
USERMAIN( progMN ) {
   18ca4:	55                   	push   %ebp
   18ca5:	89 e5                	mov    %esp,%ebp
   18ca7:	81 ec d8 00 00 00    	sub    $0xd8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   18cad:	8b 45 0c             	mov    0xc(%ebp),%eax
   18cb0:	8b 00                	mov    (%eax),%eax
   18cb2:	85 c0                	test   %eax,%eax
   18cb4:	74 07                	je     18cbd <progMN+0x19>
   18cb6:	8b 45 0c             	mov    0xc(%ebp),%eax
   18cb9:	8b 00                	mov    (%eax),%eax
   18cbb:	eb 05                	jmp    18cc2 <progMN+0x1e>
   18cbd:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   18cc2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	int count = 5;	// default iteration count
   18cc5:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
	char ch = '5';	// default character to print
   18ccc:	c6 45 df 35          	movb   $0x35,-0x21(%ebp)
	int alsoZ = 0;	// also do progZ?
   18cd0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
	char msgw[] = "*5w*";
   18cd7:	c7 45 da 2a 35 77 2a 	movl   $0x2a77352a,-0x26(%ebp)
   18cde:	c6 45 de 00          	movb   $0x0,-0x22(%ebp)
	char msgz[] = "*5z*";
   18ce2:	c7 45 d5 2a 35 7a 2a 	movl   $0x2a7a352a,-0x2b(%ebp)
   18ce9:	c6 45 d9 00          	movb   $0x0,-0x27(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   18ced:	8b 45 08             	mov    0x8(%ebp),%eax
   18cf0:	83 f8 03             	cmp    $0x3,%eax
   18cf3:	74 22                	je     18d17 <progMN+0x73>
   18cf5:	83 f8 04             	cmp    $0x4,%eax
   18cf8:	74 07                	je     18d01 <progMN+0x5d>
   18cfa:	83 f8 02             	cmp    $0x2,%eax
   18cfd:	74 31                	je     18d30 <progMN+0x8c>
   18cff:	eb 42                	jmp    18d43 <progMN+0x9f>
	case 4:	alsoZ = argv[3][0] == 't';
   18d01:	8b 45 0c             	mov    0xc(%ebp),%eax
   18d04:	83 c0 0c             	add    $0xc,%eax
   18d07:	8b 00                	mov    (%eax),%eax
   18d09:	0f b6 00             	movzbl (%eax),%eax
   18d0c:	3c 74                	cmp    $0x74,%al
   18d0e:	0f 94 c0             	sete   %al
   18d11:	0f b6 c0             	movzbl %al,%eax
   18d14:	89 45 f0             	mov    %eax,-0x10(%ebp)
			// FALL THROUGH
	case 3:	count = ustr2int( argv[2], 10 );
   18d17:	8b 45 0c             	mov    0xc(%ebp),%eax
   18d1a:	83 c0 08             	add    $0x8,%eax
   18d1d:	8b 00                	mov    (%eax),%eax
   18d1f:	83 ec 08             	sub    $0x8,%esp
   18d22:	6a 0a                	push   $0xa
   18d24:	50                   	push   %eax
   18d25:	e8 c0 11 00 00       	call   19eea <ustr2int>
   18d2a:	83 c4 10             	add    $0x10,%esp
   18d2d:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   18d30:	8b 45 0c             	mov    0xc(%ebp),%eax
   18d33:	83 c0 04             	add    $0x4,%eax
   18d36:	8b 00                	mov    (%eax),%eax
   18d38:	0f b6 00             	movzbl (%eax),%eax
   18d3b:	88 45 df             	mov    %al,-0x21(%ebp)
			break;
   18d3e:	e9 a8 00 00 00       	jmp    18deb <progMN+0x147>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   18d43:	ff 75 08             	pushl  0x8(%ebp)
   18d46:	ff 75 e4             	pushl  -0x1c(%ebp)
   18d49:	68 51 bd 01 00       	push   $0x1bd51
   18d4e:	8d 85 55 ff ff ff    	lea    -0xab(%ebp),%eax
   18d54:	50                   	push   %eax
   18d55:	e8 1b 0f 00 00       	call   19c75 <usprint>
   18d5a:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   18d5d:	83 ec 0c             	sub    $0xc,%esp
   18d60:	8d 85 55 ff ff ff    	lea    -0xab(%ebp),%eax
   18d66:	50                   	push   %eax
   18d67:	e8 f6 15 00 00       	call   1a362 <cwrites>
   18d6c:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   18d6f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   18d76:	eb 5b                	jmp    18dd3 <progMN+0x12f>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   18d78:	8b 45 08             	mov    0x8(%ebp),%eax
   18d7b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18d82:	8b 45 0c             	mov    0xc(%ebp),%eax
   18d85:	01 d0                	add    %edx,%eax
   18d87:	8b 00                	mov    (%eax),%eax
   18d89:	85 c0                	test   %eax,%eax
   18d8b:	74 13                	je     18da0 <progMN+0xfc>
   18d8d:	8b 45 08             	mov    0x8(%ebp),%eax
   18d90:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18d97:	8b 45 0c             	mov    0xc(%ebp),%eax
   18d9a:	01 d0                	add    %edx,%eax
   18d9c:	8b 00                	mov    (%eax),%eax
   18d9e:	eb 05                	jmp    18da5 <progMN+0x101>
   18da0:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   18da5:	83 ec 04             	sub    $0x4,%esp
   18da8:	50                   	push   %eax
   18da9:	68 6c bd 01 00       	push   $0x1bd6c
   18dae:	8d 85 55 ff ff ff    	lea    -0xab(%ebp),%eax
   18db4:	50                   	push   %eax
   18db5:	e8 bb 0e 00 00       	call   19c75 <usprint>
   18dba:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   18dbd:	83 ec 0c             	sub    $0xc,%esp
   18dc0:	8d 85 55 ff ff ff    	lea    -0xab(%ebp),%eax
   18dc6:	50                   	push   %eax
   18dc7:	e8 96 15 00 00       	call   1a362 <cwrites>
   18dcc:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   18dcf:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   18dd3:	8b 45 ec             	mov    -0x14(%ebp),%eax
   18dd6:	3b 45 08             	cmp    0x8(%ebp),%eax
   18dd9:	7e 9d                	jle    18d78 <progMN+0xd4>
			}
			cwrites( "\n" );
   18ddb:	83 ec 0c             	sub    $0xc,%esp
   18dde:	68 70 bd 01 00       	push   $0x1bd70
   18de3:	e8 7a 15 00 00       	call   1a362 <cwrites>
   18de8:	83 c4 10             	add    $0x10,%esp
	}

	// update the extra message strings
	msgw[1] = msgz[1] = ch;
   18deb:	0f b6 45 df          	movzbl -0x21(%ebp),%eax
   18def:	88 45 d6             	mov    %al,-0x2a(%ebp)
   18df2:	0f b6 45 d6          	movzbl -0x2a(%ebp),%eax
   18df6:	88 45 db             	mov    %al,-0x25(%ebp)

	// announce our presence
	write( CHAN_SIO, &ch, 1 );
   18df9:	83 ec 04             	sub    $0x4,%esp
   18dfc:	6a 01                	push   $0x1
   18dfe:	8d 45 df             	lea    -0x21(%ebp),%eax
   18e01:	50                   	push   %eax
   18e02:	6a 01                	push   $0x1
   18e04:	e8 ea e0 ff ff       	call   16ef3 <write>
   ...
   18e0c:	c7 85 40 ff ff ff 32 	movl   $0x1be32,-0xc0(%ebp)
   18e13:	be 01 00 
   18e16:	c7 85 44 ff ff ff 46 	movl   $0x1bb46,-0xbc(%ebp)
   18e1d:	bb 01 00 
   18e20:	c7 85 48 ff ff ff 97 	movl   $0x1be97,-0xb8(%ebp)
   18e27:	be 01 00 
   18e2a:	c7 85 4c ff ff ff f3 	movl   $0x1baf3,-0xb4(%ebp)
   18e31:	ba 01 00 
   18e34:	c7 85 50 ff ff ff 00 	movl   $0x0,-0xb0(%ebp)
   18e3b:	00 00 00 

	// Z:  15 iterations
	char *argsz[] = { "progZ", "Z", "15", NULL };
   18e3e:	c7 85 30 ff ff ff e9 	movl   $0x1bde9,-0xd0(%ebp)
   18e45:	bd 01 00 
   18e48:	c7 85 34 ff ff ff ef 	movl   $0x1bdef,-0xcc(%ebp)
   18e4f:	bd 01 00 
   18e52:	c7 85 38 ff ff ff 97 	movl   $0x1be97,-0xc8(%ebp)
   18e59:	be 01 00 
   18e5c:	c7 85 3c ff ff ff 00 	movl   $0x0,-0xc4(%ebp)
   18e63:	00 00 00 

	for( int i = 0; i < count; ++i ) {
   18e66:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   18e6d:	eb 7d                	jmp    18eec <progMN+0x248>
		write( CHAN_SIO, &ch, 1 );
   18e6f:	83 ec 04             	sub    $0x4,%esp
   18e72:	6a 01                	push   $0x1
   18e74:	8d 45 df             	lea    -0x21(%ebp),%eax
   18e77:	50                   	push   %eax
   18e78:	6a 01                	push   $0x1
   18e7a:	e8 74 e0 ff ff       	call   16ef3 <write>
   18e7f:	83 c4 10             	add    $0x10,%esp
		int whom = spawn( (uint32_t) progW, argsw	);
   18e82:	ba b7 83 01 00       	mov    $0x183b7,%edx
   18e87:	83 ec 08             	sub    $0x8,%esp
   18e8a:	8d 85 40 ff ff ff    	lea    -0xc0(%ebp),%eax
   18e90:	50                   	push   %eax
   18e91:	52                   	push   %edx
   18e92:	e8 35 14 00 00       	call   1a2cc <spawn>
   18e97:	83 c4 10             	add    $0x10,%esp
   18e9a:	89 45 e0             	mov    %eax,-0x20(%ebp)
		if( whom < 1 ) {
   18e9d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
   18ea1:	7f 0f                	jg     18eb2 <progMN+0x20e>
			swrites( msgw );
   18ea3:	83 ec 0c             	sub    $0xc,%esp
   18ea6:	8d 45 da             	lea    -0x26(%ebp),%eax
   18ea9:	50                   	push   %eax
   18eaa:	e8 19 15 00 00       	call   1a3c8 <swrites>
   18eaf:	83 c4 10             	add    $0x10,%esp
		}
		if( alsoZ ) {
   18eb2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
   18eb6:	74 30                	je     18ee8 <progMN+0x244>
			whom = spawn( (uint32_t) progZ, argsz );
   18eb8:	ba 7d 7e 01 00       	mov    $0x17e7d,%edx
   18ebd:	83 ec 08             	sub    $0x8,%esp
   18ec0:	8d 85 30 ff ff ff    	lea    -0xd0(%ebp),%eax
   18ec6:	50                   	push   %eax
   18ec7:	52                   	push   %edx
   18ec8:	e8 ff 13 00 00       	call   1a2cc <spawn>
   18ecd:	83 c4 10             	add    $0x10,%esp
   18ed0:	89 45 e0             	mov    %eax,-0x20(%ebp)
			if( whom < 1 ) {
   18ed3:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
   18ed7:	7f 0f                	jg     18ee8 <progMN+0x244>
				swrites( msgz );
   18ed9:	83 ec 0c             	sub    $0xc,%esp
   18edc:	8d 45 d5             	lea    -0x2b(%ebp),%eax
   18edf:	50                   	push   %eax
   18ee0:	e8 e3 14 00 00       	call   1a3c8 <swrites>
   18ee5:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count; ++i ) {
   18ee8:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   18eec:	8b 45 e8             	mov    -0x18(%ebp),%eax
   18eef:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   18ef2:	0f 8c 77 ff ff ff    	jl     18e6f <progMN+0x1cb>
			}
		}
	}

	exit( 0 );
   18ef8:	83 ec 0c             	sub    $0xc,%esp
   18efb:	6a 00                	push   $0x0
   18efd:	e8 c9 df ff ff       	call   16ecb <exit>
   18f02:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   18f05:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   18f0a:	c9                   	leave  
   18f0b:	c3                   	ret    
...
USERMAIN( progP ) {
   18f0c:	55                   	push   %ebp
   18f0d:	89 e5                	mov    %esp,%ebp
   18f0f:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   18f15:	8b 45 0c             	mov    0xc(%ebp),%eax
   18f18:	8b 00                	mov    (%eax),%eax
   18f1a:	85 c0                	test   %eax,%eax
   18f1c:	74 07                	je     18f25 <progP+0x19>
   18f1e:	8b 45 0c             	mov    0xc(%ebp),%eax
   18f21:	8b 00                	mov    (%eax),%eax
   18f23:	eb 05                	jmp    18f2a <progP+0x1e>
   18f25:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   18f2a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	int count = 3;	  // default iteration count
   18f2d:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
	char ch = 'p';	  // default character to print
   18f34:	c6 45 df 70          	movb   $0x70,-0x21(%ebp)
	int nap = 2;	  // nap time
   18f38:	c7 45 f0 02 00 00 00 	movl   $0x2,-0x10(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   18f3f:	8b 45 08             	mov    0x8(%ebp),%eax
   18f42:	83 f8 03             	cmp    $0x3,%eax
   18f45:	74 25                	je     18f6c <progP+0x60>
   18f47:	83 f8 04             	cmp    $0x4,%eax
   18f4a:	74 07                	je     18f53 <progP+0x47>
   18f4c:	83 f8 02             	cmp    $0x2,%eax
   18f4f:	74 34                	je     18f85 <progP+0x79>
   18f51:	eb 45                	jmp    18f98 <progP+0x8c>
	case 4:	nap = ustr2int( argv[3], 10 );
   18f53:	8b 45 0c             	mov    0xc(%ebp),%eax
   18f56:	83 c0 0c             	add    $0xc,%eax
   18f59:	8b 00                	mov    (%eax),%eax
   18f5b:	83 ec 08             	sub    $0x8,%esp
   18f5e:	6a 0a                	push   $0xa
   18f60:	50                   	push   %eax
   18f61:	e8 84 0f 00 00       	call   19eea <ustr2int>
   18f66:	83 c4 10             	add    $0x10,%esp
   18f69:	89 45 f0             	mov    %eax,-0x10(%ebp)
			// FALL THROUGH
	case 3:	count = ustr2int( argv[2], 10 );
   18f6c:	8b 45 0c             	mov    0xc(%ebp),%eax
   18f6f:	83 c0 08             	add    $0x8,%eax
   18f72:	8b 00                	mov    (%eax),%eax
   18f74:	83 ec 08             	sub    $0x8,%esp
   18f77:	6a 0a                	push   $0xa
   18f79:	50                   	push   %eax
   18f7a:	e8 6b 0f 00 00       	call   19eea <ustr2int>
   18f7f:	83 c4 10             	add    $0x10,%esp
   18f82:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   18f85:	8b 45 0c             	mov    0xc(%ebp),%eax
   18f88:	83 c0 04             	add    $0x4,%eax
   18f8b:	8b 00                	mov    (%eax),%eax
   18f8d:	0f b6 00             	movzbl (%eax),%eax
   18f90:	88 45 df             	mov    %al,-0x21(%ebp)
			break;
   18f93:	e9 a8 00 00 00       	jmp    19040 <progP+0x134>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   18f98:	ff 75 08             	pushl  0x8(%ebp)
   18f9b:	ff 75 e4             	pushl  -0x1c(%ebp)
   18f9e:	68 51 bd 01 00       	push   $0x1bd51
   18fa3:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   18fa9:	50                   	push   %eax
   18faa:	e8 c6 0c 00 00       	call   19c75 <usprint>
   18faf:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   18fb2:	83 ec 0c             	sub    $0xc,%esp
   18fb5:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   18fbb:	50                   	push   %eax
   18fbc:	e8 a1 13 00 00       	call   1a362 <cwrites>
   18fc1:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   18fc4:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
   18fcb:	eb 5b                	jmp    19028 <progP+0x11c>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   18fcd:	8b 45 08             	mov    0x8(%ebp),%eax
   18fd0:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18fd7:	8b 45 0c             	mov    0xc(%ebp),%eax
   18fda:	01 d0                	add    %edx,%eax
   18fdc:	8b 00                	mov    (%eax),%eax
   18fde:	85 c0                	test   %eax,%eax
   18fe0:	74 13                	je     18ff5 <progP+0xe9>
   18fe2:	8b 45 08             	mov    0x8(%ebp),%eax
   18fe5:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   18fec:	8b 45 0c             	mov    0xc(%ebp),%eax
   18fef:	01 d0                	add    %edx,%eax
   18ff1:	8b 00                	mov    (%eax),%eax
   18ff3:	eb 05                	jmp    18ffa <progP+0xee>
   18ff5:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   18ffa:	83 ec 04             	sub    $0x4,%esp
   18ffd:	50                   	push   %eax
   18ffe:	68 6c bd 01 00       	push   $0x1bd6c
   19003:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   19009:	50                   	push   %eax
   1900a:	e8 66 0c 00 00       	call   19c75 <usprint>
   1900f:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   19012:	83 ec 0c             	sub    $0xc,%esp
   19015:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   1901b:	50                   	push   %eax
   1901c:	e8 41 13 00 00       	call   1a362 <cwrites>
   19021:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   19024:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
   19028:	8b 45 ec             	mov    -0x14(%ebp),%eax
   1902b:	3b 45 08             	cmp    0x8(%ebp),%eax
   1902e:	7e 9d                	jle    18fcd <progP+0xc1>
			}
			cwrites( "\n" );
   19030:	83 ec 0c             	sub    $0xc,%esp
   19033:	68 70 bd 01 00       	push   $0x1bd70
   19038:	e8 25 13 00 00       	call   1a362 <cwrites>
   1903d:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	uint32_t now = gettime();
   19040:	e8 c6 de ff ff       	call   16f0b <gettime>
   19045:	89 45 e0             	mov    %eax,-0x20(%ebp)
	usprint( buf, " P@%u", now );
   19048:	83 ec 04             	sub    $0x4,%esp
   1904b:	ff 75 e0             	pushl  -0x20(%ebp)
   1904e:	68 9a be 01 00       	push   $0x1be9a
   19053:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   19059:	50                   	push   %eax
   1905a:	e8 16 0c 00 00       	call   19c75 <usprint>
   1905f:	83 c4 10             	add    $0x10,%esp
	swrites( buf );
   19062:	83 ec 0c             	sub    $0xc,%esp
   19065:	8d 85 5f ff ff ff    	lea    -0xa1(%ebp),%eax
   1906b:	50                   	push   %eax
   1906c:	e8 57 13 00 00       	call   1a3c8 <swrites>
   19071:	83 c4 10             	add    $0x10,%esp

	for( int i = 0; i < count; ++i ) {
   19074:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   1907b:	eb 2c                	jmp    190a9 <progP+0x19d>
		sleep( SEC_TO_MS(nap) );
   1907d:	8b 45 f0             	mov    -0x10(%ebp),%eax
   19080:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   19086:	83 ec 0c             	sub    $0xc,%esp
   19089:	50                   	push   %eax
   1908a:	e8 9c de ff ff       	call   16f2b <sleep>
   1908f:	83 c4 10             	add    $0x10,%esp
		write( CHAN_SIO, &ch, 1 );
   19092:	83 ec 04             	sub    $0x4,%esp
   19095:	6a 01                	push   $0x1
   19097:	8d 45 df             	lea    -0x21(%ebp),%eax
   1909a:	50                   	push   %eax
   1909b:	6a 01                	push   $0x1
   1909d:	e8 51 de ff ff       	call   16ef3 <write>
   190a2:	83 c4 10             	add    $0x10,%esp
	for( int i = 0; i < count; ++i ) {
   190a5:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   190a9:	8b 45 e8             	mov    -0x18(%ebp),%eax
   190ac:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   190af:	7c cc                	jl     1907d <progP+0x171>
	}

	exit( 0 );
   190b1:	83 ec 0c             	sub    $0xc,%esp
   190b4:	6a 00                	push   $0x0
   190b6:	e8 10 de ff ff       	call   16ecb <exit>
   190bb:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   190be:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   190c3:	c9                   	leave  
   190c4:	c3                   	ret    
...
USERMAIN( progQ ) {
   190c5:	55                   	push   %ebp
   190c6:	89 e5                	mov    %esp,%ebp
   190c8:	81 ec 98 00 00 00    	sub    $0x98,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   190ce:	8b 45 0c             	mov    0xc(%ebp),%eax
   190d1:	8b 00                	mov    (%eax),%eax
   190d3:	85 c0                	test   %eax,%eax
   190d5:	74 07                	je     190de <progQ+0x19>
   190d7:	8b 45 0c             	mov    0xc(%ebp),%eax
   190da:	8b 00                	mov    (%eax),%eax
   190dc:	eb 05                	jmp    190e3 <progQ+0x1e>
   190de:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   190e3:	89 45 f0             	mov    %eax,-0x10(%ebp)
	char ch = 'q';	  // default character to print
   190e6:	c6 45 ef 71          	movb   $0x71,-0x11(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   190ea:	8b 45 08             	mov    0x8(%ebp),%eax
   190ed:	83 f8 02             	cmp    $0x2,%eax
   190f0:	75 13                	jne    19105 <progQ+0x40>
	case 2:	ch = argv[1][0];
   190f2:	8b 45 0c             	mov    0xc(%ebp),%eax
   190f5:	83 c0 04             	add    $0x4,%eax
   190f8:	8b 00                	mov    (%eax),%eax
   190fa:	0f b6 00             	movzbl (%eax),%eax
   190fd:	88 45 ef             	mov    %al,-0x11(%ebp)
			break;
   19100:	e9 a8 00 00 00       	jmp    191ad <progQ+0xe8>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   19105:	ff 75 08             	pushl  0x8(%ebp)
   19108:	ff 75 f0             	pushl  -0x10(%ebp)
   1910b:	68 51 bd 01 00       	push   $0x1bd51
   19110:	8d 85 6f ff ff ff    	lea    -0x91(%ebp),%eax
   19116:	50                   	push   %eax
   19117:	e8 59 0b 00 00       	call   19c75 <usprint>
   1911c:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   1911f:	83 ec 0c             	sub    $0xc,%esp
   19122:	8d 85 6f ff ff ff    	lea    -0x91(%ebp),%eax
   19128:	50                   	push   %eax
   19129:	e8 34 12 00 00       	call   1a362 <cwrites>
   1912e:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   19131:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
   19138:	eb 5b                	jmp    19195 <progQ+0xd0>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   1913a:	8b 45 08             	mov    0x8(%ebp),%eax
   1913d:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   19144:	8b 45 0c             	mov    0xc(%ebp),%eax
   19147:	01 d0                	add    %edx,%eax
   19149:	8b 00                	mov    (%eax),%eax
   1914b:	85 c0                	test   %eax,%eax
   1914d:	74 13                	je     19162 <progQ+0x9d>
   1914f:	8b 45 08             	mov    0x8(%ebp),%eax
   19152:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   19159:	8b 45 0c             	mov    0xc(%ebp),%eax
   1915c:	01 d0                	add    %edx,%eax
   1915e:	8b 00                	mov    (%eax),%eax
   19160:	eb 05                	jmp    19167 <progQ+0xa2>
   19162:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   19167:	83 ec 04             	sub    $0x4,%esp
   1916a:	50                   	push   %eax
   1916b:	68 6c bd 01 00       	push   $0x1bd6c
   19170:	8d 85 6f ff ff ff    	lea    -0x91(%ebp),%eax
   19176:	50                   	push   %eax
   19177:	e8 f9 0a 00 00       	call   19c75 <usprint>
   1917c:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   1917f:	83 ec 0c             	sub    $0xc,%esp
   19182:	8d 85 6f ff ff ff    	lea    -0x91(%ebp),%eax
   19188:	50                   	push   %eax
   19189:	e8 d4 11 00 00       	call   1a362 <cwrites>
   1918e:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   19191:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
   19195:	8b 45 f4             	mov    -0xc(%ebp),%eax
   19198:	3b 45 08             	cmp    0x8(%ebp),%eax
   1919b:	7e 9d                	jle    1913a <progQ+0x75>
			}
			cwrites( "\n" );
   1919d:	83 ec 0c             	sub    $0xc,%esp
   191a0:	68 70 bd 01 00       	push   $0x1bd70
   191a5:	e8 b8 11 00 00       	call   1a362 <cwrites>
   191aa:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	write( CHAN_SIO, &ch, 1 );
   191ad:	83 ec 04             	sub    $0x4,%esp
   191b0:	6a 01                	push   $0x1
   191b2:	8d 45 ef             	lea    -0x11(%ebp),%eax
   191b5:	50                   	push   %eax
   191b6:	6a 01                	push   $0x1
   191b8:	e8 36 dd ff ff       	call   16ef3 <write>
   191bd:	83 c4 10             	add    $0x10,%esp

	// try something weird
	bogus();
   191c0:	e8 6e dd ff ff       	call   16f33 <bogus>

	// should not have come back here!
	usprint( buf, "!!!!! %c returned from bogus syscall!?!?!\n", ch );
   191c5:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
   191c9:	0f be c0             	movsbl %al,%eax
   191cc:	83 ec 04             	sub    $0x4,%esp
   191cf:	50                   	push   %eax
   191d0:	68 a0 be 01 00       	push   $0x1bea0
   191d5:	8d 85 6f ff ff ff    	lea    -0x91(%ebp),%eax
   191db:	50                   	push   %eax
   191dc:	e8 94 0a 00 00       	call   19c75 <usprint>
   191e1:	83 c4 10             	add    $0x10,%esp
	cwrites( buf );
   191e4:	83 ec 0c             	sub    $0xc,%esp
   191e7:	8d 85 6f ff ff ff    	lea    -0x91(%ebp),%eax
   191ed:	50                   	push   %eax
   191ee:	e8 6f 11 00 00       	call   1a362 <cwrites>
   191f3:	83 c4 10             	add    $0x10,%esp

	exit( 1 );
   191f6:	83 ec 0c             	sub    $0xc,%esp
   191f9:	6a 01                	push   $0x1
   191fb:	e8 cb dc ff ff       	call   16ecb <exit>
   19200:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   19203:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   19208:	c9                   	leave  
   19209:	c3                   	ret    
...
USERMAIN( progR ) {
   1920a:	55                   	push   %ebp
   1920b:	89 e5                	mov    %esp,%ebp
   1920d:	81 ec a8 00 00 00    	sub    $0xa8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   19213:	8b 45 0c             	mov    0xc(%ebp),%eax
   19216:	8b 00                	mov    (%eax),%eax
   19218:	85 c0                	test   %eax,%eax
   1921a:	74 07                	je     19223 <progR+0x19>
   1921c:	8b 45 0c             	mov    0xc(%ebp),%eax
   1921f:	8b 00                	mov    (%eax),%eax
   19221:	eb 05                	jmp    19228 <progR+0x1e>
   19223:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   19228:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	char ch = 'r';	// default character to print
   1922b:	c6 45 f7 72          	movb   $0x72,-0x9(%ebp)
	int delay = 10;	// initial delay count
   1922f:	c7 45 f0 0a 00 00 00 	movl   $0xa,-0x10(%ebp)
	int seq = 99;	// my sequence number
   19236:	c7 45 ec 63 00 00 00 	movl   $0x63,-0x14(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   1923d:	8b 45 08             	mov    0x8(%ebp),%eax
   19240:	83 f8 03             	cmp    $0x3,%eax
   19243:	74 25                	je     1926a <progR+0x60>
   19245:	83 f8 04             	cmp    $0x4,%eax
   19248:	74 07                	je     19251 <progR+0x47>
   1924a:	83 f8 02             	cmp    $0x2,%eax
   1924d:	74 34                	je     19283 <progR+0x79>
   1924f:	eb 45                	jmp    19296 <progR+0x8c>
	case 4:	delay = ustr2int( argv[3], 10 );
   19251:	8b 45 0c             	mov    0xc(%ebp),%eax
   19254:	83 c0 0c             	add    $0xc,%eax
   19257:	8b 00                	mov    (%eax),%eax
   19259:	83 ec 08             	sub    $0x8,%esp
   1925c:	6a 0a                	push   $0xa
   1925e:	50                   	push   %eax
   1925f:	e8 86 0c 00 00       	call   19eea <ustr2int>
   19264:	83 c4 10             	add    $0x10,%esp
   19267:	89 45 f0             	mov    %eax,-0x10(%ebp)
			// FALL THROUGH
	case 3:	seq = ustr2int( argv[2], 10 );
   1926a:	8b 45 0c             	mov    0xc(%ebp),%eax
   1926d:	83 c0 08             	add    $0x8,%eax
   19270:	8b 00                	mov    (%eax),%eax
   19272:	83 ec 08             	sub    $0x8,%esp
   19275:	6a 0a                	push   $0xa
   19277:	50                   	push   %eax
   19278:	e8 6d 0c 00 00       	call   19eea <ustr2int>
   1927d:	83 c4 10             	add    $0x10,%esp
   19280:	89 45 ec             	mov    %eax,-0x14(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   19283:	8b 45 0c             	mov    0xc(%ebp),%eax
   19286:	83 c0 04             	add    $0x4,%eax
   19289:	8b 00                	mov    (%eax),%eax
   1928b:	0f b6 00             	movzbl (%eax),%eax
   1928e:	88 45 f7             	mov    %al,-0x9(%ebp)
			break;
   19291:	e9 a8 00 00 00       	jmp    1933e <progR+0x134>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   19296:	ff 75 08             	pushl  0x8(%ebp)
   19299:	ff 75 e4             	pushl  -0x1c(%ebp)
   1929c:	68 51 bd 01 00       	push   $0x1bd51
   192a1:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   192a7:	50                   	push   %eax
   192a8:	e8 c8 09 00 00       	call   19c75 <usprint>
   192ad:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   192b0:	83 ec 0c             	sub    $0xc,%esp
   192b3:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   192b9:	50                   	push   %eax
   192ba:	e8 a3 10 00 00       	call   1a362 <cwrites>
   192bf:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   192c2:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   192c9:	eb 5b                	jmp    19326 <progR+0x11c>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   192cb:	8b 45 08             	mov    0x8(%ebp),%eax
   192ce:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   192d5:	8b 45 0c             	mov    0xc(%ebp),%eax
   192d8:	01 d0                	add    %edx,%eax
   192da:	8b 00                	mov    (%eax),%eax
   192dc:	85 c0                	test   %eax,%eax
   192de:	74 13                	je     192f3 <progR+0xe9>
   192e0:	8b 45 08             	mov    0x8(%ebp),%eax
   192e3:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   192ea:	8b 45 0c             	mov    0xc(%ebp),%eax
   192ed:	01 d0                	add    %edx,%eax
   192ef:	8b 00                	mov    (%eax),%eax
   192f1:	eb 05                	jmp    192f8 <progR+0xee>
   192f3:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   192f8:	83 ec 04             	sub    $0x4,%esp
   192fb:	50                   	push   %eax
   192fc:	68 6c bd 01 00       	push   $0x1bd6c
   19301:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   19307:	50                   	push   %eax
   19308:	e8 68 09 00 00       	call   19c75 <usprint>
   1930d:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   19310:	83 ec 0c             	sub    $0xc,%esp
   19313:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   19319:	50                   	push   %eax
   1931a:	e8 43 10 00 00       	call   1a362 <cwrites>
   1931f:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   19322:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   19326:	8b 45 e8             	mov    -0x18(%ebp),%eax
   19329:	3b 45 08             	cmp    0x8(%ebp),%eax
   1932c:	7e 9d                	jle    192cb <progR+0xc1>
			}
			cwrites( "\n" );
   1932e:	83 ec 0c             	sub    $0xc,%esp
   19331:	68 70 bd 01 00       	push   $0x1bd70
   19336:	e8 27 10 00 00       	call   1a362 <cwrites>
   1933b:	83 c4 10             	add    $0x10,%esp
	int32_t ppid;
 ...
 restart:
	...
	// announce our presence
	pid = getpid();
   1933e:	e8 b8 db ff ff       	call   16efb <getpid>
   19343:	89 45 e0             	mov    %eax,-0x20(%ebp)
	ppid = getppid();
   19346:	e8 b8 db ff ff       	call   16f03 <getppid>
   1934b:	89 45 dc             	mov    %eax,-0x24(%ebp)

	usprint( buf, " %c[%d,%d,%d]", ch, seq, pid, ppid );
   1934e:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
   19352:	83 ec 08             	sub    $0x8,%esp
   19355:	ff 75 dc             	pushl  -0x24(%ebp)
   19358:	ff 75 e0             	pushl  -0x20(%ebp)
   1935b:	ff 75 ec             	pushl  -0x14(%ebp)
   1935e:	50                   	push   %eax
   1935f:	68 cb be 01 00       	push   $0x1becb
   19364:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   1936a:	50                   	push   %eax
   1936b:	e8 05 09 00 00       	call   19c75 <usprint>
   19370:	83 c4 20             	add    $0x20,%esp
	swrites( buf );
   19373:	83 ec 0c             	sub    $0xc,%esp
   19376:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   1937c:	50                   	push   %eax
   1937d:	e8 46 10 00 00       	call   1a3c8 <swrites>
   19382:	83 c4 10             	add    $0x10,%esp

	sleep( SEC_TO_MS(delay) );
   19385:	8b 45 f0             	mov    -0x10(%ebp),%eax
   19388:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   1938e:	83 ec 0c             	sub    $0xc,%esp
   19391:	50                   	push   %eax
   19392:	e8 94 db ff ff       	call   16f2b <sleep>
   19397:	83 c4 10             	add    $0x10,%esp

	// create the next child in sequence
	if( seq < 5 ) {
   1939a:	83 7d ec 04          	cmpl   $0x4,-0x14(%ebp)
   1939e:	7f 63                	jg     19403 <progR+0x1f9>
		++seq;
   193a0:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
		int32_t n = fork();
   193a4:	e8 32 db ff ff       	call   16edb <fork>
   193a9:	89 45 d8             	mov    %eax,-0x28(%ebp)
		switch( n ) {
   193ac:	8b 45 d8             	mov    -0x28(%ebp),%eax
   193af:	83 f8 ff             	cmp    $0xffffffff,%eax
   193b2:	74 06                	je     193ba <progR+0x1b0>
   193b4:	85 c0                	test   %eax,%eax
   193b6:	74 86                	je     1933e <progR+0x134>
   193b8:	eb 2e                	jmp    193e8 <progR+0x1de>
		case -1:
			// failure?
			usprint( buf, "** R[%d] fork code %d\n", pid, n );
   193ba:	ff 75 d8             	pushl  -0x28(%ebp)
   193bd:	ff 75 e0             	pushl  -0x20(%ebp)
   193c0:	68 d9 be 01 00       	push   $0x1bed9
   193c5:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   193cb:	50                   	push   %eax
   193cc:	e8 a4 08 00 00       	call   19c75 <usprint>
   193d1:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   193d4:	83 ec 0c             	sub    $0xc,%esp
   193d7:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   193dd:	50                   	push   %eax
   193de:	e8 7f 0f 00 00       	call   1a362 <cwrites>
   193e3:	83 c4 10             	add    $0x10,%esp
			break;
   193e6:	eb 1c                	jmp    19404 <progR+0x1fa>
		case 0:
			// child
			goto restart;
		default:
			// parent
			--seq;
   193e8:	83 6d ec 01          	subl   $0x1,-0x14(%ebp)
			sleep( SEC_TO_MS(delay) );
   193ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
   193ef:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   193f5:	83 ec 0c             	sub    $0xc,%esp
   193f8:	50                   	push   %eax
   193f9:	e8 2d db ff ff       	call   16f2b <sleep>
   193fe:	83 c4 10             	add    $0x10,%esp
   19401:	eb 01                	jmp    19404 <progR+0x1fa>
		}
	}
   19403:	90                   	nop
	...
	pid = getpid();
   19404:	e8 f2 da ff ff       	call   16efb <getpid>
   19409:	89 45 e0             	mov    %eax,-0x20(%ebp)
	ppid = getppid();
   1940c:	e8 f2 da ff ff       	call   16f03 <getppid>
   19411:	89 45 dc             	mov    %eax,-0x24(%ebp)
	usprint( buf, " %c[%d,%d,%d]", ch, seq, pid, ppid );
   19414:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
   19418:	83 ec 08             	sub    $0x8,%esp
   1941b:	ff 75 dc             	pushl  -0x24(%ebp)
   1941e:	ff 75 e0             	pushl  -0x20(%ebp)
   19421:	ff 75 ec             	pushl  -0x14(%ebp)
   19424:	50                   	push   %eax
   19425:	68 cb be 01 00       	push   $0x1becb
   1942a:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   19430:	50                   	push   %eax
   19431:	e8 3f 08 00 00       	call   19c75 <usprint>
   19436:	83 c4 20             	add    $0x20,%esp
	swrites( buf );
   19439:	83 ec 0c             	sub    $0xc,%esp
   1943c:	8d 85 58 ff ff ff    	lea    -0xa8(%ebp),%eax
   19442:	50                   	push   %eax
   19443:	e8 80 0f 00 00       	call   1a3c8 <swrites>
   19448:	83 c4 10             	add    $0x10,%esp

	exit( 0 );
   1944b:	83 ec 0c             	sub    $0xc,%esp
   1944e:	6a 00                	push   $0x0
   19450:	e8 76 da ff ff       	call   16ecb <exit>
   19455:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   19458:	b8 2a 00 00 00       	mov    $0x2a,%eax
...
USERMAIN( progS ) {
   1945f:	55                   	push   %ebp
   19460:	89 e5                	mov    %esp,%ebp
   19462:	81 ec 98 00 00 00    	sub    $0x98,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   19468:	8b 45 0c             	mov    0xc(%ebp),%eax
   1946b:	8b 00                	mov    (%eax),%eax
   1946d:	85 c0                	test   %eax,%eax
   1946f:	74 07                	je     19478 <progS+0x19>
   19471:	8b 45 0c             	mov    0xc(%ebp),%eax
   19474:	8b 00                	mov    (%eax),%eax
   19476:	eb 05                	jmp    1947d <progS+0x1e>
   19478:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   1947d:	89 45 ec             	mov    %eax,-0x14(%ebp)
	char ch = 's';	  // default character to print
   19480:	c6 45 eb 73          	movb   $0x73,-0x15(%ebp)
	int nap = 20;	  // nap time
   19484:	c7 45 f4 14 00 00 00 	movl   $0x14,-0xc(%ebp)
	char buf[128];

	// process the command-line arguments
	switch( argc ) {
   1948b:	8b 45 08             	mov    0x8(%ebp),%eax
   1948e:	83 f8 02             	cmp    $0x2,%eax
   19491:	74 1e                	je     194b1 <progS+0x52>
   19493:	83 f8 03             	cmp    $0x3,%eax
   19496:	75 2c                	jne    194c4 <progS+0x65>
	case 3:	nap = ustr2int( argv[2], 10 );
   19498:	8b 45 0c             	mov    0xc(%ebp),%eax
   1949b:	83 c0 08             	add    $0x8,%eax
   1949e:	8b 00                	mov    (%eax),%eax
   194a0:	83 ec 08             	sub    $0x8,%esp
   194a3:	6a 0a                	push   $0xa
   194a5:	50                   	push   %eax
   194a6:	e8 3f 0a 00 00       	call   19eea <ustr2int>
   194ab:	83 c4 10             	add    $0x10,%esp
   194ae:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   194b1:	8b 45 0c             	mov    0xc(%ebp),%eax
   194b4:	83 c0 04             	add    $0x4,%eax
   194b7:	8b 00                	mov    (%eax),%eax
   194b9:	0f b6 00             	movzbl (%eax),%eax
   194bc:	88 45 eb             	mov    %al,-0x15(%ebp)
			break;
   194bf:	e9 a8 00 00 00       	jmp    1956c <progS+0x10d>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   194c4:	ff 75 08             	pushl  0x8(%ebp)
   194c7:	ff 75 ec             	pushl  -0x14(%ebp)
   194ca:	68 51 bd 01 00       	push   $0x1bd51
   194cf:	8d 85 6b ff ff ff    	lea    -0x95(%ebp),%eax
   194d5:	50                   	push   %eax
   194d6:	e8 9a 07 00 00       	call   19c75 <usprint>
   194db:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   194de:	83 ec 0c             	sub    $0xc,%esp
   194e1:	8d 85 6b ff ff ff    	lea    -0x95(%ebp),%eax
   194e7:	50                   	push   %eax
   194e8:	e8 75 0e 00 00       	call   1a362 <cwrites>
   194ed:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   194f0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
   194f7:	eb 5b                	jmp    19554 <progS+0xf5>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   194f9:	8b 45 08             	mov    0x8(%ebp),%eax
   194fc:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   19503:	8b 45 0c             	mov    0xc(%ebp),%eax
   19506:	01 d0                	add    %edx,%eax
   19508:	8b 00                	mov    (%eax),%eax
   1950a:	85 c0                	test   %eax,%eax
   1950c:	74 13                	je     19521 <progS+0xc2>
   1950e:	8b 45 08             	mov    0x8(%ebp),%eax
   19511:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   19518:	8b 45 0c             	mov    0xc(%ebp),%eax
   1951b:	01 d0                	add    %edx,%eax
   1951d:	8b 00                	mov    (%eax),%eax
   1951f:	eb 05                	jmp    19526 <progS+0xc7>
   19521:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   19526:	83 ec 04             	sub    $0x4,%esp
   19529:	50                   	push   %eax
   1952a:	68 6c bd 01 00       	push   $0x1bd6c
   1952f:	8d 85 6b ff ff ff    	lea    -0x95(%ebp),%eax
   19535:	50                   	push   %eax
   19536:	e8 3a 07 00 00       	call   19c75 <usprint>
   1953b:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   1953e:	83 ec 0c             	sub    $0xc,%esp
   19541:	8d 85 6b ff ff ff    	lea    -0x95(%ebp),%eax
   19547:	50                   	push   %eax
   19548:	e8 15 0e 00 00       	call   1a362 <cwrites>
   1954d:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   19550:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
   19554:	8b 45 f0             	mov    -0x10(%ebp),%eax
   19557:	3b 45 08             	cmp    0x8(%ebp),%eax
   1955a:	7e 9d                	jle    194f9 <progS+0x9a>
			}
			cwrites( "\n" );
   1955c:	83 ec 0c             	sub    $0xc,%esp
   1955f:	68 70 bd 01 00       	push   $0x1bd70
   19564:	e8 f9 0d 00 00       	call   1a362 <cwrites>
   19569:	83 c4 10             	add    $0x10,%esp
	}

	// announce our presence
	write( CHAN_SIO, &ch, 1 );
   1956c:	83 ec 04             	sub    $0x4,%esp
   1956f:	6a 01                	push   $0x1
   19571:	8d 45 eb             	lea    -0x15(%ebp),%eax
   19574:	50                   	push   %eax
   19575:	6a 01                	push   $0x1
   19577:	e8 77 d9 ff ff       	call   16ef3 <write>
   1957c:	83 c4 10             	add    $0x10,%esp

	usprint( buf, "%s sleeping %d(%d)\n", name, nap, SEC_TO_MS(nap) );
   1957f:	8b 45 f4             	mov    -0xc(%ebp),%eax
   19582:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   19588:	83 ec 0c             	sub    $0xc,%esp
   1958b:	50                   	push   %eax
   1958c:	ff 75 f4             	pushl  -0xc(%ebp)
   1958f:	ff 75 ec             	pushl  -0x14(%ebp)
   19592:	68 f0 be 01 00       	push   $0x1bef0
   19597:	8d 85 6b ff ff ff    	lea    -0x95(%ebp),%eax
   1959d:	50                   	push   %eax
   1959e:	e8 d2 06 00 00       	call   19c75 <usprint>
   195a3:	83 c4 20             	add    $0x20,%esp
	cwrites( buf );
   195a6:	83 ec 0c             	sub    $0xc,%esp
   195a9:	8d 85 6b ff ff ff    	lea    -0x95(%ebp),%eax
   195af:	50                   	push   %eax
   195b0:	e8 ad 0d 00 00       	call   1a362 <cwrites>
   195b5:	83 c4 10             	add    $0x10,%esp

	for(;;) {
		sleep( SEC_TO_MS(nap) );
   195b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
   195bb:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   195c1:	83 ec 0c             	sub    $0xc,%esp
   195c4:	50                   	push   %eax
   195c5:	e8 61 d9 ff ff       	call   16f2b <sleep>
   195ca:	83 c4 10             	add    $0x10,%esp
		write( CHAN_SIO, &ch, 1 );
   195cd:	83 ec 04             	sub    $0x4,%esp
   195d0:	6a 01                	push   $0x1
   195d2:	8d 45 eb             	lea    -0x15(%ebp),%eax
   195d5:	50                   	push   %eax
   195d6:	6a 01                	push   $0x1
   195d8:	e8 16 d9 ff ff       	call   16ef3 <write>
   195dd:	83 c4 10             	add    $0x10,%esp
		sleep( SEC_TO_MS(nap) );
   195e0:	eb d6                	jmp    195b8 <progS+0x159>
...
USERMAIN( progTUV ) {
   195e2:	55                   	push   %ebp
   195e3:	89 e5                	mov    %esp,%ebp
   195e5:	81 ec a8 01 00 00    	sub    $0x1a8,%esp
	char *name = argv[0] ? argv[0] : "nobody";
   195eb:	8b 45 0c             	mov    0xc(%ebp),%eax
   195ee:	8b 00                	mov    (%eax),%eax
   195f0:	85 c0                	test   %eax,%eax
   195f2:	74 07                	je     195fb <progTUV+0x19>
   195f4:	8b 45 0c             	mov    0xc(%ebp),%eax
   195f7:	8b 00                	mov    (%eax),%eax
   195f9:	eb 05                	jmp    19600 <progTUV+0x1e>
   195fb:	b8 68 ba 01 00       	mov    $0x1ba68,%eax
   19600:	89 45 d0             	mov    %eax,-0x30(%ebp)
	int count = 3;			// default child count
   19603:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
	char ch = '6';			// default character to print
   1960a:	c6 45 c7 36          	movb   $0x36,-0x39(%ebp)
	int nap = 8;			// nap time
   1960e:	c7 45 cc 08 00 00 00 	movl   $0x8,-0x34(%ebp)
	bool_t waiting = true;	// default is waiting by PID
   19615:	c6 45 f3 01          	movb   $0x1,-0xd(%ebp)
	bool_t bypid = true;
   19619:	c6 45 f2 01          	movb   $0x1,-0xe(%ebp)
	char buf[128];
	uint_t children[MAX_CHILDREN];
	int nkids = 0;
   1961d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
	char ch2[] = "*?*";
   19624:	c7 85 78 fe ff ff 2a 	movl   $0x2a3f2a,-0x188(%ebp)
   1962b:	3f 2a 00 

	// process the command-line arguments
	switch( argc ) {
   1962e:	8b 45 08             	mov    0x8(%ebp),%eax
   19631:	83 f8 03             	cmp    $0x3,%eax
   19634:	74 32                	je     19668 <progTUV+0x86>
   19636:	83 f8 04             	cmp    $0x4,%eax
   19639:	74 07                	je     19642 <progTUV+0x60>
   1963b:	83 f8 02             	cmp    $0x2,%eax
   1963e:	74 41                	je     19681 <progTUV+0x9f>
   19640:	eb 52                	jmp    19694 <progTUV+0xb2>
	case 4:	waiting = argv[3][0] != 'k';	// 'w'/'W' -> wait, else -> kill
   19642:	8b 45 0c             	mov    0xc(%ebp),%eax
   19645:	83 c0 0c             	add    $0xc,%eax
   19648:	8b 00                	mov    (%eax),%eax
   1964a:	0f b6 00             	movzbl (%eax),%eax
   1964d:	3c 6b                	cmp    $0x6b,%al
   1964f:	0f 95 c0             	setne  %al
   19652:	88 45 f3             	mov    %al,-0xd(%ebp)
			bypid   = argv[3][0] != 'w';	// 'W'/'k' -> by PID
   19655:	8b 45 0c             	mov    0xc(%ebp),%eax
   19658:	83 c0 0c             	add    $0xc,%eax
   1965b:	8b 00                	mov    (%eax),%eax
   1965d:	0f b6 00             	movzbl (%eax),%eax
   19660:	3c 77                	cmp    $0x77,%al
   19662:	0f 95 c0             	setne  %al
   19665:	88 45 f2             	mov    %al,-0xe(%ebp)
			// FALL THROUGH
	case 3:	count = ustr2int( argv[2], 10 );
   19668:	8b 45 0c             	mov    0xc(%ebp),%eax
   1966b:	83 c0 08             	add    $0x8,%eax
   1966e:	8b 00                	mov    (%eax),%eax
   19670:	83 ec 08             	sub    $0x8,%esp
   19673:	6a 0a                	push   $0xa
   19675:	50                   	push   %eax
   19676:	e8 6f 08 00 00       	call   19eea <ustr2int>
   1967b:	83 c4 10             	add    $0x10,%esp
   1967e:	89 45 f4             	mov    %eax,-0xc(%ebp)
			// FALL THROUGH
	case 2:	ch = argv[1][0];
   19681:	8b 45 0c             	mov    0xc(%ebp),%eax
   19684:	83 c0 04             	add    $0x4,%eax
   19687:	8b 00                	mov    (%eax),%eax
   19689:	0f b6 00             	movzbl (%eax),%eax
   1968c:	88 45 c7             	mov    %al,-0x39(%ebp)
			break;
   1968f:	e9 a8 00 00 00       	jmp    1973c <progTUV+0x15a>
	default:
			usprint( buf, "%s: argc %d, args: ", name, argc );
   19694:	ff 75 08             	pushl  0x8(%ebp)
   19697:	ff 75 d0             	pushl  -0x30(%ebp)
   1969a:	68 51 bd 01 00       	push   $0x1bd51
   1969f:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   196a5:	50                   	push   %eax
   196a6:	e8 ca 05 00 00       	call   19c75 <usprint>
   196ab:	83 c4 10             	add    $0x10,%esp
			cwrites( buf );
   196ae:	83 ec 0c             	sub    $0xc,%esp
   196b1:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   196b7:	50                   	push   %eax
   196b8:	e8 a5 0c 00 00       	call   1a362 <cwrites>
   196bd:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   196c0:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
   196c7:	eb 5b                	jmp    19724 <progTUV+0x142>
				usprint( buf, " %s", argv[argc] ? argv[argc] : "(null)" );
   196c9:	8b 45 08             	mov    0x8(%ebp),%eax
   196cc:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   196d3:	8b 45 0c             	mov    0xc(%ebp),%eax
   196d6:	01 d0                	add    %edx,%eax
   196d8:	8b 00                	mov    (%eax),%eax
   196da:	85 c0                	test   %eax,%eax
   196dc:	74 13                	je     196f1 <progTUV+0x10f>
   196de:	8b 45 08             	mov    0x8(%ebp),%eax
   196e1:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   196e8:	8b 45 0c             	mov    0xc(%ebp),%eax
   196eb:	01 d0                	add    %edx,%eax
   196ed:	8b 00                	mov    (%eax),%eax
   196ef:	eb 05                	jmp    196f6 <progTUV+0x114>
   196f1:	b8 65 bd 01 00       	mov    $0x1bd65,%eax
   196f6:	83 ec 04             	sub    $0x4,%esp
   196f9:	50                   	push   %eax
   196fa:	68 6c bd 01 00       	push   $0x1bd6c
   196ff:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   19705:	50                   	push   %eax
   19706:	e8 6a 05 00 00       	call   19c75 <usprint>
   1970b:	83 c4 10             	add    $0x10,%esp
				cwrites( buf );
   1970e:	83 ec 0c             	sub    $0xc,%esp
   19711:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   19717:	50                   	push   %eax
   19718:	e8 45 0c 00 00       	call   1a362 <cwrites>
   1971d:	83 c4 10             	add    $0x10,%esp
			for( int i = 0; i <= argc; ++i ) {
   19720:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
   19724:	8b 45 e8             	mov    -0x18(%ebp),%eax
   19727:	3b 45 08             	cmp    0x8(%ebp),%eax
   1972a:	7e 9d                	jle    196c9 <progTUV+0xe7>
			}
			cwrites( "\n" );
   1972c:	83 ec 0c             	sub    $0xc,%esp
   1972f:	68 70 bd 01 00       	push   $0x1bd70
   19734:	e8 29 0c 00 00       	call   1a362 <cwrites>
   19739:	83 c4 10             	add    $0x10,%esp
	}

	// fix the secondary output message (for indicating errors)
	ch2[1] = ch;
   1973c:	0f b6 45 c7          	movzbl -0x39(%ebp),%eax
   19740:	88 85 79 fe ff ff    	mov    %al,-0x187(%ebp)

	// announce our presence
	write( CHAN_SIO, &ch, 1 );
   19746:	83 ec 04             	sub    $0x4,%esp
   19749:	6a 01                	push   $0x1
   1974b:	8d 45 c7             	lea    -0x39(%ebp),%eax
   1974e:	50                   	push   %eax
   1974f:	6a 01                	push   $0x1
   19751:	e8 9d d7 ff ff       	call   16ef3 <write>
   19756:	83 c4 10             	add    $0x10,%esp

	// set up the argument vector
	char *argsw[] = { "progW", "W", "10", "5", NULL };
   19759:	c7 85 64 fe ff ff 32 	movl   $0x1be32,-0x19c(%ebp)
   19760:	be 01 00 
   19763:	c7 85 68 fe ff ff 46 	movl   $0x1bb46,-0x198(%ebp)
   1976a:	bb 01 00 
   1976d:	c7 85 6c fe ff ff c4 	movl   $0x1bac4,-0x194(%ebp)
   19774:	ba 01 00 
   19777:	c7 85 70 fe ff ff f3 	movl   $0x1baf3,-0x190(%ebp)
   1977e:	ba 01 00 
   19781:	c7 85 74 fe ff ff 00 	movl   $0x0,-0x18c(%ebp)
   19788:	00 00 00 

	for( int i = 0; i < count; ++i ) {
   1978b:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
   19792:	eb 4c                	jmp    197e0 <progTUV+0x1fe>
		int whom = spawn( (uint32_t) progW, argsw );
   19794:	ba b7 83 01 00       	mov    $0x183b7,%edx
   19799:	83 ec 08             	sub    $0x8,%esp
   1979c:	8d 85 64 fe ff ff    	lea    -0x19c(%ebp),%eax
   197a2:	50                   	push   %eax
   197a3:	52                   	push   %edx
   197a4:	e8 23 0b 00 00       	call   1a2cc <spawn>
   197a9:	83 c4 10             	add    $0x10,%esp
   197ac:	89 45 c8             	mov    %eax,-0x38(%ebp)
		if( whom < 0 ) {
   197af:	83 7d c8 00          	cmpl   $0x0,-0x38(%ebp)
   197b3:	79 14                	jns    197c9 <progTUV+0x1e7>
			swrites( ch2 );
   197b5:	83 ec 0c             	sub    $0xc,%esp
   197b8:	8d 85 78 fe ff ff    	lea    -0x188(%ebp),%eax
   197be:	50                   	push   %eax
   197bf:	e8 04 0c 00 00       	call   1a3c8 <swrites>
   197c4:	83 c4 10             	add    $0x10,%esp
   197c7:	eb 13                	jmp    197dc <progTUV+0x1fa>
		} else {
			children[nkids++] = whom;
   197c9:	8b 45 ec             	mov    -0x14(%ebp),%eax
   197cc:	8d 50 01             	lea    0x1(%eax),%edx
   197cf:	89 55 ec             	mov    %edx,-0x14(%ebp)
   197d2:	8b 55 c8             	mov    -0x38(%ebp),%edx
   197d5:	89 94 85 7c fe ff ff 	mov    %edx,-0x184(%ebp,%eax,4)
	for( int i = 0; i < count; ++i ) {
   197dc:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
   197e0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
   197e3:	3b 45 f4             	cmp    -0xc(%ebp),%eax
   197e6:	7c ac                	jl     19794 <progTUV+0x1b2>
		}
	}

	// let the children start
	sleep( SEC_TO_MS(nap) );
   197e8:	8b 45 cc             	mov    -0x34(%ebp),%eax
   197eb:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
   197f1:	83 ec 0c             	sub    $0xc,%esp
   197f4:	50                   	push   %eax
   197f5:	e8 31 d7 ff ff       	call   16f2b <sleep>
   197fa:	83 c4 10             	add    $0x10,%esp

	// collect exit status information

	// current child index
	int n = 0;
   197fd:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
	do {
		int this;
		int32_t status;
		...
		if( waiting ) {
   19804:	80 7d f3 00          	cmpb   $0x0,-0xd(%ebp)
   19808:	74 2f                	je     19839 <progTUV+0x257>
			this = waitpid( bypid ? children[n] : 0, &status );
   1980a:	80 7d f2 00          	cmpb   $0x0,-0xe(%ebp)
   1980e:	74 0c                	je     1981c <progTUV+0x23a>
   19810:	8b 45 e0             	mov    -0x20(%ebp),%eax
   19813:	8b 84 85 7c fe ff ff 	mov    -0x184(%ebp,%eax,4),%eax
   1981a:	eb 05                	jmp    19821 <progTUV+0x23f>
   1981c:	b8 00 00 00 00       	mov    $0x0,%eax
   19821:	83 ec 08             	sub    $0x8,%esp
   19824:	8d 95 60 fe ff ff    	lea    -0x1a0(%ebp),%edx
   1982a:	52                   	push   %edx
   1982b:	50                   	push   %eax
   1982c:	e8 a2 d6 ff ff       	call   16ed3 <waitpid>
   19831:	83 c4 10             	add    $0x10,%esp
   19834:	89 45 dc             	mov    %eax,-0x24(%ebp)
   19837:	eb 19                	jmp    19852 <progTUV+0x270>
		} else {
			// always by PID
			this = kill( children[n] );
   19839:	8b 45 e0             	mov    -0x20(%ebp),%eax
   1983c:	8b 84 85 7c fe ff ff 	mov    -0x184(%ebp,%eax,4),%eax
   19843:	83 ec 0c             	sub    $0xc,%esp
   19846:	50                   	push   %eax
   19847:	e8 d7 d6 ff ff       	call   16f23 <kill>
   1984c:	83 c4 10             	add    $0x10,%esp
   1984f:	89 45 dc             	mov    %eax,-0x24(%ebp)
		}

		// what was the result?
		if( this < SUCCESS ) {
   19852:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
   19856:	0f 89 a1 00 00 00    	jns    198fd <progTUV+0x31b>

			// uh-oh - something went wrong

			// "no children" means we're all done
			if( this != E_NO_CHILDREN ) {
   1985c:	83 7d dc fc          	cmpl   $0xfffffffc,-0x24(%ebp)
   19860:	74 77                	je     198d9 <progTUV+0x2f7>
				if( waiting ) {
   19862:	80 7d f3 00          	cmpb   $0x0,-0xd(%ebp)
   19866:	74 3f                	je     198a7 <progTUV+0x2c5>
					usprint( buf, "!! %c: waitpid(%d) status %d\n",
   19868:	80 7d f2 00          	cmpb   $0x0,-0xe(%ebp)
   1986c:	74 0c                	je     1987a <progTUV+0x298>
   1986e:	8b 45 e0             	mov    -0x20(%ebp),%eax
   19871:	8b 84 85 7c fe ff ff 	mov    -0x184(%ebp,%eax,4),%eax
   19878:	eb 05                	jmp    1987f <progTUV+0x29d>
   1987a:	b8 00 00 00 00       	mov    $0x0,%eax
   1987f:	0f b6 55 c7          	movzbl -0x39(%ebp),%edx
   19883:	0f be d2             	movsbl %dl,%edx
   19886:	83 ec 0c             	sub    $0xc,%esp
   19889:	ff 75 dc             	pushl  -0x24(%ebp)
   1988c:	50                   	push   %eax
   1988d:	52                   	push   %edx
   1988e:	68 04 bf 01 00       	push   $0x1bf04
   19893:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   19899:	50                   	push   %eax
   1989a:	e8 d6 03 00 00       	call   19c75 <usprint>
   1989f:	83 c4 20             	add    $0x20,%esp
			} else {
			...
			break;
   198a2:	e9 9d 01 00 00       	jmp    19a44 <progTUV+0x462>
					usprint( buf, "!! %c: kill(%d) status %d\n",
   198a7:	8b 45 e0             	mov    -0x20(%ebp),%eax
   198aa:	8b 94 85 7c fe ff ff 	mov    -0x184(%ebp,%eax,4),%edx
   198b1:	0f b6 45 c7          	movzbl -0x39(%ebp),%eax
   198b5:	0f be c0             	movsbl %al,%eax
   198b8:	83 ec 0c             	sub    $0xc,%esp
   198bb:	ff 75 dc             	pushl  -0x24(%ebp)
   198be:	52                   	push   %edx
   198bf:	50                   	push   %eax
   198c0:	68 38 be 01 00       	push   $0x1be38
   198c5:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   198cb:	50                   	push   %eax
   198cc:	e8 a4 03 00 00       	call   19c75 <usprint>
   198d1:	83 c4 20             	add    $0x20,%esp
			break;
   198d4:	e9 6b 01 00 00       	jmp    19a44 <progTUV+0x462>
				usprint( buf, "!! %c: no children\n", ch );
   198d9:	0f b6 45 c7          	movzbl -0x39(%ebp),%eax
   198dd:	0f be c0             	movsbl %al,%eax
   198e0:	83 ec 04             	sub    $0x4,%esp
   198e3:	50                   	push   %eax
   198e4:	68 22 bf 01 00       	push   $0x1bf22
   198e9:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   198ef:	50                   	push   %eax
   198f0:	e8 80 03 00 00       	call   19c75 <usprint>
   198f5:	83 c4 10             	add    $0x10,%esp
   198f8:	e9 47 01 00 00       	jmp    19a44 <progTUV+0x462>

		} else {

			// locate the child
			int ix = -1;
   198fd:	c7 45 d8 ff ff ff ff 	movl   $0xffffffff,-0x28(%ebp)

			// were we looking by PID?
			if( bypid ) {
   19904:	80 7d f2 00          	cmpb   $0x0,-0xe(%ebp)
   19908:	74 58                	je     19962 <progTUV+0x380>
				// we should have just gotten the one we were looking for
				if( this != children[n] ) {
   1990a:	8b 45 e0             	mov    -0x20(%ebp),%eax
   1990d:	8b 94 85 7c fe ff ff 	mov    -0x184(%ebp,%eax,4),%edx
   19914:	8b 45 dc             	mov    -0x24(%ebp),%eax
   19917:	39 c2                	cmp    %eax,%edx
   19919:	74 41                	je     1995c <progTUV+0x37a>
					// uh-oh
					usprint( buf, "** %c: wait/kill PID %d, got %d\n",
   1991b:	8b 45 e0             	mov    -0x20(%ebp),%eax
   1991e:	8b 94 85 7c fe ff ff 	mov    -0x184(%ebp,%eax,4),%edx
   19925:	0f b6 45 c7          	movzbl -0x39(%ebp),%eax
   19929:	0f be c0             	movsbl %al,%eax
   1992c:	83 ec 0c             	sub    $0xc,%esp
   1992f:	ff 75 dc             	pushl  -0x24(%ebp)
   19932:	52                   	push   %edx
   19933:	50                   	push   %eax
   19934:	68 38 bf 01 00       	push   $0x1bf38
   19939:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   1993f:	50                   	push   %eax
   19940:	e8 30 03 00 00       	call   19c75 <usprint>
   19945:	83 c4 20             	add    $0x20,%esp
							ch, children[n], this );
					cwrites( buf );
   19948:	83 ec 0c             	sub    $0xc,%esp
   1994b:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   19951:	50                   	push   %eax
   19952:	e8 0b 0a 00 00       	call   1a362 <cwrites>
   19957:	83 c4 10             	add    $0x10,%esp
   1995a:	eb 06                	jmp    19962 <progTUV+0x380>
				} else {
					ix = n;
   1995c:	8b 45 e0             	mov    -0x20(%ebp),%eax
   1995f:	89 45 d8             	mov    %eax,-0x28(%ebp)
				}
			}

			// either not looking by PID, or the lookup failed somehow
			if( ix < 0 ) {
   19962:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
   19966:	79 2e                	jns    19996 <progTUV+0x3b4>
				int i;
				for( i = 0; i < nkids; ++i ) {
   19968:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
   1996f:	eb 1d                	jmp    1998e <progTUV+0x3ac>
					if( children[i] == this ) {
   19971:	8b 45 d4             	mov    -0x2c(%ebp),%eax
   19974:	8b 94 85 7c fe ff ff 	mov    -0x184(%ebp,%eax,4),%edx
   1997b:	8b 45 dc             	mov    -0x24(%ebp),%eax
   1997e:	39 c2                	cmp    %eax,%edx
   19980:	75 08                	jne    1998a <progTUV+0x3a8>
						ix = i;
   19982:	8b 45 d4             	mov    -0x2c(%ebp),%eax
   19985:	89 45 d8             	mov    %eax,-0x28(%ebp)
						break;
   19988:	eb 0c                	jmp    19996 <progTUV+0x3b4>
				for( i = 0; i < nkids; ++i ) {
   1998a:	83 45 d4 01          	addl   $0x1,-0x2c(%ebp)
   1998e:	8b 45 d4             	mov    -0x2c(%ebp),%eax
   19991:	3b 45 ec             	cmp    -0x14(%ebp),%eax
   19994:	7c db                	jl     19971 <progTUV+0x38f>
				}
			}
			...
			if( ix < 0 ) {
   19996:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
   1999a:	79 21                	jns    199bd <progTUV+0x3db>

				// didn't find an entry for this PID???
				usprint( buf, "!! %c: child PID %d term, NOT FOUND\n",
   1999c:	0f b6 45 c7          	movzbl -0x39(%ebp),%eax
   199a0:	0f be c0             	movsbl %al,%eax
   199a3:	ff 75 dc             	pushl  -0x24(%ebp)
   199a6:	50                   	push   %eax
   199a7:	68 5c bf 01 00       	push   $0x1bf5c
   199ac:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   199b2:	50                   	push   %eax
   199b3:	e8 bd 02 00 00       	call   19c75 <usprint>
   199b8:	83 c4 10             	add    $0x10,%esp
   199bb:	eb 65                	jmp    19a22 <progTUV+0x440>
						ch, this );
				...
				if( ix != n ) {
   199bd:	8b 45 d8             	mov    -0x28(%ebp),%eax
   199c0:	3b 45 e0             	cmp    -0x20(%ebp),%eax
   199c3:	74 31                	je     199f6 <progTUV+0x414>
					// ... but it's out of sequence
					usprint( buf, "== %c: child %d (%d,%d) status %d\n",
   199c5:	8b 95 60 fe ff ff    	mov    -0x1a0(%ebp),%edx
   199cb:	0f b6 45 c7          	movzbl -0x39(%ebp),%eax
   199cf:	0f be c0             	movsbl %al,%eax
   199d2:	83 ec 04             	sub    $0x4,%esp
   199d5:	52                   	push   %edx
   199d6:	ff 75 dc             	pushl  -0x24(%ebp)
   199d9:	ff 75 e0             	pushl  -0x20(%ebp)
   199dc:	ff 75 d8             	pushl  -0x28(%ebp)
   199df:	50                   	push   %eax
   199e0:	68 84 bf 01 00       	push   $0x1bf84
   199e5:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   199eb:	50                   	push   %eax
   199ec:	e8 84 02 00 00       	call   19c75 <usprint>
   199f1:	83 c4 20             	add    $0x20,%esp
   199f4:	eb 2c                	jmp    19a22 <progTUV+0x440>
							ch, ix, n, this, status );
				} else {
					usprint( buf, "== %c: child %d (%d) status %d\n",
   199f6:	8b 95 60 fe ff ff    	mov    -0x1a0(%ebp),%edx
   199fc:	0f b6 45 c7          	movzbl -0x39(%ebp),%eax
   19a00:	0f be c0             	movsbl %al,%eax
   19a03:	83 ec 08             	sub    $0x8,%esp
   19a06:	52                   	push   %edx
   19a07:	ff 75 dc             	pushl  -0x24(%ebp)
   19a0a:	ff 75 d8             	pushl  -0x28(%ebp)
   19a0d:	50                   	push   %eax
   19a0e:	68 a8 bf 01 00       	push   $0x1bfa8
   19a13:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   19a19:	50                   	push   %eax
   19a1a:	e8 56 02 00 00       	call   19c75 <usprint>
   19a1f:	83 c4 20             	add    $0x20,%esp
				}
			}
		...
		cwrites( buf );
   19a22:	83 ec 0c             	sub    $0xc,%esp
   19a25:	8d 85 47 ff ff ff    	lea    -0xb9(%ebp),%eax
   19a2b:	50                   	push   %eax
   19a2c:	e8 31 09 00 00       	call   1a362 <cwrites>
   19a31:	83 c4 10             	add    $0x10,%esp

		++n;
   19a34:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)

	} while( n < nkids );
   19a38:	8b 45 e0             	mov    -0x20(%ebp),%eax
   19a3b:	3b 45 ec             	cmp    -0x14(%ebp),%eax
   19a3e:	0f 8c c0 fd ff ff    	jl     19804 <progTUV+0x222>

	exit( 0 );
   19a44:	83 ec 0c             	sub    $0xc,%esp
   19a47:	6a 00                	push   $0x0
   19a49:	e8 7d d4 ff ff       	call   16ecb <exit>
   19a4e:	83 c4 10             	add    $0x10,%esp

	return( 42 );  // shut the compiler up!
   19a51:	b8 2a 00 00 00       	mov    $0x2a,%eax
}
   19a56:	c9                   	leave  
   19a57:	c3                   	ret    
...
void ublkmov( void *dst, const void *src, register uint32_t len ) {
   19a58:	55                   	push   %ebp
   19a59:	89 e5                	mov    %esp,%ebp
   19a5b:	56                   	push   %esi
   19a5c:	53                   	push   %ebx
   19a5d:	8b 45 10             	mov    0x10(%ebp),%eax

	// verify that the addresses are aligned and
	// the length is a multiple of four bytes
	if( (((uint32_t)dst)&0x3) != 0 ||
   19a60:	8b 55 08             	mov    0x8(%ebp),%edx
   19a63:	83 e2 03             	and    $0x3,%edx
   19a66:	85 d2                	test   %edx,%edx
   19a68:	75 13                	jne    19a7d <ublkmov+0x25>
		(((uint32_t)src)&0x3) != 0 ||
   19a6a:	8b 55 0c             	mov    0xc(%ebp),%edx
   19a6d:	83 e2 03             	and    $0x3,%edx
	if( (((uint32_t)dst)&0x3) != 0 ||
   19a70:	85 d2                	test   %edx,%edx
   19a72:	75 09                	jne    19a7d <ublkmov+0x25>
		(len & 0x3) != 0 ) {
   19a74:	89 c2                	mov    %eax,%edx
   19a76:	83 e2 03             	and    $0x3,%edx
		(((uint32_t)src)&0x3) != 0 ||
   19a79:	85 d2                	test   %edx,%edx
   19a7b:	74 14                	je     19a91 <ublkmov+0x39>
		// something isn't aligned, so just use memmove()
		umemmove( dst, src, len );
   19a7d:	83 ec 04             	sub    $0x4,%esp
   19a80:	50                   	push   %eax
   19a81:	ff 75 0c             	pushl  0xc(%ebp)
   19a84:	ff 75 08             	pushl  0x8(%ebp)
   19a87:	e8 b4 00 00 00       	call   19b40 <umemmove>
   19a8c:	83 c4 10             	add    $0x10,%esp
		return;
   19a8f:	eb 5a                	jmp    19aeb <ublkmov+0x93>
	}

	// everything is nicely aligned, so off we go
	register uint32_t *dest = dst;
   19a91:	8b 5d 08             	mov    0x8(%ebp),%ebx
	register const uint32_t *source = src;
   19a94:	8b 75 0c             	mov    0xc(%ebp),%esi

	// now copying 32-bit values
	len /= 4;
   19a97:	c1 e8 02             	shr    $0x2,%eax

	if( source < dest && (source + len) > dest ) {
   19a9a:	39 de                	cmp    %ebx,%esi
   19a9c:	73 44                	jae    19ae2 <ublkmov+0x8a>
   19a9e:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   19aa5:	01 f2                	add    %esi,%edx
   19aa7:	39 d3                	cmp    %edx,%ebx
   19aa9:	73 37                	jae    19ae2 <ublkmov+0x8a>
		source += len;
   19aab:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   19ab2:	01 d6                	add    %edx,%esi
		dest += len;
   19ab4:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
   19abb:	01 d3                	add    %edx,%ebx
		while( len-- > 0 ) {
   19abd:	eb 0a                	jmp    19ac9 <ublkmov+0x71>
			*--dest = *--source;
   19abf:	83 ee 04             	sub    $0x4,%esi
   19ac2:	83 eb 04             	sub    $0x4,%ebx
   19ac5:	8b 16                	mov    (%esi),%edx
   19ac7:	89 13                	mov    %edx,(%ebx)
		while( len-- > 0 ) {
   19ac9:	89 c2                	mov    %eax,%edx
   19acb:	8d 42 ff             	lea    -0x1(%edx),%eax
   19ace:	85 d2                	test   %edx,%edx
   19ad0:	75 ed                	jne    19abf <ublkmov+0x67>
	if( source < dest && (source + len) > dest ) {
   19ad2:	eb 17                	jmp    19aeb <ublkmov+0x93>
		}
	} else {
		while( len-- ) {
			*dest++ = *source++;
   19ad4:	89 f1                	mov    %esi,%ecx
   19ad6:	8d 71 04             	lea    0x4(%ecx),%esi
   19ad9:	89 da                	mov    %ebx,%edx
   19adb:	8d 5a 04             	lea    0x4(%edx),%ebx
   19ade:	8b 09                	mov    (%ecx),%ecx
   19ae0:	89 0a                	mov    %ecx,(%edx)
		while( len-- ) {
   19ae2:	89 c2                	mov    %eax,%edx
   19ae4:	8d 42 ff             	lea    -0x1(%edx),%eax
   19ae7:	85 d2                	test   %edx,%edx
   19ae9:	75 e9                	jne    19ad4 <ublkmov+0x7c>
		}
	}
}
   19aeb:	8d 65 f8             	lea    -0x8(%ebp),%esp
   19aee:	5b                   	pop    %ebx
   19aef:	5e                   	pop    %esi
   19af0:	5d                   	pop    %ebp
   19af1:	c3                   	ret    
...
void umemclr( void *buf, register uint32_t len ) {
   19af2:	55                   	push   %ebp
   19af3:	89 e5                	mov    %esp,%ebp
   19af5:	53                   	push   %ebx
   19af6:	8b 55 0c             	mov    0xc(%ebp),%edx
	register uint8_t *dest = buf;
   19af9:	8b 5d 08             	mov    0x8(%ebp),%ebx
	/*
	** We could speed this up by unrolling it and clearing
	** words at a time (instead of bytes).
	*/
	...
	while( len-- ) {
   19afc:	eb 08                	jmp    19b06 <umemclr+0x14>
			*dest++ = 0;
   19afe:	89 d8                	mov    %ebx,%eax
   19b00:	8d 58 01             	lea    0x1(%eax),%ebx
   19b03:	c6 00 00             	movb   $0x0,(%eax)
	while( len-- ) {
   19b06:	89 d0                	mov    %edx,%eax
   19b08:	8d 50 ff             	lea    -0x1(%eax),%edx
   19b0b:	85 c0                	test   %eax,%eax
   19b0d:	75 ef                	jne    19afe <umemclr+0xc>
	}
}
   19b0f:	90                   	nop
   19b10:	5b                   	pop    %ebx
...
void umemcpy( void *dst, register const void *src, register uint32_t len ) {
   19b13:	55                   	push   %ebp
   19b14:	89 e5                	mov    %esp,%ebp
   19b16:	56                   	push   %esi
   19b17:	53                   	push   %ebx
   19b18:	8b 4d 10             	mov    0x10(%ebp),%ecx
	register uint8_t *dest = dst;
   19b1b:	8b 5d 08             	mov    0x8(%ebp),%ebx
	register const uint8_t *source = src;
   19b1e:	8b 75 0c             	mov    0xc(%ebp),%esi
	/*
	** We could speed this up by unrolling it and copying
	** words at a time (instead of bytes).
	*/
	...
	while( len-- ) {
   19b21:	eb 0f                	jmp    19b32 <umemcpy+0x1f>
		*dest++ = *source++;
   19b23:	89 f2                	mov    %esi,%edx
   19b25:	8d 72 01             	lea    0x1(%edx),%esi
   19b28:	89 d8                	mov    %ebx,%eax
   19b2a:	8d 58 01             	lea    0x1(%eax),%ebx
   19b2d:	0f b6 12             	movzbl (%edx),%edx
   19b30:	88 10                	mov    %dl,(%eax)
	while( len-- ) {
   19b32:	89 c8                	mov    %ecx,%eax
   19b34:	8d 48 ff             	lea    -0x1(%eax),%ecx
   19b37:	85 c0                	test   %eax,%eax
   19b39:	75 e8                	jne    19b23 <umemcpy+0x10>
	}
}
   19b3b:	90                   	nop
   19b3c:	5b                   	pop    %ebx
...
void umemmove( void *dst, const void *src, register uint32_t len ) {
   19b40:	55                   	push   %ebp
   19b41:	89 e5                	mov    %esp,%ebp
   19b43:	56                   	push   %esi
   19b44:	53                   	push   %ebx
   19b45:	8b 45 10             	mov    0x10(%ebp),%eax
	register uint8_t *dest = dst;
   19b48:	8b 75 08             	mov    0x8(%ebp),%esi
	register const uint8_t *source = src;
   19b4b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	/*
	** We could speed this up by unrolling it and copying
	** words at a time (instead of bytes).
	*/
	...
	if( source < dest && (source + len) > dest ) {
   19b4e:	39 f3                	cmp    %esi,%ebx
   19b50:	73 32                	jae    19b84 <umemmove+0x44>
   19b52:	8d 14 03             	lea    (%ebx,%eax,1),%edx
   19b55:	39 d6                	cmp    %edx,%esi
   19b57:	73 2b                	jae    19b84 <umemmove+0x44>
		source += len;
   19b59:	01 c3                	add    %eax,%ebx
		dest += len;
   19b5b:	01 c6                	add    %eax,%esi
		while( len-- > 0 ) {
   19b5d:	eb 0b                	jmp    19b6a <umemmove+0x2a>
			*--dest = *--source;
   19b5f:	83 eb 01             	sub    $0x1,%ebx
   19b62:	83 ee 01             	sub    $0x1,%esi
   19b65:	0f b6 13             	movzbl (%ebx),%edx
   19b68:	88 16                	mov    %dl,(%esi)
		while( len-- > 0 ) {
   19b6a:	89 c2                	mov    %eax,%edx
   19b6c:	8d 42 ff             	lea    -0x1(%edx),%eax
   19b6f:	85 d2                	test   %edx,%edx
   19b71:	75 ec                	jne    19b5f <umemmove+0x1f>
	if( source < dest && (source + len) > dest ) {
   19b73:	eb 18                	jmp    19b8d <umemmove+0x4d>
		}
	} else {
		while( len-- ) {
			*dest++ = *source++;
   19b75:	89 d9                	mov    %ebx,%ecx
   19b77:	8d 59 01             	lea    0x1(%ecx),%ebx
   19b7a:	89 f2                	mov    %esi,%edx
   19b7c:	8d 72 01             	lea    0x1(%edx),%esi
   19b7f:	0f b6 09             	movzbl (%ecx),%ecx
   19b82:	88 0a                	mov    %cl,(%edx)
		while( len-- ) {
   19b84:	89 c2                	mov    %eax,%edx
   19b86:	8d 42 ff             	lea    -0x1(%edx),%eax
   19b89:	85 d2                	test   %edx,%edx
   19b8b:	75 e8                	jne    19b75 <umemmove+0x35>
		}
	}
}
   19b8d:	90                   	nop
...
void umemset( void *buf, register uint32_t len, register uint32_t value ) {
   19b92:	55                   	push   %ebp
   19b93:	89 e5                	mov    %esp,%ebp
   19b95:	53                   	push   %ebx
   19b96:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	register uint8_t *bp = buf;
   19b99:	8b 5d 08             	mov    0x8(%ebp),%ebx
	/*
	** We could speed this up by unrolling it and copying
	** words at a time (instead of bytes).
	*/
	...
	while( len-- ) {
   19b9c:	eb 0b                	jmp    19ba9 <umemset+0x17>
		*bp++ = value;
   19b9e:	89 d8                	mov    %ebx,%eax
   19ba0:	8d 58 01             	lea    0x1(%eax),%ebx
   19ba3:	0f b6 55 10          	movzbl 0x10(%ebp),%edx
   19ba7:	88 10                	mov    %dl,(%eax)
	while( len-- ) {
   19ba9:	89 c8                	mov    %ecx,%eax
   19bab:	8d 48 ff             	lea    -0x1(%eax),%ecx
   19bae:	85 c0                	test   %eax,%eax
   19bb0:	75 ec                	jne    19b9e <umemset+0xc>
	}
}
   19bb2:	90                   	nop
   19bb3:	5b                   	pop    %ebx
...
char *upad( char *dst, int extra, int padchar ) {
   19bb6:	55                   	push   %ebp
   19bb7:	89 e5                	mov    %esp,%ebp
	while( extra > 0 ){
   19bb9:	eb 12                	jmp    19bcd <upad+0x17>
		*dst++ = (char) padchar;
   19bbb:	8b 45 08             	mov    0x8(%ebp),%eax
   19bbe:	8d 50 01             	lea    0x1(%eax),%edx
   19bc1:	89 55 08             	mov    %edx,0x8(%ebp)
   19bc4:	8b 55 10             	mov    0x10(%ebp),%edx
   19bc7:	88 10                	mov    %dl,(%eax)
		extra -= 1;
   19bc9:	83 6d 0c 01          	subl   $0x1,0xc(%ebp)
	while( extra > 0 ){
   19bcd:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
   19bd1:	7f e8                	jg     19bbb <upad+0x5>
	}
	return dst;
...
char *upadstr( char *dst, char *str, int len, int width,
				int leftadjust, int padchar ) {
   19bd8:	55                   	push   %ebp
   19bd9:	89 e5                	mov    %esp,%ebp
   19bdb:	83 ec 18             	sub    $0x18,%esp
	int extra;

	// determine the length of the string if we need to
	if( len < 0 ){
   19bde:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
   19be2:	79 11                	jns    19bf5 <upadstr+0x1d>
		len = ustrlen( str );
   19be4:	83 ec 0c             	sub    $0xc,%esp
   19be7:	ff 75 0c             	pushl  0xc(%ebp)
   19bea:	e8 03 04 00 00       	call   19ff2 <ustrlen>
   19bef:	83 c4 10             	add    $0x10,%esp
   19bf2:	89 45 10             	mov    %eax,0x10(%ebp)
	}

	// how much filler must we add?
	extra = width - len;
   19bf5:	8b 45 14             	mov    0x14(%ebp),%eax
   19bf8:	2b 45 10             	sub    0x10(%ebp),%eax
   19bfb:	89 45 f0             	mov    %eax,-0x10(%ebp)

	// add filler on the left if we're not left-justifying
	if( extra > 0 && !leftadjust ){
   19bfe:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
   19c02:	7e 1d                	jle    19c21 <upadstr+0x49>
   19c04:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
   19c08:	75 17                	jne    19c21 <upadstr+0x49>
		dst = upad( dst, extra, padchar );
   19c0a:	83 ec 04             	sub    $0x4,%esp
   19c0d:	ff 75 1c             	pushl  0x1c(%ebp)
   19c10:	ff 75 f0             	pushl  -0x10(%ebp)
   19c13:	ff 75 08             	pushl  0x8(%ebp)
   19c16:	e8 9b ff ff ff       	call   19bb6 <upad>
   19c1b:	83 c4 10             	add    $0x10,%esp
   19c1e:	89 45 08             	mov    %eax,0x8(%ebp)
	}

	// copy the string itself
	for( int i = 0; i < len; ++i ) {
   19c21:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
   19c28:	eb 1b                	jmp    19c45 <upadstr+0x6d>
		*dst++ = str[i];
   19c2a:	8b 55 f4             	mov    -0xc(%ebp),%edx
   19c2d:	8b 45 0c             	mov    0xc(%ebp),%eax
   19c30:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
   19c33:	8b 45 08             	mov    0x8(%ebp),%eax
   19c36:	8d 50 01             	lea    0x1(%eax),%edx
   19c39:	89 55 08             	mov    %edx,0x8(%ebp)
   19c3c:	0f b6 11             	movzbl (%ecx),%edx
   19c3f:	88 10                	mov    %dl,(%eax)
	for( int i = 0; i < len; ++i ) {
   19c41:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
   19c45:	8b 45 f4             	mov    -0xc(%ebp),%eax
   19c48:	3b 45 10             	cmp    0x10(%ebp),%eax
   19c4b:	7c dd                	jl     19c2a <upadstr+0x52>
	}

	// add filler on the right if we are left-justifying
	if( extra > 0 && leftadjust ){
   19c4d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
   19c51:	7e 1d                	jle    19c70 <upadstr+0x98>
   19c53:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
   19c57:	74 17                	je     19c70 <upadstr+0x98>
		dst = upad( dst, extra, padchar );
   19c59:	83 ec 04             	sub    $0x4,%esp
   19c5c:	ff 75 1c             	pushl  0x1c(%ebp)
   19c5f:	ff 75 f0             	pushl  -0x10(%ebp)
   19c62:	ff 75 08             	pushl  0x8(%ebp)
   19c65:	e8 4c ff ff ff       	call   19bb6 <upad>
   19c6a:	83 c4 10             	add    $0x10,%esp
   19c6d:	89 45 08             	mov    %eax,0x8(%ebp)
	}
...
void usprint( char *dst, char *fmt, ... ) {
   19c75:	55                   	push   %ebp
   19c76:	89 e5                	mov    %esp,%ebp
   19c78:	83 ec 38             	sub    $0x38,%esp
	** to point to the next "thing", and interpret it according
	** to the format string.
	*/
	...
	// get the pointer to the first "value" parameter
	ap = (int *)(&fmt) + 1;
   19c7b:	8d 45 0c             	lea    0xc(%ebp),%eax
   19c7e:	83 c0 04             	add    $0x4,%eax
   19c81:	89 45 f4             	mov    %eax,-0xc(%ebp)

	// iterate through the format string
	while( (ch = *fmt++) != '\0' ){
   19c84:	e9 3f 02 00 00       	jmp    19ec8 <usprint+0x253>
		/*
		** Is it the start of a format code?
		*/
		if( ch == '%' ){
   19c89:	80 7d f3 25          	cmpb   $0x25,-0xd(%ebp)
   19c8d:	0f 85 26 02 00 00    	jne    19eb9 <usprint+0x244>
			/*
			** Yes, get the padding and width options (if there).
			** Alignment must come at the beginning, then fill,
			** then width.
			*/
			leftadjust = 0;
   19c93:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
			padchar = ' ';
   19c9a:	c7 45 e4 20 00 00 00 	movl   $0x20,-0x1c(%ebp)
			width = 0;
   19ca1:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
			ch = *fmt++;
   19ca8:	8b 45 0c             	mov    0xc(%ebp),%eax
   19cab:	8d 50 01             	lea    0x1(%eax),%edx
   19cae:	89 55 0c             	mov    %edx,0xc(%ebp)
   19cb1:	0f b6 00             	movzbl (%eax),%eax
   19cb4:	88 45 f3             	mov    %al,-0xd(%ebp)
			if( ch == '-' ){
   19cb7:	80 7d f3 2d          	cmpb   $0x2d,-0xd(%ebp)
   19cbb:	75 16                	jne    19cd3 <usprint+0x5e>
				leftadjust = 1;
   19cbd:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
				ch = *fmt++;
   19cc4:	8b 45 0c             	mov    0xc(%ebp),%eax
   19cc7:	8d 50 01             	lea    0x1(%eax),%edx
   19cca:	89 55 0c             	mov    %edx,0xc(%ebp)
   19ccd:	0f b6 00             	movzbl (%eax),%eax
   19cd0:	88 45 f3             	mov    %al,-0xd(%ebp)
			}
			if( ch == '0' ){
   19cd3:	80 7d f3 30          	cmpb   $0x30,-0xd(%ebp)
   19cd7:	75 40                	jne    19d19 <usprint+0xa4>
				padchar = '0';
   19cd9:	c7 45 e4 30 00 00 00 	movl   $0x30,-0x1c(%ebp)
				ch = *fmt++;
   19ce0:	8b 45 0c             	mov    0xc(%ebp),%eax
   19ce3:	8d 50 01             	lea    0x1(%eax),%edx
   19ce6:	89 55 0c             	mov    %edx,0xc(%ebp)
   19ce9:	0f b6 00             	movzbl (%eax),%eax
   19cec:	88 45 f3             	mov    %al,-0xd(%ebp)
			}
			while( ch >= '0' && ch <= '9' ){
   19cef:	eb 28                	jmp    19d19 <usprint+0xa4>
				width *= 10;
   19cf1:	8b 55 e8             	mov    -0x18(%ebp),%edx
   19cf4:	89 d0                	mov    %edx,%eax
   19cf6:	c1 e0 02             	shl    $0x2,%eax
   19cf9:	01 d0                	add    %edx,%eax
   19cfb:	01 c0                	add    %eax,%eax
   19cfd:	89 45 e8             	mov    %eax,-0x18(%ebp)
				width += ch - '0';
   19d00:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   19d04:	83 e8 30             	sub    $0x30,%eax
   19d07:	01 45 e8             	add    %eax,-0x18(%ebp)
				ch = *fmt++;
   19d0a:	8b 45 0c             	mov    0xc(%ebp),%eax
   19d0d:	8d 50 01             	lea    0x1(%eax),%edx
   19d10:	89 55 0c             	mov    %edx,0xc(%ebp)
   19d13:	0f b6 00             	movzbl (%eax),%eax
   19d16:	88 45 f3             	mov    %al,-0xd(%ebp)
			while( ch >= '0' && ch <= '9' ){
   19d19:	80 7d f3 2f          	cmpb   $0x2f,-0xd(%ebp)
   19d1d:	7e 06                	jle    19d25 <usprint+0xb0>
   19d1f:	80 7d f3 39          	cmpb   $0x39,-0xd(%ebp)
   19d23:	7e cc                	jle    19cf1 <usprint+0x7c>
			}
			...
			*/
			switch( ch ) {
   19d25:	0f be 45 f3          	movsbl -0xd(%ebp),%eax
   19d29:	83 e8 63             	sub    $0x63,%eax
   19d2c:	83 f8 15             	cmp    $0x15,%eax
   19d2f:	0f 87 93 01 00 00    	ja     19ec8 <usprint+0x253>
   19d35:	8b 04 85 c8 bf 01 00 	mov    0x1bfc8(,%eax,4),%eax
   19d3c:	ff e0                	jmp    *%eax

			case 'c':  // characters are passed as 32-bit values
				ch = *ap++;
   19d3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
   19d41:	8d 50 04             	lea    0x4(%eax),%edx
   19d44:	89 55 f4             	mov    %edx,-0xc(%ebp)
   19d47:	8b 00                	mov    (%eax),%eax
   19d49:	88 45 f3             	mov    %al,-0xd(%ebp)
				buf[ 0 ] = ch;
   19d4c:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
   19d50:	88 45 d0             	mov    %al,-0x30(%ebp)
				buf[ 1 ] = '\0';
   19d53:	c6 45 d1 00          	movb   $0x0,-0x2f(%ebp)
				dst = upadstr( dst, buf, 1, width, leftadjust, padchar );
   19d57:	83 ec 08             	sub    $0x8,%esp
   19d5a:	ff 75 e4             	pushl  -0x1c(%ebp)
   19d5d:	ff 75 ec             	pushl  -0x14(%ebp)
   19d60:	ff 75 e8             	pushl  -0x18(%ebp)
   19d63:	6a 01                	push   $0x1
   19d65:	8d 45 d0             	lea    -0x30(%ebp),%eax
   19d68:	50                   	push   %eax
   19d69:	ff 75 08             	pushl  0x8(%ebp)
   19d6c:	e8 67 fe ff ff       	call   19bd8 <upadstr>
   19d71:	83 c4 20             	add    $0x20,%esp
   19d74:	89 45 08             	mov    %eax,0x8(%ebp)
				break;
   19d77:	e9 4c 01 00 00       	jmp    19ec8 <usprint+0x253>

			case 'd':
				len = ucvtdec( buf, *ap++ );
   19d7c:	8b 45 f4             	mov    -0xc(%ebp),%eax
   19d7f:	8d 50 04             	lea    0x4(%eax),%edx
   19d82:	89 55 f4             	mov    %edx,-0xc(%ebp)
   19d85:	8b 00                	mov    (%eax),%eax
   19d87:	83 ec 08             	sub    $0x8,%esp
   19d8a:	50                   	push   %eax
   19d8b:	8d 45 d0             	lea    -0x30(%ebp),%eax
   19d8e:	50                   	push   %eax
   19d8f:	e8 a4 02 00 00       	call   1a038 <ucvtdec>
   19d94:	83 c4 10             	add    $0x10,%esp
   19d97:	89 45 e0             	mov    %eax,-0x20(%ebp)
				dst = upadstr( dst, buf, len, width, leftadjust, padchar );
   19d9a:	83 ec 08             	sub    $0x8,%esp
   19d9d:	ff 75 e4             	pushl  -0x1c(%ebp)
   19da0:	ff 75 ec             	pushl  -0x14(%ebp)
   19da3:	ff 75 e8             	pushl  -0x18(%ebp)
   19da6:	ff 75 e0             	pushl  -0x20(%ebp)
   19da9:	8d 45 d0             	lea    -0x30(%ebp),%eax
   19dac:	50                   	push   %eax
   19dad:	ff 75 08             	pushl  0x8(%ebp)
   19db0:	e8 23 fe ff ff       	call   19bd8 <upadstr>
   19db5:	83 c4 20             	add    $0x20,%esp
   19db8:	89 45 08             	mov    %eax,0x8(%ebp)
				break;
   19dbb:	e9 08 01 00 00       	jmp    19ec8 <usprint+0x253>

			case 's':
				str = (char *) (*ap++);
   19dc0:	8b 45 f4             	mov    -0xc(%ebp),%eax
   19dc3:	8d 50 04             	lea    0x4(%eax),%edx
   19dc6:	89 55 f4             	mov    %edx,-0xc(%ebp)
   19dc9:	8b 00                	mov    (%eax),%eax
   19dcb:	89 45 dc             	mov    %eax,-0x24(%ebp)
				dst = upadstr( dst, str, -1, width, leftadjust, padchar );
   19dce:	83 ec 08             	sub    $0x8,%esp
   19dd1:	ff 75 e4             	pushl  -0x1c(%ebp)
   19dd4:	ff 75 ec             	pushl  -0x14(%ebp)
   19dd7:	ff 75 e8             	pushl  -0x18(%ebp)
   19dda:	6a ff                	push   $0xffffffff
   19ddc:	ff 75 dc             	pushl  -0x24(%ebp)
   19ddf:	ff 75 08             	pushl  0x8(%ebp)
   19de2:	e8 f1 fd ff ff       	call   19bd8 <upadstr>
   19de7:	83 c4 20             	add    $0x20,%esp
   19dea:	89 45 08             	mov    %eax,0x8(%ebp)
				break;
   19ded:	e9 d6 00 00 00       	jmp    19ec8 <usprint+0x253>

			case 'x':
				len = ucvthex( buf, *ap++ );
   19df2:	8b 45 f4             	mov    -0xc(%ebp),%eax
   19df5:	8d 50 04             	lea    0x4(%eax),%edx
   19df8:	89 55 f4             	mov    %edx,-0xc(%ebp)
   19dfb:	8b 00                	mov    (%eax),%eax
   19dfd:	83 ec 08             	sub    $0x8,%esp
   19e00:	50                   	push   %eax
   19e01:	8d 45 d0             	lea    -0x30(%ebp),%eax
   19e04:	50                   	push   %eax
   19e05:	e8 fe 02 00 00       	call   1a108 <ucvthex>
   19e0a:	83 c4 10             	add    $0x10,%esp
   19e0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
				dst = upadstr( dst, buf, len, width, leftadjust, padchar );
   19e10:	83 ec 08             	sub    $0x8,%esp
   19e13:	ff 75 e4             	pushl  -0x1c(%ebp)
   19e16:	ff 75 ec             	pushl  -0x14(%ebp)
   19e19:	ff 75 e8             	pushl  -0x18(%ebp)
   19e1c:	ff 75 e0             	pushl  -0x20(%ebp)
   19e1f:	8d 45 d0             	lea    -0x30(%ebp),%eax
   19e22:	50                   	push   %eax
   19e23:	ff 75 08             	pushl  0x8(%ebp)
   19e26:	e8 ad fd ff ff       	call   19bd8 <upadstr>
   19e2b:	83 c4 20             	add    $0x20,%esp
   19e2e:	89 45 08             	mov    %eax,0x8(%ebp)
				break;
   19e31:	e9 92 00 00 00       	jmp    19ec8 <usprint+0x253>

			case 'o':
				len = ucvtoct( buf, *ap++ );
   19e36:	8b 45 f4             	mov    -0xc(%ebp),%eax
   19e39:	8d 50 04             	lea    0x4(%eax),%edx
   19e3c:	89 55 f4             	mov    %edx,-0xc(%ebp)
   19e3f:	8b 00                	mov    (%eax),%eax
   19e41:	83 ec 08             	sub    $0x8,%esp
   19e44:	50                   	push   %eax
   19e45:	8d 45 d0             	lea    -0x30(%ebp),%eax
   19e48:	50                   	push   %eax
   19e49:	e8 44 03 00 00       	call   1a192 <ucvtoct>
   19e4e:	83 c4 10             	add    $0x10,%esp
   19e51:	89 45 e0             	mov    %eax,-0x20(%ebp)
				dst = upadstr( dst, buf, len, width, leftadjust, padchar );
   19e54:	83 ec 08             	sub    $0x8,%esp
   19e57:	ff 75 e4             	pushl  -0x1c(%ebp)
   19e5a:	ff 75 ec             	pushl  -0x14(%ebp)
   19e5d:	ff 75 e8             	pushl  -0x18(%ebp)
   19e60:	ff 75 e0             	pushl  -0x20(%ebp)
   19e63:	8d 45 d0             	lea    -0x30(%ebp),%eax
   19e66:	50                   	push   %eax
   19e67:	ff 75 08             	pushl  0x8(%ebp)
   19e6a:	e8 69 fd ff ff       	call   19bd8 <upadstr>
   19e6f:	83 c4 20             	add    $0x20,%esp
   19e72:	89 45 08             	mov    %eax,0x8(%ebp)
				break;
   19e75:	eb 51                	jmp    19ec8 <usprint+0x253>

			case 'u':
				len = ucvtuns( buf, *ap++ );
   19e77:	8b 45 f4             	mov    -0xc(%ebp),%eax
   19e7a:	8d 50 04             	lea    0x4(%eax),%edx
   19e7d:	89 55 f4             	mov    %edx,-0xc(%ebp)
   19e80:	8b 00                	mov    (%eax),%eax
   19e82:	83 ec 08             	sub    $0x8,%esp
   19e85:	50                   	push   %eax
   19e86:	8d 45 d0             	lea    -0x30(%ebp),%eax
   19e89:	50                   	push   %eax
   19e8a:	e8 8d 03 00 00       	call   1a21c <ucvtuns>
   19e8f:	83 c4 10             	add    $0x10,%esp
   19e92:	89 45 e0             	mov    %eax,-0x20(%ebp)
				dst = upadstr( dst, buf, len, width, leftadjust, padchar );
   19e95:	83 ec 08             	sub    $0x8,%esp
   19e98:	ff 75 e4             	pushl  -0x1c(%ebp)
   19e9b:	ff 75 ec             	pushl  -0x14(%ebp)
   19e9e:	ff 75 e8             	pushl  -0x18(%ebp)
   19ea1:	ff 75 e0             	pushl  -0x20(%ebp)
   19ea4:	8d 45 d0             	lea    -0x30(%ebp),%eax
   19ea7:	50                   	push   %eax
   19ea8:	ff 75 08             	pushl  0x8(%ebp)
   19eab:	e8 28 fd ff ff       	call   19bd8 <upadstr>
   19eb0:	83 c4 20             	add    $0x20,%esp
   19eb3:	89 45 08             	mov    %eax,0x8(%ebp)
				break;
   19eb6:	90                   	nop
   19eb7:	eb 0f                	jmp    19ec8 <usprint+0x253>

			}
		} else {
			// no, it's just an ordinary character
			*dst++ = ch;
   19eb9:	8b 45 08             	mov    0x8(%ebp),%eax
   19ebc:	8d 50 01             	lea    0x1(%eax),%edx
   19ebf:	89 55 08             	mov    %edx,0x8(%ebp)
   19ec2:	0f b6 55 f3          	movzbl -0xd(%ebp),%edx
   19ec6:	88 10                	mov    %dl,(%eax)
	while( (ch = *fmt++) != '\0' ){
   19ec8:	8b 45 0c             	mov    0xc(%ebp),%eax
   19ecb:	8d 50 01             	lea    0x1(%eax),%edx
   19ece:	89 55 0c             	mov    %edx,0xc(%ebp)
   19ed1:	0f b6 00             	movzbl (%eax),%eax
   19ed4:	88 45 f3             	mov    %al,-0xd(%ebp)
   19ed7:	80 7d f3 00          	cmpb   $0x0,-0xd(%ebp)
   19edb:	0f 85 a8 fd ff ff    	jne    19c89 <usprint+0x14>
		}
	}

	// NUL-terminate the result
	*dst = '\0';
   19ee1:	8b 45 08             	mov    0x8(%ebp),%eax
   19ee4:	c6 00 00             	movb   $0x0,(%eax)
}
   19ee7:	90                   	nop
   19ee8:	c9                   	leave  
   19ee9:	c3                   	ret    
...
int ustr2int( register const char *str, register int base ) {
   19eea:	55                   	push   %ebp
   19eeb:	89 e5                	mov    %esp,%ebp
   19eed:	53                   	push   %ebx
   19eee:	83 ec 14             	sub    $0x14,%esp
   19ef1:	8b 45 08             	mov    0x8(%ebp),%eax
   19ef4:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	register int num = 0;
   19ef7:	bb 00 00 00 00       	mov    $0x0,%ebx
	register char bchar = '9';
   19efc:	c6 45 eb 39          	movb   $0x39,-0x15(%ebp)
	int sign = 1;
   19f00:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%ebp)

	// check for leading '-'
	if( *str == '-' ) {
   19f07:	0f b6 10             	movzbl (%eax),%edx
   19f0a:	80 fa 2d             	cmp    $0x2d,%dl
   19f0d:	75 0a                	jne    19f19 <ustr2int+0x2f>
		sign = -1;
   19f0f:	c7 45 f8 ff ff ff ff 	movl   $0xffffffff,-0x8(%ebp)
		++str;
   19f16:	83 c0 01             	add    $0x1,%eax
	}

	if( base != 10 ) {
   19f19:	83 f9 0a             	cmp    $0xa,%ecx
   19f1c:	74 2b                	je     19f49 <ustr2int+0x5f>
		bchar = '0' + base - 1;
   19f1e:	89 ca                	mov    %ecx,%edx
   19f20:	83 c2 2f             	add    $0x2f,%edx
   19f23:	88 55 eb             	mov    %dl,-0x15(%ebp)
	}

	// iterate through the characters
	while( *str ) {
   19f26:	eb 21                	jmp    19f49 <ustr2int+0x5f>
		if( *str < '0' || *str > bchar )
   19f28:	0f b6 10             	movzbl (%eax),%edx
   19f2b:	80 fa 2f             	cmp    $0x2f,%dl
   19f2e:	7e 20                	jle    19f50 <ustr2int+0x66>
   19f30:	0f b6 10             	movzbl (%eax),%edx
   19f33:	38 55 eb             	cmp    %dl,-0x15(%ebp)
   19f36:	7c 18                	jl     19f50 <ustr2int+0x66>
			break;
		num = num * base + *str - '0';
   19f38:	0f af d9             	imul   %ecx,%ebx
   19f3b:	0f b6 10             	movzbl (%eax),%edx
   19f3e:	0f be d2             	movsbl %dl,%edx
   19f41:	01 da                	add    %ebx,%edx
   19f43:	8d 5a d0             	lea    -0x30(%edx),%ebx
		++str;
   19f46:	83 c0 01             	add    $0x1,%eax
	while( *str ) {
   19f49:	0f b6 10             	movzbl (%eax),%edx
   19f4c:	84 d2                	test   %dl,%dl
   19f4e:	75 d8                	jne    19f28 <ustr2int+0x3e>
	}

	// return the converted value
	return( num * sign );
   19f50:	89 d8                	mov    %ebx,%eax
   19f52:	0f af 45 f8          	imul   -0x8(%ebp),%eax
}
   19f56:	83 c4 14             	add    $0x14,%esp
   19f59:	5b                   	pop    %ebx
   19f5a:	5d                   	pop    %ebp
   19f5b:	c3                   	ret    
...
char *ustrcat( register char *dst, register const char *src ) {
   19f5c:	55                   	push   %ebp
   19f5d:	89 e5                	mov    %esp,%ebp
   19f5f:	56                   	push   %esi
   19f60:	53                   	push   %ebx
   19f61:	8b 45 08             	mov    0x8(%ebp),%eax
   19f64:	8b 75 0c             	mov    0xc(%ebp),%esi
	register char *tmp = dst;
   19f67:	89 c3                	mov    %eax,%ebx

	while( *dst )  // find the NUL
   19f69:	eb 03                	jmp    19f6e <ustrcat+0x12>
		++dst;
   19f6b:	83 c0 01             	add    $0x1,%eax
	while( *dst )  // find the NUL
   19f6e:	0f b6 10             	movzbl (%eax),%edx
   19f71:	84 d2                	test   %dl,%dl
   19f73:	75 f6                	jne    19f6b <ustrcat+0xf>

	while( (*dst++ = *src++) )  // append the src string
   19f75:	90                   	nop
   19f76:	89 f1                	mov    %esi,%ecx
   19f78:	8d 71 01             	lea    0x1(%ecx),%esi
   19f7b:	89 c2                	mov    %eax,%edx
   19f7d:	8d 42 01             	lea    0x1(%edx),%eax
   19f80:	0f b6 09             	movzbl (%ecx),%ecx
   19f83:	88 0a                	mov    %cl,(%edx)
   19f85:	0f b6 12             	movzbl (%edx),%edx
   19f88:	84 d2                	test   %dl,%dl
   19f8a:	75 ea                	jne    19f76 <ustrcat+0x1a>
		;

	return( tmp );
   19f8c:	89 d8                	mov    %ebx,%eax
}
   19f8e:	5b                   	pop    %ebx
   19f8f:	5e                   	pop    %esi
   19f90:	5d                   	pop    %ebp
...
int ustrcmp( register const char *s1, register const char *s2 ) {
   19f92:	55                   	push   %ebp
   19f93:	89 e5                	mov    %esp,%ebp
   19f95:	53                   	push   %ebx
   19f96:	8b 45 08             	mov    0x8(%ebp),%eax
   19f99:	8b 55 0c             	mov    0xc(%ebp),%edx

	while( *s1 != 0 && (*s1 == *s2) )
   19f9c:	eb 06                	jmp    19fa4 <ustrcmp+0x12>
		++s1, ++s2;
   19f9e:	83 c0 01             	add    $0x1,%eax
   19fa1:	83 c2 01             	add    $0x1,%edx
	while( *s1 != 0 && (*s1 == *s2) )
   19fa4:	0f b6 08             	movzbl (%eax),%ecx
   19fa7:	84 c9                	test   %cl,%cl
   19fa9:	74 0a                	je     19fb5 <ustrcmp+0x23>
   19fab:	0f b6 18             	movzbl (%eax),%ebx
   19fae:	0f b6 0a             	movzbl (%edx),%ecx
   19fb1:	38 cb                	cmp    %cl,%bl
   19fb3:	74 e9                	je     19f9e <ustrcmp+0xc>

	return( *s1 - *s2 );
   19fb5:	0f b6 00             	movzbl (%eax),%eax
   19fb8:	0f be c8             	movsbl %al,%ecx
   19fbb:	0f b6 02             	movzbl (%edx),%eax
   19fbe:	0f be c0             	movsbl %al,%eax
   19fc1:	29 c1                	sub    %eax,%ecx
   19fc3:	89 c8                	mov    %ecx,%eax
}
   19fc5:	5b                   	pop    %ebx
   19fc6:	5d                   	pop    %ebp
   19fc7:	c3                   	ret    
...
char *ustrcpy( register char *dst, register const char *src ) {
   19fc8:	55                   	push   %ebp
   19fc9:	89 e5                	mov    %esp,%ebp
   19fcb:	56                   	push   %esi
   19fcc:	53                   	push   %ebx
   19fcd:	8b 4d 08             	mov    0x8(%ebp),%ecx
   19fd0:	8b 75 0c             	mov    0xc(%ebp),%esi
	register char *tmp = dst;
   19fd3:	89 cb                	mov    %ecx,%ebx

	while( (*dst++ = *src++) )
   19fd5:	90                   	nop
   19fd6:	89 f2                	mov    %esi,%edx
   19fd8:	8d 72 01             	lea    0x1(%edx),%esi
   19fdb:	89 c8                	mov    %ecx,%eax
   19fdd:	8d 48 01             	lea    0x1(%eax),%ecx
   19fe0:	0f b6 12             	movzbl (%edx),%edx
   19fe3:	88 10                	mov    %dl,(%eax)
   19fe5:	0f b6 00             	movzbl (%eax),%eax
   19fe8:	84 c0                	test   %al,%al
   19fea:	75 ea                	jne    19fd6 <ustrcpy+0xe>
		;

	return( tmp );
   19fec:	89 d8                	mov    %ebx,%eax
}
   19fee:	5b                   	pop    %ebx
   19fef:	5e                   	pop    %esi
   19ff0:	5d                   	pop    %ebp
...
uint32_t ustrlen( register const char *str ) {
   19ff2:	55                   	push   %ebp
   19ff3:	89 e5                	mov    %esp,%ebp
   19ff5:	53                   	push   %ebx
   19ff6:	8b 55 08             	mov    0x8(%ebp),%edx
	register uint32_t len = 0;
   19ff9:	bb 00 00 00 00       	mov    $0x0,%ebx

	while( *str++ ) {
   19ffe:	eb 03                	jmp    1a003 <ustrlen+0x11>
		++len;
   1a000:	83 c3 01             	add    $0x1,%ebx
	while( *str++ ) {
   1a003:	89 d0                	mov    %edx,%eax
   1a005:	8d 50 01             	lea    0x1(%eax),%edx
   1a008:	0f b6 00             	movzbl (%eax),%eax
   1a00b:	84 c0                	test   %al,%al
   1a00d:	75 f1                	jne    1a000 <ustrlen+0xe>
	}

	return( len );
   1a00f:	89 d8                	mov    %ebx,%eax
}
   1a011:	5b                   	pop    %ebx
   1a012:	5d                   	pop    %ebp
   1a013:	c3                   	ret    
...
uint32_t ubound( uint32_t min, uint32_t value, uint32_t max ) {
   1a014:	55                   	push   %ebp
   1a015:	89 e5                	mov    %esp,%ebp
	if( value < min ){
   1a017:	8b 45 0c             	mov    0xc(%ebp),%eax
   1a01a:	3b 45 08             	cmp    0x8(%ebp),%eax
   1a01d:	73 06                	jae    1a025 <ubound+0x11>
		value = min;
   1a01f:	8b 45 08             	mov    0x8(%ebp),%eax
   1a022:	89 45 0c             	mov    %eax,0xc(%ebp)
	}
	if( value > max ){
   1a025:	8b 45 0c             	mov    0xc(%ebp),%eax
   1a028:	3b 45 10             	cmp    0x10(%ebp),%eax
   1a02b:	76 06                	jbe    1a033 <ubound+0x1f>
		value = max;
   1a02d:	8b 45 10             	mov    0x10(%ebp),%eax
   1a030:	89 45 0c             	mov    %eax,0xc(%ebp)
	}
	return value;
   1a033:	8b 45 0c             	mov    0xc(%ebp),%eax
}
   1a036:	5d                   	pop    %ebp
   1a037:	c3                   	ret    
...
int ucvtdec( char *buf, int32_t value ) {
   1a038:	55                   	push   %ebp
   1a039:	89 e5                	mov    %esp,%ebp
   1a03b:	83 ec 18             	sub    $0x18,%esp
	char *bp = buf;
   1a03e:	8b 45 08             	mov    0x8(%ebp),%eax
   1a041:	89 45 f4             	mov    %eax,-0xc(%ebp)

	if( value < 0 ) {
   1a044:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
   1a048:	79 0f                	jns    1a059 <ucvtdec+0x21>
		*bp++ = '-';
   1a04a:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1a04d:	8d 50 01             	lea    0x1(%eax),%edx
   1a050:	89 55 f4             	mov    %edx,-0xc(%ebp)
   1a053:	c6 00 2d             	movb   $0x2d,(%eax)
		value = -value;
   1a056:	f7 5d 0c             	negl   0xc(%ebp)
	}

	bp = ucvtdec0( bp, value );
   1a059:	83 ec 08             	sub    $0x8,%esp
   1a05c:	ff 75 0c             	pushl  0xc(%ebp)
   1a05f:	ff 75 f4             	pushl  -0xc(%ebp)
   1a062:	e8 18 00 00 00       	call   1a07f <ucvtdec0>
   1a067:	83 c4 10             	add    $0x10,%esp
   1a06a:	89 45 f4             	mov    %eax,-0xc(%ebp)
	*bp  = '\0';
   1a06d:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1a070:	c6 00 00             	movb   $0x0,(%eax)

	return( bp - buf );
   1a073:	8b 55 f4             	mov    -0xc(%ebp),%edx
   1a076:	8b 45 08             	mov    0x8(%ebp),%eax
   1a079:	29 c2                	sub    %eax,%edx
   1a07b:	89 d0                	mov    %edx,%eax
}
   1a07d:	c9                   	leave  
   1a07e:	c3                   	ret    
...
char *ucvtdec0( char *buf, int value ) {
   1a07f:	55                   	push   %ebp
   1a080:	89 e5                	mov    %esp,%ebp
   1a082:	83 ec 18             	sub    $0x18,%esp
	int quotient;

	quotient = value / 10;
   1a085:	8b 4d 0c             	mov    0xc(%ebp),%ecx
   1a088:	ba 67 66 66 66       	mov    $0x66666667,%edx
   1a08d:	89 c8                	mov    %ecx,%eax
   1a08f:	f7 ea                	imul   %edx
   1a091:	c1 fa 02             	sar    $0x2,%edx
   1a094:	89 c8                	mov    %ecx,%eax
   1a096:	c1 f8 1f             	sar    $0x1f,%eax
   1a099:	29 c2                	sub    %eax,%edx
   1a09b:	89 d0                	mov    %edx,%eax
   1a09d:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if( quotient < 0 ) {
   1a0a0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
   1a0a4:	79 0e                	jns    1a0b4 <ucvtdec0+0x35>
		quotient = 214748364;
   1a0a6:	c7 45 f4 cc cc cc 0c 	movl   $0xccccccc,-0xc(%ebp)
		value = 8;
   1a0ad:	c7 45 0c 08 00 00 00 	movl   $0x8,0xc(%ebp)
	}
	if( quotient != 0 ) {
   1a0b4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
   1a0b8:	74 14                	je     1a0ce <ucvtdec0+0x4f>
		buf = ucvtdec0( buf, quotient );
   1a0ba:	83 ec 08             	sub    $0x8,%esp
   1a0bd:	ff 75 f4             	pushl  -0xc(%ebp)
   1a0c0:	ff 75 08             	pushl  0x8(%ebp)
   1a0c3:	e8 b7 ff ff ff       	call   1a07f <ucvtdec0>
   1a0c8:	83 c4 10             	add    $0x10,%esp
   1a0cb:	89 45 08             	mov    %eax,0x8(%ebp)
	}
	*buf++ = value % 10 + '0';
   1a0ce:	8b 4d 0c             	mov    0xc(%ebp),%ecx
   1a0d1:	ba 67 66 66 66       	mov    $0x66666667,%edx
   1a0d6:	89 c8                	mov    %ecx,%eax
   1a0d8:	f7 ea                	imul   %edx
   1a0da:	c1 fa 02             	sar    $0x2,%edx
   1a0dd:	89 c8                	mov    %ecx,%eax
   1a0df:	c1 f8 1f             	sar    $0x1f,%eax
   1a0e2:	29 c2                	sub    %eax,%edx
   1a0e4:	89 d0                	mov    %edx,%eax
   1a0e6:	c1 e0 02             	shl    $0x2,%eax
   1a0e9:	01 d0                	add    %edx,%eax
   1a0eb:	01 c0                	add    %eax,%eax
   1a0ed:	29 c1                	sub    %eax,%ecx
   1a0ef:	89 ca                	mov    %ecx,%edx
   1a0f1:	89 d0                	mov    %edx,%eax
   1a0f3:	8d 48 30             	lea    0x30(%eax),%ecx
   1a0f6:	8b 45 08             	mov    0x8(%ebp),%eax
   1a0f9:	8d 50 01             	lea    0x1(%eax),%edx
   1a0fc:	89 55 08             	mov    %edx,0x8(%ebp)
   1a0ff:	89 ca                	mov    %ecx,%edx
   1a101:	88 10                	mov    %dl,(%eax)
	return buf;
...
int ucvthex( char *buf, uint32_t value ) {
   1a108:	55                   	push   %ebp
   1a109:	89 e5                	mov    %esp,%ebp
   1a10b:	83 ec 20             	sub    $0x20,%esp
	const char hexdigits[] = "0123456789ABCDEF";
   1a10e:	c7 45 e3 30 31 32 33 	movl   $0x33323130,-0x1d(%ebp)
   1a115:	c7 45 e7 34 35 36 37 	movl   $0x37363534,-0x19(%ebp)
   1a11c:	c7 45 eb 38 39 41 42 	movl   $0x42413938,-0x15(%ebp)
   1a123:	c7 45 ef 43 44 45 46 	movl   $0x46454443,-0x11(%ebp)
   1a12a:	c6 45 f3 00          	movb   $0x0,-0xd(%ebp)
	int chars_stored = 0;
   1a12e:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)

	for( int i = 0; i < 8; i += 1 ) {
   1a135:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
   1a13c:	eb 43                	jmp    1a181 <ucvthex+0x79>
		uint32_t val = value & 0xf0000000;
   1a13e:	8b 45 0c             	mov    0xc(%ebp),%eax
   1a141:	25 00 00 00 f0       	and    $0xf0000000,%eax
   1a146:	89 45 f4             	mov    %eax,-0xc(%ebp)
		if( chars_stored || val != 0 || i == 7 ) {
   1a149:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
   1a14d:	75 0c                	jne    1a15b <ucvthex+0x53>
   1a14f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
   1a153:	75 06                	jne    1a15b <ucvthex+0x53>
   1a155:	83 7d f8 07          	cmpl   $0x7,-0x8(%ebp)
   1a159:	75 1e                	jne    1a179 <ucvthex+0x71>
			++chars_stored;
   1a15b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
			val = (val >> 28) & 0xf;
   1a15f:	c1 6d f4 1c          	shrl   $0x1c,-0xc(%ebp)
			*buf++ = hexdigits[val];
   1a163:	8b 45 08             	mov    0x8(%ebp),%eax
   1a166:	8d 50 01             	lea    0x1(%eax),%edx
   1a169:	89 55 08             	mov    %edx,0x8(%ebp)
   1a16c:	8d 4d e3             	lea    -0x1d(%ebp),%ecx
   1a16f:	8b 55 f4             	mov    -0xc(%ebp),%edx
   1a172:	01 ca                	add    %ecx,%edx
   1a174:	0f b6 12             	movzbl (%edx),%edx
   1a177:	88 10                	mov    %dl,(%eax)
		}
		value <<= 4;
   1a179:	c1 65 0c 04          	shll   $0x4,0xc(%ebp)
	for( int i = 0; i < 8; i += 1 ) {
   1a17d:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
   1a181:	83 7d f8 07          	cmpl   $0x7,-0x8(%ebp)
   1a185:	7e b7                	jle    1a13e <ucvthex+0x36>
	}

	*buf = '\0';
   1a187:	8b 45 08             	mov    0x8(%ebp),%eax
   1a18a:	c6 00 00             	movb   $0x0,(%eax)

	return( chars_stored );
   1a18d:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
   1a190:	c9                   	leave  
   1a191:	c3                   	ret    
...
int ucvtoct( char *buf, uint32_t value ) {
   1a192:	55                   	push   %ebp
   1a193:	89 e5                	mov    %esp,%ebp
   1a195:	83 ec 10             	sub    $0x10,%esp
	int i;
	int chars_stored = 0;
   1a198:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
	char *bp = buf;
   1a19f:	8b 45 08             	mov    0x8(%ebp),%eax
   1a1a2:	89 45 f4             	mov    %eax,-0xc(%ebp)
	uint32_t val;

	val = ( value & 0xc0000000 );
   1a1a5:	8b 45 0c             	mov    0xc(%ebp),%eax
   1a1a8:	25 00 00 00 c0       	and    $0xc0000000,%eax
   1a1ad:	89 45 f0             	mov    %eax,-0x10(%ebp)
	val >>= 30;
   1a1b0:	c1 6d f0 1e          	shrl   $0x1e,-0x10(%ebp)
	for( i = 0; i < 11; i += 1 ){
   1a1b4:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
   1a1bb:	eb 47                	jmp    1a204 <ucvtoct+0x72>

		if( i == 10 || val != 0 || chars_stored ) {
   1a1bd:	83 7d fc 0a          	cmpl   $0xa,-0x4(%ebp)
   1a1c1:	74 0c                	je     1a1cf <ucvtoct+0x3d>
   1a1c3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
   1a1c7:	75 06                	jne    1a1cf <ucvtoct+0x3d>
   1a1c9:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
   1a1cd:	74 1e                	je     1a1ed <ucvtoct+0x5b>
			chars_stored = 1;
   1a1cf:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%ebp)
			val &= 0x7;
   1a1d6:	83 65 f0 07          	andl   $0x7,-0x10(%ebp)
			*bp++ = val + '0';
   1a1da:	8b 45 f0             	mov    -0x10(%ebp),%eax
   1a1dd:	8d 48 30             	lea    0x30(%eax),%ecx
   1a1e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1a1e3:	8d 50 01             	lea    0x1(%eax),%edx
   1a1e6:	89 55 f4             	mov    %edx,-0xc(%ebp)
   1a1e9:	89 ca                	mov    %ecx,%edx
   1a1eb:	88 10                	mov    %dl,(%eax)
		}
		value <<= 3;
   1a1ed:	c1 65 0c 03          	shll   $0x3,0xc(%ebp)
		val = ( value & 0xe0000000 );
   1a1f1:	8b 45 0c             	mov    0xc(%ebp),%eax
   1a1f4:	25 00 00 00 e0       	and    $0xe0000000,%eax
   1a1f9:	89 45 f0             	mov    %eax,-0x10(%ebp)
		val >>= 29;
   1a1fc:	c1 6d f0 1d          	shrl   $0x1d,-0x10(%ebp)
	for( i = 0; i < 11; i += 1 ){
   1a200:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
   1a204:	83 7d fc 0a          	cmpl   $0xa,-0x4(%ebp)
   1a208:	7e b3                	jle    1a1bd <ucvtoct+0x2b>
	}
	*bp = '\0';
   1a20a:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1a20d:	c6 00 00             	movb   $0x0,(%eax)

	return bp - buf;
   1a210:	8b 55 f4             	mov    -0xc(%ebp),%edx
   1a213:	8b 45 08             	mov    0x8(%ebp),%eax
   1a216:	29 c2                	sub    %eax,%edx
   1a218:	89 d0                	mov    %edx,%eax
}
   1a21a:	c9                   	leave  
   1a21b:	c3                   	ret    
...
int ucvtuns( char *buf, uint32_t value ) {
   1a21c:	55                   	push   %ebp
   1a21d:	89 e5                	mov    %esp,%ebp
   1a21f:	83 ec 18             	sub    $0x18,%esp
	char    *bp = buf;
   1a222:	8b 45 08             	mov    0x8(%ebp),%eax
   1a225:	89 45 f4             	mov    %eax,-0xc(%ebp)

	bp = ucvtuns0( bp, value );
   1a228:	83 ec 08             	sub    $0x8,%esp
   1a22b:	ff 75 0c             	pushl  0xc(%ebp)
   1a22e:	ff 75 f4             	pushl  -0xc(%ebp)
   1a231:	e8 18 00 00 00       	call   1a24e <ucvtuns0>
   1a236:	83 c4 10             	add    $0x10,%esp
   1a239:	89 45 f4             	mov    %eax,-0xc(%ebp)
	*bp = '\0';
   1a23c:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1a23f:	c6 00 00             	movb   $0x0,(%eax)

	return bp - buf;
   1a242:	8b 55 f4             	mov    -0xc(%ebp),%edx
   1a245:	8b 45 08             	mov    0x8(%ebp),%eax
   1a248:	29 c2                	sub    %eax,%edx
...
char *ucvtuns0( char *buf, uint32_t value ) {
   1a24e:	55                   	push   %ebp
   1a24f:	89 e5                	mov    %esp,%ebp
   1a251:	83 ec 18             	sub    $0x18,%esp
	uint32_t quotient;

	quotient = value / 10;
   1a254:	8b 45 0c             	mov    0xc(%ebp),%eax
   1a257:	ba cd cc cc cc       	mov    $0xcccccccd,%edx
   1a25c:	f7 e2                	mul    %edx
   1a25e:	89 d0                	mov    %edx,%eax
   1a260:	c1 e8 03             	shr    $0x3,%eax
   1a263:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if( quotient != 0 ){
   1a266:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
   1a26a:	74 15                	je     1a281 <ucvtuns0+0x33>
		buf = ucvtdec0( buf, quotient );
   1a26c:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1a26f:	83 ec 08             	sub    $0x8,%esp
   1a272:	50                   	push   %eax
   1a273:	ff 75 08             	pushl  0x8(%ebp)
   1a276:	e8 04 fe ff ff       	call   1a07f <ucvtdec0>
   1a27b:	83 c4 10             	add    $0x10,%esp
   1a27e:	89 45 08             	mov    %eax,0x8(%ebp)
	}
	*buf++ = value % 10 + '0';
   1a281:	8b 4d 0c             	mov    0xc(%ebp),%ecx
   1a284:	ba cd cc cc cc       	mov    $0xcccccccd,%edx
   1a289:	89 c8                	mov    %ecx,%eax
   1a28b:	f7 e2                	mul    %edx
   1a28d:	c1 ea 03             	shr    $0x3,%edx
   1a290:	89 d0                	mov    %edx,%eax
   1a292:	c1 e0 02             	shl    $0x2,%eax
   1a295:	01 d0                	add    %edx,%eax
   1a297:	01 c0                	add    %eax,%eax
   1a299:	29 c1                	sub    %eax,%ecx
   1a29b:	89 ca                	mov    %ecx,%edx
   1a29d:	89 d0                	mov    %edx,%eax
   1a29f:	8d 48 30             	lea    0x30(%eax),%ecx
   1a2a2:	8b 45 08             	mov    0x8(%ebp),%eax
   1a2a5:	8d 50 01             	lea    0x1(%eax),%edx
   1a2a8:	89 55 08             	mov    %edx,0x8(%ebp)
   1a2ab:	89 ca                	mov    %ecx,%edx
   1a2ad:	88 10                	mov    %dl,(%eax)
	return buf;
   1a2af:	8b 45 08             	mov    0x8(%ebp),%eax
}
   1a2b2:	c9                   	leave  
   1a2b3:	c3                   	ret    
...
int wait( int32_t *status ) {
   1a2b4:	55                   	push   %ebp
   1a2b5:	89 e5                	mov    %esp,%ebp
   1a2b7:	83 ec 08             	sub    $0x8,%esp
	return( waitpid(0,status) );
   1a2ba:	83 ec 08             	sub    $0x8,%esp
   1a2bd:	ff 75 08             	pushl  0x8(%ebp)
   1a2c0:	6a 00                	push   $0x0
   1a2c2:	e8 0c cc ff ff       	call   16ed3 <waitpid>
   1a2c7:	83 c4 10             	add    $0x10,%esp
}
   1a2ca:	c9                   	leave  
   1a2cb:	c3                   	ret    
...
int32_t spawn( uint32_t entry, char **args ) {
   1a2cc:	55                   	push   %ebp
   1a2cd:	89 e5                	mov    %esp,%ebp
   1a2cf:	81 ec 18 01 00 00    	sub    $0x118,%esp
	int32_t pid;
	char buf[256];

	pid = fork();
   1a2d5:	e8 01 cc ff ff       	call   16edb <fork>
   1a2da:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if( pid != 0 ) {
   1a2dd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
   1a2e1:	74 05                	je     1a2e8 <spawn+0x1c>
		// failure, or we are the parent
		return( pid );
   1a2e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1a2e6:	eb 57                	jmp    1a33f <spawn+0x73>
	}

	// we are the child
	pid = getpid();
   1a2e8:	e8 0e cc ff ff       	call   16efb <getpid>
   1a2ed:	89 45 f4             	mov    %eax,-0xc(%ebp)

	// child inherits parent's priority level

	exec( entry, args );
   1a2f0:	83 ec 08             	sub    $0x8,%esp
   1a2f3:	ff 75 0c             	pushl  0xc(%ebp)
   1a2f6:	ff 75 08             	pushl  0x8(%ebp)
   1a2f9:	e8 e5 cb ff ff       	call   16ee3 <exec>
   1a2fe:	83 c4 10             	add    $0x10,%esp

	// uh-oh....

	usprint( buf, "Child %d exec() %08x failed\n", pid, entry );
   1a301:	ff 75 08             	pushl  0x8(%ebp)
   1a304:	ff 75 f4             	pushl  -0xc(%ebp)
   1a307:	68 20 c0 01 00       	push   $0x1c020
   1a30c:	8d 85 f4 fe ff ff    	lea    -0x10c(%ebp),%eax
   1a312:	50                   	push   %eax
   1a313:	e8 5d f9 ff ff       	call   19c75 <usprint>
   1a318:	83 c4 10             	add    $0x10,%esp
	cwrites( buf );
   1a31b:	83 ec 0c             	sub    $0xc,%esp
   1a31e:	8d 85 f4 fe ff ff    	lea    -0x10c(%ebp),%eax
   1a324:	50                   	push   %eax
   1a325:	e8 38 00 00 00       	call   1a362 <cwrites>
   1a32a:	83 c4 10             	add    $0x10,%esp

	exit( EXIT_FAILURE );
   1a32d:	83 ec 0c             	sub    $0xc,%esp
   1a330:	6a ff                	push   $0xffffffff
   1a332:	e8 94 cb ff ff       	call   16ecb <exit>
   1a337:	83 c4 10             	add    $0x10,%esp
	return( 0 );   // shut the compiler up
   1a33a:	b8 00 00 00 00       	mov    $0x0,%eax
}
   1a33f:	c9                   	leave  
   1a340:	c3                   	ret    
...
int cwritech( char ch ) {
   1a341:	55                   	push   %ebp
   1a342:	89 e5                	mov    %esp,%ebp
   1a344:	83 ec 18             	sub    $0x18,%esp
   1a347:	8b 45 08             	mov    0x8(%ebp),%eax
   1a34a:	88 45 f4             	mov    %al,-0xc(%ebp)
	return( write(CHAN_CIO,&ch,1) );
   1a34d:	83 ec 04             	sub    $0x4,%esp
   1a350:	6a 01                	push   $0x1
   1a352:	8d 45 f4             	lea    -0xc(%ebp),%eax
   1a355:	50                   	push   %eax
   1a356:	6a 00                	push   $0x0
   1a358:	e8 96 cb ff ff       	call   16ef3 <write>
   1a35d:	83 c4 10             	add    $0x10,%esp
}
   1a360:	c9                   	leave  
   1a361:	c3                   	ret    
...
int cwrites( const char *str ) {
   1a362:	55                   	push   %ebp
   1a363:	89 e5                	mov    %esp,%ebp
   1a365:	83 ec 18             	sub    $0x18,%esp
	int len = ustrlen(str);
   1a368:	ff 75 08             	pushl  0x8(%ebp)
   1a36b:	e8 82 fc ff ff       	call   19ff2 <ustrlen>
   1a370:	83 c4 04             	add    $0x4,%esp
   1a373:	89 45 f4             	mov    %eax,-0xc(%ebp)
	return( write(CHAN_CIO,str,len) );
   1a376:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1a379:	83 ec 04             	sub    $0x4,%esp
   1a37c:	50                   	push   %eax
   1a37d:	ff 75 08             	pushl  0x8(%ebp)
   1a380:	6a 00                	push   $0x0
   1a382:	e8 6c cb ff ff       	call   16ef3 <write>
...
int cwrite( const char *buf, uint32_t size ) {
   1a38c:	55                   	push   %ebp
   1a38d:	89 e5                	mov    %esp,%ebp
   1a38f:	83 ec 08             	sub    $0x8,%esp
	return( write(CHAN_CIO,buf,size) );
   1a392:	83 ec 04             	sub    $0x4,%esp
   1a395:	ff 75 0c             	pushl  0xc(%ebp)
   1a398:	ff 75 08             	pushl  0x8(%ebp)
   1a39b:	6a 00                	push   $0x0
   1a39d:	e8 51 cb ff ff       	call   16ef3 <write>
   1a3a2:	83 c4 10             	add    $0x10,%esp
}
   1a3a5:	c9                   	leave  
   1a3a6:	c3                   	ret    
...
int swritech( char ch ) {
   1a3a7:	55                   	push   %ebp
   1a3a8:	89 e5                	mov    %esp,%ebp
   1a3aa:	83 ec 18             	sub    $0x18,%esp
   1a3ad:	8b 45 08             	mov    0x8(%ebp),%eax
   1a3b0:	88 45 f4             	mov    %al,-0xc(%ebp)
	return( write(CHAN_SIO,&ch,1) );
   1a3b3:	83 ec 04             	sub    $0x4,%esp
   1a3b6:	6a 01                	push   $0x1
   1a3b8:	8d 45 f4             	lea    -0xc(%ebp),%eax
   1a3bb:	50                   	push   %eax
   1a3bc:	6a 01                	push   $0x1
   1a3be:	e8 30 cb ff ff       	call   16ef3 <write>
   1a3c3:	83 c4 10             	add    $0x10,%esp
}
   1a3c6:	c9                   	leave  
   1a3c7:	c3                   	ret    
...
int swrites( const char *str ) {
   1a3c8:	55                   	push   %ebp
   1a3c9:	89 e5                	mov    %esp,%ebp
   1a3cb:	83 ec 18             	sub    $0x18,%esp
	int len = ustrlen(str);
   1a3ce:	ff 75 08             	pushl  0x8(%ebp)
   1a3d1:	e8 1c fc ff ff       	call   19ff2 <ustrlen>
   1a3d6:	83 c4 04             	add    $0x4,%esp
   1a3d9:	89 45 f4             	mov    %eax,-0xc(%ebp)
	return( write(CHAN_SIO,str,len) );
   1a3dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
   1a3df:	83 ec 04             	sub    $0x4,%esp
   1a3e2:	50                   	push   %eax
   1a3e3:	ff 75 08             	pushl  0x8(%ebp)
   1a3e6:	6a 01                	push   $0x1
   1a3e8:	e8 06 cb ff ff       	call   16ef3 <write>
   1a3ed:	83 c4 10             	add    $0x10,%esp
}
   1a3f0:	c9                   	leave  
   1a3f1:	c3                   	ret    
...
int swrite( const char *buf, uint32_t size ) {
   1a3f2:	55                   	push   %ebp
   1a3f3:	89 e5                	mov    %esp,%ebp
   1a3f5:	83 ec 08             	sub    $0x8,%esp
	return( write(CHAN_SIO,buf,size) );
   1a3f8:	83 ec 04             	sub    $0x4,%esp
   1a3fb:	ff 75 0c             	pushl  0xc(%ebp)
   1a3fe:	ff 75 08             	pushl  0x8(%ebp)
   1a401:	6a 01                	push   $0x1
   1a403:	e8 eb ca ff ff       	call   16ef3 <write>
   1a408:	83 c4 10             	add    $0x10,%esp
}
   1a40b:	c9                   	leave  
   1a40c:	c3                   	ret    
