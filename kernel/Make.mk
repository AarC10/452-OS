...
KERN_SRC := kernel/startup.S kernel/isrs.S \
	kernel/cio.c kernel/clock.c kernel/kernel.c \
	kernel/kmem.c kernel/procs.c kernel/sio.c \
	kernel/support.c kernel/syscalls.c \
	kernel/user.c kernel/vm.c kernel/vmtables.c
